...
**Benchmarking Coverage**: latency, throughput and fix-qps serving on A100 (the support for FP8 benchmark on H100 is coming!), Intel® Xeon® Processors and Intel® Gaudi® 3 Accelerators with different models.
