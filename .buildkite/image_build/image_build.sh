...
export VLLM_BUILD_KIND="${VLLM_BUILD_KIND:-ci}"
export VLLM_BUILD_REPO="${VLLM_BUILD_REPO:-${BUILDKITE_REPO:-https://github.com/vllm-project/vllm}}"
export VLLM_BUILD_PIPELINE="${VLLM_BUILD_PIPELINE:-${BUILDKITE_PIPELINE_SLUG:-buildkite}}"
export VLLM_BUILD_COMMIT="${VLLM_BUILD_COMMIT:-${BUILDKITE_COMMIT}}"
export VLLM_BUILD_URL="${VLLM_BUILD_URL:-${BUILDKITE_BUILD_URL:-}}"
export VLLM_IMAGE_REF="${VLLM_IMAGE_REF:-${IMAGE_TAG:-local/vllm-openai:dev}}"
export VLLM_STAGING_IMAGE_REF="${VLLM_STAGING_IMAGE_REF:-${IMAGE_TAG:-}}"
export CACHE_FROM
