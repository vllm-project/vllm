...
# Nightly CI tracks the same CUDA version as the default build
NIGHTLY_CUDA_VERSION="13.2.1"
NIGHTLY_BUILD_BASE_IMAGE="pytorch/manylinux2_28-builder:cuda13.2-9f3983c9d680f3cc243dfa0524efcb881be7869e"
