...
function cpu_tests() {
  ...
  podman exec -it "$container_id" bash -c "
    ...
    pytest -v -s tests/models/language/generation/test_core.py::test_models[False-False-5-32-openai-community/gpt2]
    pytest -v -s tests/models/language/generation/test_core.py::test_models[False-False-5-32-facebook/opt-125m]
    pytest -v -s tests/models/language/generation/test_core_slow.py::test_models[False-False-5-32-google/gemma-1.1-2b-it]
