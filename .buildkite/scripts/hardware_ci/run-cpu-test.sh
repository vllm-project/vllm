...
BUILD_RETRY_PATTERN="${BUILD_RETRY_PATTERN}|HTTP/[0-9.]+ stream [0-9]+ was not closed cleanly|fetch-pack: unexpected disconnect|fatal: early EOF|invalid index-pack output|BrokenPipeError: \[Errno 32\] Broken pipe"
