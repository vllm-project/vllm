...
DEFAULT_CI_BASE_DOCKERFILE_STAGES="base rust_toolchain_input_0 rust-toolchain-input rust-toolchain build_nixl lmcache_source lmcache_build_deps build_lmcache export_lmcache build_rocshmem build_deepep mori_base ci_base_common ci_base"
