...
if(DEEPGEMM_SRC_DIR)
  ...
  string(SUBSTRING "${_DEEPGEMM_UPSTREAM_TAG}" 0 12 _deepgemm_tag)
  set(_deepgemm_src "${_deepgemm_fc_root}/deepgemm-${_deepgemm_tag}-src")
  set(_deepgemm_bin "${_deepgemm_fc_root}/deepgemm-${_deepgemm_tag}-build")
  set(_deepgemm_sub "${_deepgemm_fc_root}/deepgemm-${_deepgemm_tag}-subbuild")
