...
- **OffloadingConnector benchmark**: End-to-end recompute versus CPU KV load measurement, strict cache-source validation, and decode-block store verification. See [offloading/README.md](./offloading/README.md).
