...
def run_vllm(
    ...
    if not use_new_beam_search_impl:
        ...
        cp_str = "cp" if enable_chunked_prefill else "" 
        eager_str = "eager" if enforce_eager else "cugraph"
        output_file_name = f"llm_engine_ms{num_scheduler_steps}_tp{tensor_parallel_size}_{cp_str}_{eager_str}_gold.pkl"
