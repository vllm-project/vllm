...
if __name__ == "__main__":
    ...
    parser.add_argument('--inject-random-number-before-prompt',
                        action='store_true',
                        help='Inject a random number before each request, '
                        'so that we can benchmark performance of block '
                        'manager when no prefix hit.')
