...
WEIGHT_SHAPES_MOE = {
    "mistralai/Mixtral-8x7B-Instruct-v0.1": [[8, 2, 4096, 28672], [8, 2, 14336, 4096]],
    "deepseek-ai/DeepSeek-V2-Lite": [[64, 6, 2048, 1408]],
    "ibm-granite/granite-3.0-1b-a400m": [[32, 8, 1024, 1024]],
    "ibm-granite/granite-3.0-3b-a800m": [[40, 8, 1024, 1536]],
}
