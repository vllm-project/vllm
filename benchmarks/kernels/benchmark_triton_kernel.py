...
def bench_run(
    ...
    w1 = torch.randn((num_expts_tot, shard_intermediate_size, hidden_size), dtype=torch.bfloat16, device="cuda")
    w2 = torch.randn((num_expts_tot, hidden_size, shard_intermediate_size // 2), dtype=torch.bfloat16, device="cuda")
