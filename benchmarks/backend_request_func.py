...
def _record_token_timings(
    ...
    if most_recent_token_timestamp is None:
        ...
        if itl_count > 0:
            output.itl.extend([0.0] * itl_count)
    else:
        per_token_latency = (timestamp - most_recent_token_timestamp) / new_tokens
        output.itl.extend([per_token_latency] * new_tokens)
                        ...
                        if chunk != "[DONE]":
                            ...
                            if choices := data.get("choices"):
                                ...
                                if (
                                    ...
                                    most_recent_token_timestamp = _record_token_timings(
                                        output,
                                        timestamp,
                                        st,
                                        most_recent_token_timestamp,
