...
RUN --mount=type=cache,target=/root/.cache/pip \
    python3 -m pip install https://github.com/flashinfer-ai/flashinfer/releases/download/v0.1.2/flashinfer-0.1.2+cu121torch2.4.0-cp310-cp310-linux_x86_64.whl
#################### vLLM installation IMAGE ####################
