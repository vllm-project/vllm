...
requests:
  ...
  {{- if and (not .Values.dra.enabled) (gt (int (index .Values.resources.requests "nvidia.com/gpu")) 0) (gt (int (index .Values.resources.limits "nvidia.com/gpu")) 0) }}
...
claims:
{{- range .Values.dra.resourceClaims }}
- name: {{ .name }}
{{- end }}
{{- end }}
{{- end }}
