...
| extraInit | object | `{"pvcStorage":"50Gi","s3modelpath":"relative_s3_model_path/opt-125m"}` | Additional configuration for the init container |
...
| resources.limits.memory | string | `"16Gi"` | CPU memory configuraiton |
| resources.requests."nvidia.com/gpu" | int | `1` | Number of gpus used |
| resources.requests.cpu | int | `4` | Number of CPUs |
| resources.requests.memory | string | `"16Gi"` | CPU memory configuraiton |
