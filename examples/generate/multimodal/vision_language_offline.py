...
# Qwen3.6-Dense
def run_qwen3_6(questions: list[str], modality: str) -> ModelRequestData:
...
# Qwen3.6-MoE
def run_qwen3_6_moe(questions: list[str], modality: str) -> ModelRequestData:
