...
cannot be assigned a single request trace automatically. This switch does not
add request middleware or context propagation across process/thread boundaries.
