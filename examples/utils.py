...
@contextmanager
def override_backend_env_var_context_manager(backend_name: str,
    ...
    * Generator
    ...
    try:
        ...
        if original_value is None:
            os.environ.pop(key, None)  # Remove the variable if it wasn't originally set
        else:
            os.environ[key] = original_value  # Revert back to the original value