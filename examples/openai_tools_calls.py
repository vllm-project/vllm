...
TOOLS_TEMPLATE = {
    ...
    "call_token_start": "<tool_call>",
    "call_token_end": "</tool_call>",

    # Keywords used to define functions. Used to present the list of functions to the llm
    "tool_token_start": "<tool>",
    "tool_token_end": "</tool>",

    # Response keywords. Used to present the values returned by the functions
    "response_token_start": "<tool_response>",
    "response_token_end": "</tool_response>",

    # Call notifications to the model (optional)
    "tool_call_notif_noarg_start": "",  #
    "tool_call_notif_noarg_end": "was called with no argument",
    "tool_call_notif_args_start": "",
    "tool_call_notif_args_end": "was called with arguments",

    # Instructions (guided generation if tool_choice is defined on a specific function)
    "function_guided": "You must call the following function at least one time to answer the question. You may call it multiple times if needed:",

    # Instructions (auto mode, if tool_choice equals "auto" or None)
    "function_list_start": "The following is a list of external functions that may be called to complete certain tasks:",
    "function_list_end": """End of list
...
* If you need to call at least one function, your message should contain only a list of function calls and nothing else; the function calls are the response.""",
    ...
    "function_call_instruct": """For each function call return a valid json object (using quotes) with function name and arguments within <tool_call>{ }</tool_call> XML tags as follows::
* With arguments:
