...
def main():
    ...
    print("================== DOC w =====================")
    llm.generate(
        wrap(doc_w), sampling_params=samp_params_preload
    )
    print("================== DOC x =====================")
    llm.generate(
        wrap(doc_x), sampling_params=samp_params_preload
    )
    # print("================== DOC y =====================")
    # llm.generate(
    #     wrap(doc_y), sampling_params=samp_params_preload
    # )
    # print("================== DOC z =====================")
    # llm.generate(
    #     wrap(doc_z), sampling_params=samp_params_preload
    # )
    print("================== BOTH =====================")
    model_response_3 = llm.generate(
        wrap(prefix + doc_w + doc_x + query_2),
        sampling_params=samp_params_preload,
        use_tqdm=False,
    )
