...
def main():
    ...
    for model in models_to_test:
        ...
        res["total_num_attention_heads"] = getattr(self.hf_text_config, "num_attention_heads", 0)
        ...
        res["supports_multimodal"] = model_config.supports_multimodal
        res["dtype"] = _find_dtype(model_id, hf_config, revision=model_config.revision)
        all_res[model] = res
