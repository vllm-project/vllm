...
Code example: [examples/online_serving/openai_responses_client_with_tools.py](../../examples/function_calling/openai_responses_client_with_tools.py)
...
Code example: [examples/online_serving/openai_transcription_client.py](../../examples/transcription/openai_transcription_client.py)
...
Code example: [examples/online_serving/openai_translation_client.py](../../examples/transcription/openai_translation_client.py)
