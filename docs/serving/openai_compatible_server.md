...
Code example: [examples/transcription/openai_transcription_client.py](../../examples/speech_to_text/openai_transcription_client.py)
...
Code example: [examples/transcription/openai_translation_client.py](../../examples/speech_to_text/openai_translation_client.py)
