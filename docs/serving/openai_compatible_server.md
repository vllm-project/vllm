...
Code example: [examples/transcription/openai_transcription_client.py](../../examples/transcription/openai_transcription_client.py)
...
Code example: [examples/transcription/openai_translation_client.py](../../examples/transcription/openai_translation_client.py)
