...
An example chat template for `NousResearch/Meta-Llama-3-8B-Instruct` can be found [here](https://www.llama.com/docs/model-cards-and-prompt-formats/llama3_1/#prompt-template)
