...
| `reload_weights` | FP8 per-tensor MoE, streaming per-expert units | filesystem | Pass | Qwen3-30B-A3B 2-layer/128-expert FP8 checkpoint on H200; serving tensors bit-identical to a cold load, 0 identity/address changes, expert staging cut from 2409 to 1256 MiB |
