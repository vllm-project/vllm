...
| `FLEX_ATTENTION` |  | fp16, bf16, fp32 | `auto`, `bfloat16`, `float16` | Any | Any | ❌ | ✅ | Decoder, Encoder Only | Any |
...
| `TRITON_ATTN` |  | fp16, bf16, fp32 | `auto`, `bfloat16`, `float16`, `fp8`, `fp8_e4m3`, `fp8_e5m2` | %16 | Any | ✅ | ✅ | All | Any |
