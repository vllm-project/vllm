...
More API details can be found in the [Offline Inference](../serving/offline-inference.md) section of the API docs.
...
>   <img src="../assets/design/hierarchy.png" alt="query" style="display: block; margin: 0 auto; width: 100%;" />
> </figure>
