...
That code can be found in [vllm/entrypoints/openai/api_server.py](../../vllm/entrypoints/launchers/api_server/entry.py).
...
The code can be found in [vllm/entrypoints/openai/api_server.py](../../vllm/entrypoints/launchers/api_server/entry.py) and [vllm/v1/utils.py](../../vllm/v1/utils.py).
