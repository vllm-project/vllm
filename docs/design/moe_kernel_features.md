...
| deepep_high_throughput | standard | fp8 | G(128),A,T<sup>2</sup> | Y | Y | [`DeepEPHTPrepareAndFinalize`][vllm.model_executor.layers.prepare_finalize.deepep_ht.DeepEPHTPrepareAndFinalize] |
