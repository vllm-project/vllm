...
| flashinfer_all2allv | standard | nvfp4,fp8 | G,A,T | N | N | [`FlashInferAllToAllMoEPrepareAndFinalize`][vllm.model_executor.layers.fused_moe.flashinfer_all2all_prepare_finalize.FlashInferAllToAllMoEPrepareAndFinalize] |
| flashinfer<sup>4</sup> | standard | nvfp4,fp8 | G,A,T | N | N | [`FlashInferAllGatherMoEPrepareAndFinalize`][vllm.model_executor.layers.fused_moe.flashinfer_all2all_prepare_finalize.FlashInferAllGatherMoEPrepareAndFinalize] |
...
| flashinfer | `FlashInferAllGatherMoEPrepareAndFinalize` | `FlashInferExperts` |
