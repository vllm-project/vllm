...
| MoEPrepareAndFinalizeNoDPEPModular<sup>5</sup> | standard | fp8,int8 | G,A,T | N | Y | [`MoEPrepareAndFinalizeNoDPEPModular`][vllm.model_executor.layers.fused_moe.prepare_finalize.MoEPrepareAndFinalizeNoDPEPModular] |
