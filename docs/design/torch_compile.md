...
- All the related configs (see the `compile_factors` functions in their respective configs in the [config folder](../../vllm/config))
- PyTorch configs (see the `compile_factors` functions in the [compiler_interface.py](../../vllm/compilation/compiler_interface.py))
