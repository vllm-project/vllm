...
!!! note
    ...
    You can convert the model checkpoint to a sharded checkpoint using [examples/basic/offline_inference/save_sharded_state.py](../../examples/basic/offline_inference/save_sharded_state.py). The conversion process might take some time, but later you can load the sharded checkpoint much faster. The model loading time should remain constant regardless of the size of tensor parallelism.
