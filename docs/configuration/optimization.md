...
- The current implementation binds GPU execution processes such as `alive` and multiprocessing workers. It does not apply NUMA binding to frontend API server processes or the DP coordinator.
