...
The OGX `file_search` handler is included with vLLM. Start the OGX server,
then configure its URL before starting vLLM.
...
```json
{"results": [{"file_id": "...", "filename": "...", "score": 0.0, "attributes": {}, "text": "..."}]}
```
