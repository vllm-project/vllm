...
Code example: <gh-code:examples/openai_completion_client.py>
...
Code example: <gh-code:examples/openai_chat_completion_client.py>
...
Code example: <gh-code:examples/openai_embedding_client.py>
...
Code example: <gh-code:examples/openai_pooling_client.py>
...
Code example: <gh-code:examples/openai_cross_encoder_score.py>
