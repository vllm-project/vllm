...
```{important}
If you discover a security vulnerability, please follow the instructions [here](gh-code:SECURITY.md#reporting-a-vulnerability).
```
...
When contributing changes to this project, you must agree to the <gh-code:DCO>.
...
- Pass all linter checks. Please use <gh-code:format.sh> to format your code.
