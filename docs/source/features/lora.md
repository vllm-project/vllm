...
2. Register the plugin with vLLM.

For more information on vLLM's plugin system and how to create custom plugins, please refer to the [Plugins documentation](../design/plugin_system.md).
