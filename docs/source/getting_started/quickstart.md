...
Be sure to complete the [Gaudi installation instructions](https://github.com/HabanaAI/vllm-fork/blob/habana_main/docs/source/getting_started/gaudi-installation.rst#run-docker-image) before continuing with this guide.
