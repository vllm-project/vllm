...
With vLLM installed, you can start generating texts for list of input prompts (i.e. offline batch inference). See the example script: <gh-file:examples/offline_inference/basic.py>
