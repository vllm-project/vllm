...
A code example can be found here: <gh-code:examples/offline_inference_embedding.py>
...
A code example can be found here: <gh-code:examples/offline_inference_classification.py>
...
A code example can be found here: <gh-code:examples/offline_inference_scoring.py>
