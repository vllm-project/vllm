...
.. code-block:: console
    ...
    $ python3 vllm/kv_quant/calibrate.py --model facebook/opt-125m --calib_dataset pileval 
    --calib_samples 128 --calib_seqlen 2048 --work_dir kv_cache_states/opt-125m

Second, export quantization scales and zero points with the captured kv cache states.

.. code-block:: console

    $ python3 vllm/kv_quant/export_kv_params.py --work_dir kv_cache_states/opt-125m 
    --kv_params_dir quant_params/opt-125m
...
.. code-block:: python
    ...
    # Create an LLM.
    llm = LLM(model="facebook/opt-125m", kv_cache_dtype="int8", kv_quant_params_path="quant_params/opt-125m")
