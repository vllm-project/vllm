...
To create sharded model files, you can use the script provided in [examples/basic/offline_inference/save_sharded_state.py](../../../examples/basic/offline_inference/save_sharded_state.py). This script demonstrates how to save a model in the sharded format that is compatible with the Run:ai Model Streamer sharded loader.
