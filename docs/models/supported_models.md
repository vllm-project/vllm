...
| `AudioFlamingoNextForConditionalGeneration` | AudioFlamingoNext | T + A | `nvidia/audio-flamingo-next-hf`, `nvidia/audio-flamingo-next-think-hf`, `nvidia/audio-flamingo-next-captioner-hf` | ✅︎ | ✅︎ |
