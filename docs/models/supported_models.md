...
| `LlamaBidirectionalModel`<sup>C</sup>, etc. | Llama-based with bidirectional attention | `nvidia/llama-nemotron-embed-1b-v2`, etc. | ✅︎ | ✅︎ |
...
| `LlamaBidirectionalForSequenceClassification`<sup>C</sup>, etc. | Llama-based with bidirectional attention | `nvidia/llama-nemotron-rerank-1b-v2` (see note), etc. | ✅︎ | ✅︎ |
