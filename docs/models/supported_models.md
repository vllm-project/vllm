...
| `Gemma4ForConditionalGeneration` | Gemma 4 | T + I<sup>+</sup> + A<sup>*</sup> | `google/gemma-4-E2B-it`, etc. | | ✅︎ |
...
!!! note
    ...
    - Video is not a native input modality; users can pre-process videos into frames externally.
