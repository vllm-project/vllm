...
| `MistralForCausalLM` | Mistral, Mistral-Instruct | `mistralai/Mistral-7B-v0.1`, `mistralai/Mistral-7B-Instruct-v0.1`, `mistralai/Ministral-3-3B-Instruct-2512`, etc. | ✅︎ | ✅︎ |
...
| `PixtralForConditionalGeneration` | Mistral 3 (Mistral format), Pixtral (Mistral format), Mistral Large 3 (Mistral format), Ministral 3 (Mistral format) | T + I<sup>+</sup> | `mistralai/Mistral-Small-3.1-24B-Instruct-2503`, `mistralai/Pixtral-12B-2409`, `mistralai/Mistral-Large-3-675B-Instruct-2512`, `mistralai/Ministral-3-3B-Instruct-2512` etc. | | ✅︎ |
