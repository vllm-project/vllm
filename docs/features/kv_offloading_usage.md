...
| `hit_pending_timeout_s` | no | `5.0` | multi-tier | Maximum seconds a request waits for an in-flight CPU-primary write before treating that block as a miss and recomputing it locally. Must be positive. |
