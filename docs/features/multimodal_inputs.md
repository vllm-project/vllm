...
Full example: [examples/multimodal/vision_language_offline.py](../../examples/multimodal/vision_language_offline.py)
...
Full example: [examples/multimodal/vision_language_multi_image_offline.py](../../examples/multimodal/vision_language_multi_image_offline.py)
...
Full example: [examples/multimodal/audio_language_offline.py](../../examples/multimodal/audio_language_offline.py)
...
Full example: [examples/multimodal/openai_chat_completion_client_for_multimodal.py](../../examples/multimodal/openai_chat_completion_client_for_multimodal.py)
