...
Full example: [examples/offline_inference/vision_language.py](../../examples/multimodal/vision_language_offline.py)
...
Full example: [examples/offline_inference/vision_language_multi_image.py](../../examples/multimodal/vision_language_multi_image_offline.py)
...
Full example: [examples/offline_inference/audio_language.py](../../examples/multimodal/audio_language_offline.py)
...
Full example: [examples/online_serving/openai_chat_completion_client_for_multimodal.py](../../examples/multimodal/openai_chat_completion_client_for_multimodal.py)
