...
[examples/offline_inference/prompt_embed_inference.py](../../examples/generate/prompt_embed_inference.py)
...
[examples/online_serving/prompt_embed_inference_with_openai_client.py](../../examples/generate/prompt_embed_inference_with_openai_client.py)
