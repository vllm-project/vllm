...
[examples/offline_inference/prompt_embed_inference.py](../../examples/features/prompt_embed/prompt_embed_offline.py)
...
[examples/online_serving/prompt_embed_inference_with_openai_client.py](../../examples/features/prompt_embed/prompt_embed_inference_with_openai_client.py)
