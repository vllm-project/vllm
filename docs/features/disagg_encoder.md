...
`examples/online_serving/disaggregated_encoder/example_ec_connector/disagg_1e1pd_example.sh`

1 Encoder instance + 1 Prefill instance + 1 Decode instance:
`examples/online_serving/disaggregated_encoder/example_ec_connector/disagg_1e1p1d_example.sh`
