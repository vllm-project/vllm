...
!!! note
    `best_of` is omitted from these compatibility matrices because it was removed in vLLM V1. See the [V1 guide](../usage/v1_guide.md#removed-features) for details.
