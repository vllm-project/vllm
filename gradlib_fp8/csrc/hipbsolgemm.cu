    ...
    hipStream_t &stream)
{
  ...
  for (int i = 0; i < returned_algo_count; i++) {
      ...
      auto status = hipblaslt_ext::matmulIsAlgoSupported(handle, matmul,
        alpha,
        matA,
        matB,
        beta,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
  ...
  m.def("hipb_mm", &HipbSolIdxBlas, "mm", py::arg("mat1"), py::arg("mat2"), py::arg("solution_index"), py::arg("outType")=at::nullopt, py::arg("scale1")=at::nullopt, py::arg("scale2")=at::nullopt, py::arg("scaleOut")=at::nullopt);
  m.def("hipb_findallsols", &HipbFindAllSolIdxBlas, "hipblas_find_all_sols", py::arg("mat1"), py::arg("mat2"), py::arg("outType")=at::nullopt);
}
