...
#SBATCH --job-name=vllm_inference_bench
...
# Configurables
IMAGE=/lustre/fsw/portfolios/hw/users/sshrestha/nvresearch-vllm-v1.sqsh
...
INFERENCE_ARGS="--batch-size 64 \
                --input-length 4096 \
                --output-length 128 \
                --data-path ${SAVED_RESULTS_DIR}"
