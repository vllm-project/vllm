...
_TORCH_CUDA_PATTERNS = [
    r"\btorch\.cuda\.(current_stream|empty_cache|synchronize|device_count|current_device|memory_reserved|memory_allocated|max_memory_allocated|max_memory_reserved|reset_peak_memory_stats|memory_stats|set_device|device\()\b",
