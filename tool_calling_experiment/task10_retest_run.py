...
"""Task 10 Retest runner -- uses an already-running server."""
...
def main():
    ...
    print("Server is healthy. Starting experiment...")
    ...
    for i, sid in enumerate(sample_indices):
        ...
        num_tools = result.get("num_tool_calls", 0)
        ...
        print(
            f"    called_geometry={called_geometry}, "
        ...
        if geometry_metadata:
            print(
                f"    curvature={geometry_metadata.get('road_curvature', '?')}, "
