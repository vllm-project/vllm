...
// SM100 FP8 GEMM template (local copy, avoids libtorch stable includes)
#include "mla/mla_sm100_fp8_gemm.cuh"
// Local caller using regular PyTorch API (not libtorch stable)
#include "mla/mla_gemm_caller.cuh"
// clang-format on
...
void cutlass_bmm_caller_sm100_fp8(
  ...
  mla::cutlass_gemm_caller<GemmKernel>(a.device(), prob_shape, mainloop_args,
                                       epilogue_args);
}
