...
#define CALL_V2_LAUNCHER_SPARSITY(T, CACHE_T, BLOCK_SIZE, KV_DTYPE) \
  if (is_block_sparse) {                                            \
    CALL_V2_LAUNCHER(T, CACHE_T, BLOCK_SIZE, KV_DTYPE, true);       \
  } else {                                                          \
    CALL_V2_LAUNCHER(T, CACHE_T, BLOCK_SIZE, KV_DTYPE, false);      \
  }
