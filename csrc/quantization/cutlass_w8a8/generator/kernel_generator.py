...
class KernelGenerator_(ABC):
    ...
    def write_ops(generator_type: GeneratorType,
        ...
        for i in range(0, len(file_paths), batch_size):
            ...
            dir_path: Path = KernelGenerator_.GENERATE_DIR / f'{args.dtype_str}_{dir_name}'
...
class KernelGenerator(KernelGenerator_):
    ...
    @staticmethod
    def write_ops(generator_type: GeneratorType, args: Cutlass3xArgs,
                  file_paths: List[str], fn_names: List[str],
                  fn_decls: List[str]):
        return KernelGenerator_.write_ops(generator_type, args, file_paths, fn_names,
