...
void cutlass_gemm_sm75(torch::Tensor& c, torch::Tensor const& a,
                       torch::Tensor const& b);

void cutlass_gemm_sm80(torch::Tensor& c, torch::Tensor const& a,
                       torch::Tensor const& b);

void cutlass_gemm_sm89(torch::Tensor& c, torch::Tensor const& a,
                       torch::Tensor const& b);

#if defined CUDA_VERSION && CUDA_VERSION >= 12000
void cutlass_gemm_sm90(torch::Tensor& c, torch::Tensor const& a,
                       torch::Tensor const& b);
#endif

void cutlass_gemm(torch::Tensor& c, torch::Tensor const& a,
                  torch::Tensor const& b) {
  int32_t major_capability;
  int32_t minor_capability;
  cudaDeviceGetAttribute(&major_capability, cudaDevAttrComputeCapabilityMajor,
