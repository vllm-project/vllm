...
constexpr int32_t LARGE_KERNEL_GROUP_THRESHOLD = 32;
...
void silu_and_mul_per_block_quant_dispatch(
    ...
    bool use_large_kernel = (num_groups > LARGE_KERNEL_GROUP_THRESHOLD) || 
                        (num_tokens * num_groups > LARGE_KERNEL_WORK_THRESHOLD);
