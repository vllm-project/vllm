            ...
            int64_t solidx)
{
    ...
    auto d_scale_d = scale_result.has_value() ? scale_result.value().data_ptr() : nullptr;
    ...
    hipblaslt_ext::Gemm gemm(handle, transpose_a ? HIPBLAS_OP_T : HIPBLAS_OP_N,
        transpose_b ? HIPBLAS_OP_T : HIPBLAS_OP_N, HIP_R_8F_E4M3_FNUZ, HIP_R_8F_E4M3_FNUZ, hipblas_out_type,
        hipblas_out_type, HIPBLAS_COMPUTE_32F);
