...
void fused_experts_cpu_local_skip(
    at::Tensor& out, at::Tensor& hidden_states, at::Tensor& w1, at::Tensor& w2,
...
// SHM CCL
  ...
  ops.def(
      "fused_experts_cpu_local_skip(Tensor(a0!) out, Tensor hidden_states, "
      "Tensor w1, Tensor w2, Tensor topk_weights, Tensor topk_ids, "
      "Tensor expert_map, int "
      ...
      "float? alpha, float? limit, bool is_vnni) -> ()");
