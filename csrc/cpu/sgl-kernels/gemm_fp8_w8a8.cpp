...
// Carries the whole loop rather than just the conversion, as GCC cannot inline an avx10.2
// function into a caller lacking that target, so branching per vector is costly.
