...
#define GPTQ_CALL_IF_MOE_8(W_TYPE, N_BLOCKS, K_BLOCKS, NUM_THREADS)    \
  __CALL_IF_MOE_8_128(W_TYPE, 1, N_BLOCKS, K_BLOCKS, true, false, 0,   \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 2, N_BLOCKS, K_BLOCKS, true, false, 0,   \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 3, N_BLOCKS, K_BLOCKS, true, false, 0,   \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 4, N_BLOCKS, K_BLOCKS, true, false, 0,   \
                      NUM_THREADS)                                     \
                                                                       \
  __CALL_IF_MOE_8_128(W_TYPE, 1, N_BLOCKS, K_BLOCKS, false, false, -1, \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 1, N_BLOCKS, K_BLOCKS, false, false, 2,  \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 1, N_BLOCKS, K_BLOCKS, false, false, 4,  \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 1, N_BLOCKS, K_BLOCKS, false, false, 8,  \
                      NUM_THREADS)                                     \
                                                                       \
  __CALL_IF_MOE_8_128(W_TYPE, 2, N_BLOCKS, K_BLOCKS, false, false, -1, \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 2, N_BLOCKS, K_BLOCKS, false, false, 2,  \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 2, N_BLOCKS, K_BLOCKS, false, false, 4,  \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 2, N_BLOCKS, K_BLOCKS, false, false, 8,  \
                      NUM_THREADS)                                     \
                                                                       \
  __CALL_IF_MOE_8_128(W_TYPE, 3, N_BLOCKS, K_BLOCKS, false, false, -1, \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 3, N_BLOCKS, K_BLOCKS, false, false, 2,  \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 3, N_BLOCKS, K_BLOCKS, false, false, 4,  \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 3, N_BLOCKS, K_BLOCKS, false, false, 8,  \
                      NUM_THREADS)                                     \
                                                                       \
  __CALL_IF_MOE_8_128(W_TYPE, 4, N_BLOCKS, K_BLOCKS, false, false, -1, \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 4, N_BLOCKS, K_BLOCKS, false, false, 2,  \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 4, N_BLOCKS, K_BLOCKS, false, false, 4,  \
                      NUM_THREADS)                                     \
  __CALL_IF_MOE_8_128(W_TYPE, 4, N_BLOCKS, K_BLOCKS, false, false, 8,  \
                      NUM_THREADS)
