...
#define CALL_MOE_KERNEL_FUNCTION(KERNEL_FUNCTION)                              \
  else if (KERNEL_FUNCTION(a_type, q_type, thread_n_blocks, thread_k_blocks,   \
...
torch::Tensor marlin_gemm_moe(
  ...
  if (a.scalar_type() == at::ScalarType::Half) {
    marlin_moe::marlin_mm_moe(
        ...
        size_k, workspace.data_ptr(), vllm::kHalf, *b_q_type, has_act_order,
    ...
    marlin_moe::marlin_mm_moe(
        ...
        size_n, size_k, workspace.data_ptr(), vllm::kBFloat16, *b_q_type,
