...
#define __CALL_IF_MOE_8(W_TYPE, THREAD_N_BLOCKS, THREAD_K_BLOCKS,             \
...
#define AWQ_CALL_IF_MOE_8(W_TYPE, N_BLOCKS, K_BLOCKS, NUM_THREADS)          \
  __CALL_IF_MOE_8(W_TYPE, N_BLOCKS, K_BLOCKS, false, true, -1, NUM_THREADS) \
  __CALL_IF_MOE_8(W_TYPE, N_BLOCKS, K_BLOCKS, false, true, 2, NUM_THREADS)  \
  __CALL_IF_MOE_8(W_TYPE, N_BLOCKS, K_BLOCKS, false, true, 4, NUM_THREADS)  \
  __CALL_IF_MOE_8(W_TYPE, N_BLOCKS, K_BLOCKS, false, true, 8, NUM_THREADS)
