...
template __global__ void Marlin<half, vllm::kU8B128.id(), 128, 4, 4, 8, false, pipe_stages, true, false, 0, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<half, vllm::kU8B128.id(), 128, 4, 4, 8, false, pipe_stages, false, false, -1, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<half, vllm::kU8B128.id(), 128, 4, 4, 8, false, pipe_stages, false, false, 2, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<half, vllm::kU8B128.id(), 128, 4, 4, 8, false, pipe_stages, false, false, 4, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<half, vllm::kU8B128.id(), 128, 4, 4, 8, false, pipe_stages, false, false, 8, false>( MARLIN_KERNEL_PARAMS );
