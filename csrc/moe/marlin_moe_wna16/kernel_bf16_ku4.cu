...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 1, 16, 4, true, pipe_stages, false, true, -1, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 1, 16, 4, false, pipe_stages, false, true, -1, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 2, 8, 8, false, pipe_stages, false, true, -1, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 3, 8, 8, false, pipe_stages, false, true, -1, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 4, 8, 8, false, pipe_stages, false, true, -1, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 1, 16, 4, true, pipe_stages, false, true, 2, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 1, 16, 4, false, pipe_stages, false, true, 2, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 2, 8, 8, false, pipe_stages, false, true, 2, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 3, 8, 8, false, pipe_stages, false, true, 2, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 4, 8, 8, false, pipe_stages, false, true, 2, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 1, 16, 4, true, pipe_stages, false, true, 4, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 1, 16, 4, false, pipe_stages, false, true, 4, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 2, 8, 8, false, pipe_stages, false, true, 4, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 3, 8, 8, false, pipe_stages, false, true, 4, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 4, 8, 8, false, pipe_stages, false, true, 4, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 1, 16, 4, true, pipe_stages, false, true, 8, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 1, 16, 4, false, pipe_stages, false, true, 8, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 2, 8, 8, false, pipe_stages, false, true, 8, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 3, 8, 8, false, pipe_stages, false, true, 8, false>( MARLIN_KERNEL_PARAMS );
...
template __global__ void Marlin<nv_bfloat16, vllm::kU4.id(), 256, 4, 8, 8, false, pipe_stages, false, true, 8, false>( MARLIN_KERNEL_PARAMS );
