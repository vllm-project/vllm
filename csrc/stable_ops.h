...
void static_scaled_fp8_quant(torch::stable::Tensor& out,
                             const torch::stable::Tensor& input,
...
void dynamic_per_token_scaled_fp8_quant(
    torch::stable::Tensor& out, const torch::stable::Tensor& input,
    torch::stable::Tensor& scales,
    const std::optional<torch::stable::Tensor>& scale_ub);
