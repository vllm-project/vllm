...
void dsa_litetopk_seed_prep(const torch::stable::Tensor& slog, int64_t num_buckets,
                            int64_t topk, int64_t cand_cap, int64_t emit_limit, double headroom,
...
void dsa_litetopk_scan(const torch::stable::Tensor& q, const torch::stable::Tensor& kv,
                       const torch::stable::Tensor& kv_scales, const torch::stable::Tensor& weights,
                       const torch::stable::Tensor& cu_start, const torch::stable::Tensor& cu_end,
                       torch::stable::Tensor& origin, torch::stable::Tensor& inv_delta,
                       torch::stable::Tensor& th_bucket, torch::stable::Tensor& cand_val,
                       torch::stable::Tensor& cand_idx, torch::stable::Tensor& cand_cnt,
                       torch::stable::Tensor& bcount, int64_t num_buckets, int64_t topk,
                       int64_t refresh_every, int64_t num_kv_splits_override, int64_t probe_group,
                       int64_t probe_add_max);

void dsa_litetopk_select(const torch::stable::Tensor& cand_val,
                         const torch::stable::Tensor& cand_idx,
                         const torch::stable::Tensor& cand_cnt, const torch::stable::Tensor& origin,
                         const torch::stable::Tensor& inv_delta,
                         const torch::stable::Tensor& th_bucket, int64_t num_buckets, int64_t topk,
                         torch::stable::Tensor& out_val, torch::stable::Tensor& out_idx);
