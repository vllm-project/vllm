...
STABLE_TORCH_LIBRARY_FRAGMENT(_C, ops) {
  ...
  ops.def(
      "fused_deepseek_v4_kv_rope_quant_insert("
  ...
  ops.def(
      ...
      "Tensor kv, Tensor norm_weight, Tensor! k_cache, Tensor slot_mapping, "
      "Tensor position_ids, Tensor cos_sin_cache, float eps, "
      "int cache_block_size) -> ()");
...
STABLE_TORCH_LIBRARY_IMPL(_C, CUDA, ops) {
  ...
  ops.impl("fused_deepseek_v4_kv_rope_quant_insert",
           TORCH_BOX(&fused_deepseek_v4_kv_rope_quant_insert));
  ops.impl("fused_deepseek_v4_kv_norm_rope_quant_insert",
           TORCH_BOX(&fused_deepseek_v4_kv_norm_rope_quant_insert));
  ops.impl(
      "fused_deepseek_v4_qnorm_rope_kv_rope_full_cache_bf16_insert",
