...
void concat_and_cache_mla_rope_fused(
  ...
  STD_TORCH_CHECK(kv_cache_slot_mapping.size(0) == num_tokens);
  STD_TORCH_CHECK(kv_cache_slot_mapping.scalar_type() ==
                  torch::headeronly::ScalarType::Long);
