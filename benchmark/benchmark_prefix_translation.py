...
from benchmark.trace import generate_translation_requests
...
def main(args: argparse.Namespace):
    ...
    # Generate requests.
    prefix_tokens, requests = generate_translation_requests(
        model=args.model,
    ...
    # #
    # _, input_tokens, sampling_params = requests.pop(3)
    # frontend._add_query(input_tokens, sampling_params, arrival_time=0.0)
    # server.add_sequence_groups(frontend.get_inputs())
    ...
    #             # Es war ein echter Herzschmerzenstod
