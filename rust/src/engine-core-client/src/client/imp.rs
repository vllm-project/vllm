...
impl ClientInner {
    ...
    ///
    /// Used when a terminal Abort/Error stop ends the session, or when a continuation
    /// ADD is committed after the session was already removed. The wire command is the
