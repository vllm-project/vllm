...
pub use vllm_parser::tool::{
    ...
    LongcatToolParser, MinimaxM2ToolParser, MinimaxM3ToolParser, MistralToolParser,
    Phi4MiniJsonToolParser, Qwen3CoderToolParser, Qwen3XmlToolParser, ToolParser, ToolParserError,
};
...
impl ToolParserFactory {
    ...
    pub fn new() -> Self {
        ...
        factory
            ...
            .register_parser::<LongcatToolParser>(names::LONGCAT)
        ...
        factory
            ...
            .register_pattern("longcat", names::LONGCAT);
