...
pub use vllm_parser::tool::{
    ...
    DeepSeekV41ToolParser, Ernie45ToolParser, Glm45MoeToolParser, Glm47MoeToolParser,
    Granite4ToolParser, HermesToolParser, Internlm2ToolParser, KimiK2ToolParser,
    Llama3JsonToolParser, MiMoToolParser, MinimaxM2ToolParser, MinimaxM3ToolParser,
