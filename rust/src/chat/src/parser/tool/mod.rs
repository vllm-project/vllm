...
pub use vllm_parser::tool::{
    ...
    Qwen3XmlToolParser, SeedOssToolParser, ToolParser, ToolParserError, XlamToolParser,
};
...
impl ToolParserFactory {
    ...
    pub fn new() -> Self {
        ...
        factory
            ...
            .register_parser::<XlamToolParser>(names::XLAM);
        ...
        factory
            ...
            .register_pattern("xlam", names::XLAM)
            .register_pattern("xLAM", names::XLAM);
