...
class CacheEngine:
    ...
    def __init__(
        ...
        if self.enable_external_swapper:
            ...
            if self.num_external_blocks:
                self.num_external_blocks //= parallel_config.pipeline_parallel_size
            ...
            if self.cache_config.external_swapper:
                external_swapper_impl = ExternalSwapperBase.get_external_swapper_class(
    ...
    def _get_cache_engine_identifier(self) -> str:
        ...
        return f"cache_engine_rank_{self.rank}_pipeline_parallel_{self.pipeline_parallel_id}"
