...
from vllm.worker.multi_step_mlu_model_runner import (MLUMultiStepModelRunner,
                                                     MLUStatefulModelInput)
from vllm.worker.mlu_worker import MLUWorker, WorkerInput
...
class MLUMultiStepWorker(MLUWorker):
    ...
    def _prepare_last_sampled_token_ids_for_tp_workers(
        ...
        if get_pp_group().is_last_rank:
            ...
            # we need it for MLU advance_step.
