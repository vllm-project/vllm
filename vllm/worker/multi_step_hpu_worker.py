...
class MultiStepHPUWorker(HPUWorker):
    ...
    def _get_driver_input_and_broadcast(
        ...
        if is_first_multi_step:
            ...
            worker_input = dataclasses.replace(
                worker_input, num_steps=execute_model_req.num_lookahead_slots + 1)
            model_input: ModelInputForHPU = (self.model_runner.prepare_model_input(
    ...
    ) -> Optional[Tuple[ModelInputForHPU, WorkerInput, Dict[str, torch.Tensor]]]:
