...
"""BerryLM parser for tool calls and reasoning.

BerryLM XML tool call format::
...
The ``_berrylm_arg_converter`` parses these into a JSON object.
"""
...
def _berrylm_arg_converter(raw_args: str, partial: bool) -> str:
...
def berrylm_config(
    ...
    *,
    ...
    return ParserEngineConfig(
        ...
        arg_converter=_berrylm_arg_converter,
...
class BerryLMParser(ParserEngine):
    """BerryLM parser: ``<think>``/``</think>`` reasoning +
