...
def _triton_fused_qk_norm_rope(qkv, q_weight, k_weight, position_ids, cos_sin_cache, cos_sin_cache_stride_0, cos_sin_cache_stride_1, k_weight_stride_0, position_ids_stride_0, q_weight_stride_0, qkv_stride_0, qkv_stride_1, qkv_stride_2, eps, is_neox, qk_heads: tl.constexpr, _BLOCK_SIZE_2: tl.constexpr, head_dim: tl.constexpr, num_heads_q: tl.constexpr, embed_dim: tl.constexpr):
    ...
    x2_blk = tl.load(qkv + (indices_0[:, None, None] * qkv_stride_0 + indices_1[None, :, None] * qkv_stride_1 + v_13[None, None, :] * qkv_stride_2), mask_1[None, :, None], other=0)
