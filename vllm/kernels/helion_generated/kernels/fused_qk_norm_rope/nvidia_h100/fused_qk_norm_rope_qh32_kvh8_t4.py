...
def _triton_fused_qk_norm_rope(qkv, q_weight, k_weight, position_ids, cos_sin_cache, cos_sin_cache_stride_0, cos_sin_cache_stride_1, k_weight_stride_0, position_ids_stride_0, q_weight_stride_0, qkv_stride_0, qkv_stride_1, qkv_stride_2, eps, is_neox, _BLOCK_SIZE_2: tl.constexpr, head_dim: tl.constexpr, qk_heads: tl.constexpr, num_heads_q: tl.constexpr, embed_dim: tl.constexpr):
    ...
    load = tl.load(qkv + (indices_0[:, None, None] * qkv_stride_0 + indices_1[None, :, None] * qkv_stride_1 + indices_2[None, None, :] * qkv_stride_2), mask_1[None, :, None] & mask_2[None, None, :], other=0, eviction_policy='evict_first')
    ...
    load_2 = tl.load(k_weight + indices_2[None, None, :] * k_weight_stride_0, mask_2[None, None, :], other=0, eviction_policy='evict_last')
    ...
    if is_neox:
        ...
        v_13 = x1_offset + v_16
    tl.debug_barrier()
    x1_blk = tl.load(qkv + (indices_0[:, None, None] * qkv_stride_0 + indices_1[None, :, None] * qkv_stride_1 + x1_offset[None, None, :] * qkv_stride_2), mask_1[None, :, None], other=0, eviction_policy='evict_first')
    x2_blk = tl.load(qkv + (indices_0[:, None, None] * qkv_stride_0 + indices_1[None, :, None] * qkv_stride_1 + v_13[None, None, :] * qkv_stride_2), mask_1[None, :, None], other=0, eviction_policy='evict_last')
