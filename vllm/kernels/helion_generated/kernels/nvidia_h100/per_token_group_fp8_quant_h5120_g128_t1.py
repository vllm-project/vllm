...
def call(input: torch.Tensor, output_q: torch.Tensor, output_s: torch.Tensor, group_size: int, eps: float, fp8_min: float, fp8_max: float, scale_ue8m0: bool, dummy_is_scale_transposed: bool=False, dummy_is_tma_aligned: bool=False, *, _launcher=_default_launcher):
    ...
    _BLOCK_SIZE_2 = 128
    _launcher(_triton_per_token_group_fp8_quant, (40 * 1 * ((128 + _BLOCK_SIZE_2 - 1) // _BLOCK_SIZE_2),), input, output_s, output_q, input.stride(1), input.stride(2), output_q.stride(1), output_q.stride(2), output_s.stride(0), output_s.stride(1), eps, fp8_max, scale_ue8m0, fp8_min, num_warps=1, num_stages=4)
