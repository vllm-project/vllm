...
@triton.jit
def _triton_per_token_group_fp8_quant(input_1, output_s, output_q, input_1_stride_0, input_1_stride_1, input_1_stride_2, output_q_stride_0, output_q_stride_1, output_q_stride_2, output_s_stride_0, output_s_stride_1, num_tokens, eps, fp8_max, scale_ue8m0, fp8_min, _NUM_SM: tl.constexpr, groups_per_row: tl.constexpr, _BLOCK_SIZE_2: tl.constexpr, group_size: tl.constexpr):
    total_pids = tl.cdiv(groups_per_row, _BLOCK_SIZE_1) * tl.cdiv(group_size, _BLOCK_SIZE_2) * num_tokens
