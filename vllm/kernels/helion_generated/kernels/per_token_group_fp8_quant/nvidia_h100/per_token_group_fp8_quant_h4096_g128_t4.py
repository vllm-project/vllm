...
def _triton_per_token_group_fp8_quant(input_1, output_s, output_q, input_1_stride_0, input_1_stride_1, input_1_stride_2, output_q_stride_0, output_q_stride_1, output_q_stride_2, output_s_stride_0, output_s_stride_1, eps, fp8_max, scale_ue8m0, fp8_min, _BLOCK_SIZE_2: tl.constexpr, group_size: tl.constexpr, groups_per_row: tl.constexpr):
    ...
    num_blocks_1 = groups_per_row
    num_pid_m = tl.cdiv(group_size, _BLOCK_SIZE_2)
    num_pid_n = groups_per_row
    ...
    x_blk = tl.load(input_1 + (indices_0[:, None, None] * input_1_stride_0 + indices_1[None, :, None] * input_1_stride_1 + indices_2[None, None, :] * input_1_stride_2), mask_2[None, None, :], other=0, eviction_policy='evict_first')
    v_0 = tl.abs(x_blk)
    ...
    tl.store(output_q + (indices_0[:, None, None] * output_q_stride_0 + indices_1[None, :, None] * output_q_stride_1 + indices_2[None, None, :] * output_q_stride_2), v_14, mask_2[None, None, :])
