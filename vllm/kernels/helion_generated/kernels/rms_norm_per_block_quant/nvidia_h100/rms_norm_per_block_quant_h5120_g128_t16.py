...
def _triton_rms_norm_per_block_quant(input_1, residual, weight, scale_ub, scale, result, input_1_stride_0, input_1_stride_1, residual_stride_0, residual_stride_1, result_stride_0, result_stride_1, scale_stride_0, scale_stride_1, weight_stride_0, epsilon):
    ...
    for offset_1 in tl.range(0, 5120, _BLOCK_SIZE_1, disallow_acc_multi_buffer=False, flatten=True):
    ...
    tl.debug_barrier()
    for offset_2 in tl.range(0, 40, _BLOCK_SIZE_2, disallow_acc_multi_buffer=True, flatten=True):
        ...
        for offset_3 in tl.range(0, 128, _BLOCK_SIZE_3):
            ...
            v_18 = v_16 + v_17
            w_blk = tl.load(weight + n_blk * weight_stride_0, mask_2[None, :, None] & mask, other=0, eviction_policy='evict_last')
