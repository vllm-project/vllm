...
def _triton_rms_norm_per_block_quant(input_1, weight, scale, result, input_1_stride_0, input_1_stride_1, result_stride_0, result_stride_1, scale_stride_0, scale_stride_1, weight_stride_0, epsilon):
    ...
    for offset_1 in tl.range(0, 2048, _BLOCK_SIZE_1, disallow_acc_multi_buffer=False, flatten=True):
    ...
    m_blk = v_8[:, None, None]
    tl.debug_barrier()
    for offset_2 in tl.range(0, 16, _BLOCK_SIZE_2, disallow_acc_multi_buffer=True):
