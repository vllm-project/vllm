...
def advance_step(num_prefill_tokens: int,
                 num_prefills: int,
                 num_seqs: int, num_queries: int, block_size: int, token_chunk_size: int,
    ...
    return torch.ops._C.advance_step(num_prefill_tokens, num_prefills, num_seqs, num_queries, block_size,
                                     token_chunk_size,
