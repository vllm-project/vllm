...
def sparse_mla_cache_plan(
    ...
    request_block_ids: torch.Tensor,
    request_num_blocks: torch.Tensor,
    request_num_tokens: torch.Tensor,
    request_generation: torch.Tensor,
    request_active: torch.Tensor,
    req_id_per_token: torch.Tensor,
    topk_logical_ids: torch.Tensor,
    resident_main_kv: torch.Tensor,
    resident_logical_ids: torch.Tensor,
    resident_last_access: torch.Tensor,
    resident_generation: torch.Tensor,
    newest_main_kv: torch.Tensor,
    newest_logical_ids: torch.Tensor,
    newest_generation: torch.Tensor,
    topk_physical_ids: torch.Tensor,
    topk_hit_mask: torch.Tensor,
    miss_logical_ids: torch.Tensor,
    miss_victim_slots: torch.Tensor,
    miss_counts: torch.Tensor,
    hit_counts: torch.Tensor,
    num_host_blocks: int,
) -> None:
    torch.ops._C.sparse_mla_cache_plan(
        current_main_kv,
        request_block_ids,
        request_num_blocks,
        request_num_tokens,
...
def sparse_mla_offload_transfer(
    main_host_kv_uva: torch.Tensor,
    request_block_ids: torch.Tensor,
    request_num_blocks: torch.Tensor,
    request_num_tokens: torch.Tensor,
    request_generation: torch.Tensor,
    ...
    torch.ops._C.sparse_mla_offload_transfer(
        main_host_kv_uva,
        request_block_ids,
        request_num_blocks,
        request_num_tokens,
