...
class IncrementalDetokenizer:
    ...
    def from_new_request(
        ...
        if USE_FAST_DETOKENIZER and isinstance(tokenizer, PreTrainedTokenizerFast):
            ...
            return FastIncrementalDetokenizer(vllm_config, tokenizer, request)

        # Fall back to slow python-based incremental detokenization.
        return SlowIncrementalDetokenizer(vllm_config, tokenizer, request)
...
class FastIncrementalDetokenizer(BaseIncrementalDetokenizer):
    def __init__(
        ...
        super().__init__(vllm_config=vllm_config, tokenizer=tokenizer, request=request)
...
class StopChecker:
    def __init__(self, vllm_config: VllmConfig, tokenizer: TokenizerLike):
        self.reasoning_parser: ReasoningParser | None = None
