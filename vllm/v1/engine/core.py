...
try:
    from tpu_commons.interfaces.engine import IEngineCore, IEngineCoreProc
except ImportError:
    ...
    class IEngineCoreProc(Protocol):  # type: ignore[no-redef]
        pass
...
class EngineCoreProc(EngineCore, IEngineCoreProc):
