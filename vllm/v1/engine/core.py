...
class EngineCore:
    ...
    def __init__(
        ...
        # Level 0 sleep state - when True, scheduling is paused but requests accepted
    ...
    def step(self) -> tuple[dict[int, EngineCoreOutputs], bool]:
        ...
        # If scheduling is paused (level 0 sleep), don't process anything
    ...
    def is_sleeping(self) -> bool:
        ...
        return self.scheduling_paused or self.model_executor.is_sleeping
