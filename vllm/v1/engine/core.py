...
class EngineCore:
    ...
    def get_kv_cache_group_metadata(self) -> list[dict[str, int | str | None]]:
        """Return msgspec-serializable scheduler KV-cache group metadata.

        This utility RPC is consumed by external integrations such as Dynamo,
        so it may not have an in-tree caller.
