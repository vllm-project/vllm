...
class EngineCore:
    ...
    def __init__(
        ...
        if self.scheduler.connector is not None:  # type: ignore
            ...
            if (
                hasattr(self.scheduler.connector, "connector_scheduler")
                and self.scheduler.connector.connector_scheduler is not None
            ):
                self.scheduler.connector.connector_scheduler.set_model_executor(
                    self.model_executor
                )
                logger.info(
                    "Set model_executor reference for P scheduler push triggers"
                )
