...
# 1. multprocess executor.submit(step_with_batch_queue)
# 2. multi thread executor.submit(step_with_batch_queue)
# 3. async io 
    ...
    def print_model_output(self, model_output):
        for req_id in model_output.req_ids:
            ...
            logger.info(f'model output {req_id}:{model_output.sampled_token_ids[index]}')
