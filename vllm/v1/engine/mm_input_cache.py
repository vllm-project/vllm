...
class MirroredProcessingCache:
    ...
    def __init__(self, vllm_config, is_writer: bool = False):
        ...
        if self.use_cache:
            self.mm_cache_type = mm_config.mm_preprocessor_cache_type
            if self.mm_cache_type == "shm":
                ...
                raise ValueError("Unsupported mm_preprocessor_cache_type: "
                                 f"{self.mm_cache_type}. "
                                 "Supported types are 'shm' and 'lru'.")
