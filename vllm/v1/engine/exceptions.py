...
class MaxPendingTokensError(GracefulHTTPError):
    ...
    def __init__(self):
        super().__init__("Request queue reached max pending tokens limit.",
...
class MaxTierPendingTokensError(GracefulHTTPError):
    ...
    def __init__(self):
        super().__init__("Request queue reached max pending tokens for tier.",
...
class TooManyRequestsError(GracefulHTTPError):
    ...
    def __init__(self):
        super().__init__("Rate limit reached for given tier.",
                         HTTPStatus.TOO_MANY_REQUESTS)
