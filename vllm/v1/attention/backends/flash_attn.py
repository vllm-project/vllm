...
class FlashAttentionImpl(AttentionImpl):
    ...
    def __init__(
        ...
        # FA4's SM90 fp8-KV path consumes the native (bf16) Q directly (q_descale=None)
        # and dequants fp8 K/V in-kernel. So for FA4 impls we report False here: the layer
        # then skips creating/applying query_quant, leaving Q in its native bf16 dtype,
        # which the kernel narrows to its fp16 compute dtype internally.
