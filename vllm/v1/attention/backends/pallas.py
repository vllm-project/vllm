...
class PallasMetadata(PallasMetadataBase):
    """Wrapper for PallasMetadata implementation from tpu_commons."""
    pass

class PallasAttentionBackend(PallasAttentionBackendBase):
    """Wrapper for PallasAttentionBackend implementation from tpu_commons."""
    pass
