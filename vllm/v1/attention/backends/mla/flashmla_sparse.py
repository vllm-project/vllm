...
In the "nvfp4_fp8_ds_mla" format (SM100 only, DeepSeek V3.2 geometry), each
...
QUANTIZED_DS_MLA_CACHE_FORMATS: frozenset[str] = frozenset(
    {"fp8_ds_mla", "nvfp4_fp8_ds_mla"}
)

DS_MLA_BYTES_PER_TOKEN: dict[str, int] = {
    "fp8_ds_mla": 656,
    "nvfp4_fp8_ds_mla": 352,
}
...
class FlashMLASparseBackend(AttentionBackend):
    ...
    supported_kv_cache_dtypes: ClassVar[list[CacheDType]] = [
        ...
        "nvfp4_fp8_ds_mla",  # NVFP4 NoPE + FP8 RoPE (SM100 only)
    ]
    ...
    def supports_combination(
        ...
        if kv_cache_dtype == "nvfp4_fp8_ds_mla" and device_capability.major != 10:
            return (
    ...
    def get_kv_cache_shape(
        ...
        if cache_dtype_str in DS_MLA_BYTES_PER_TOKEN:
            # Custom per-token byte storage formats. See module docstring.
            return (num_blocks, block_size, DS_MLA_BYTES_PER_TOKEN[cache_dtype_str])
        else:
