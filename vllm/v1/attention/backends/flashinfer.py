...
class FlashInferMetadataBuilder(AttentionMetadataBuilder[FlashInferMetadata]):
    ...
    def get_q_data_type(self, is_prefill: bool) -> torch.dtype:
        ...
        # keeps the model dtype except on the PRIMS backend (handled below).
        if (
            (
        ...
        if cache_dtype.startswith("fp8"):
            ...
            # Architectures with only fa2 (e.g. SM89, SM120) cannot consume
            # FP8 queries, except SM120 prefill on the PRIMS backend.
            if (
                current_platform.is_device_capability(90)
    ...
    def forward(
        ...
        Args:
            ...
            value: shape = [num_tokens, num_kv_heads, head_size], or None for a
                KV-sharing decoder layer.
            kv_cache: [num_blocks, num_kv_heads, block_size, 2*head_size] with
                K/V packed in the content dimension, or separate K/V head
