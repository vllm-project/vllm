...
# ===== SELF-SPEC: Selective KV Concatenation Kernel =====
...
try:
    ...
    # Triton not available, define a dummy function
    logger.warning("Triton not available, concat_kv_indices_kernel will not be available")
    concat_kv_indices_kernel = None
