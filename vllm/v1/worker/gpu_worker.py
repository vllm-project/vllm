...
class Worker(WorkerBase):
    ...
    def resume_distributed(self, distributed_init_method: str | None = None) -> None:
        """Rebuild NCCL after snapshot restore.

        Args:
            distributed_init_method: Fresh TCP rendezvous address
                generated by the executor so all workers share the
                same address.  The pre-snapshot address is stale after
                CRIU restore (container IP changes).
        """
