...
def setup_worker_process_title_and_logging(enable_ep: bool = False) -> None:
    ...
    This function fetches parallelism information from vllm.distributed.parallel_state
    and constructs a meaningful process title and logging prefix for debugging purposes.
