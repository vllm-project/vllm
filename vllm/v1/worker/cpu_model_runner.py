...
class CPUModelRunner(GPUModelRunner):
    ...
    def _may_reorder_batch(self, scheduler_output: "SchedulerOutput") -> None:
        ...
        # CPU runner uses the first attention metadata builder
        first_builder = self.attn_groups[0][0].get_metadata_builder()
        assert type(first_builder) is TorchSDPAMetadataBuilderV1

        first_builder.reorder_batch(self.input_batch, scheduler_output)
