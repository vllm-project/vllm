...
class TPUWorker:
    ...
    def determine_available_memory(self) -> int:
        ...
        # the dynamo cache and cached bytecode to ensure model always has 1
        # compiled bytecode. Having 1 FX graph/cached bytecode per compiled
        # model is required for `support_torch_compile` decorator to skip dynamo
        # guard.
