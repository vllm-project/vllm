...
class GPUModelRunner(LoRAModelRunnerMixin, KVConnectorModelRunnerMixin):
    def __init__(
        ...
        # Initialize in _allocate_uniform_kv_caches
    ...
    def use_uniform_kv_cache(self, kv_cache_config: KVCacheConfig) -> bool:
        """
        ...
        if not self.kv_connector_prefers_cross_layer_blocks():
            return False
    ...
    def _allocate_uniform_kv_caches(
        ...
        permuted_kv_cache = self.cross_layers_kv_cache.permute(*inv_order)
    ...
    def initialize_kv_cache_tensors(
        ...
        if self.use_uniform_kv_cache(kv_cache_config):
            kv_caches = self._allocate_uniform_kv_caches(kv_cache_config)
        else:
