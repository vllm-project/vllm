...
class GPUModelRunner(LoRAModelRunnerMixin, KVConnectorModelRunnerMixin):
    ...
    def _update_computed_tokens(
        ...
        for the request.
        """
        # enable both async_scheduling and spec_decode, we need to update
    ...
    def _prepare_input_ids(
        ...
        total_without_spec = total_num_scheduled_tokens - scheduler_output.total_num_scheduled_spec_tokens  # noqa
        ...
        for req_id, cur_index in self.input_batch.req_id_to_index.items():
            ...
            prev_sampled_tokens = req_state.prev_sampled_tokens if req_state is not None else None  # noqa
            request_is_resumed = prev_sampled_tokens is not None
            if prev_index is not None or request_is_resumed:
