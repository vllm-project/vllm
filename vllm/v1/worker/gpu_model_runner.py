...
class GPUModelRunner(
    ...
    def __init__(
        ...
        self.input_batch = InputBatch(
            ...
            # Async scheduling `-1` placeholder repair is only needed when some
            # processor reads output token id values. Thinking-budget tracking is
            # requested dynamically when a budgeted request is in the batch.
