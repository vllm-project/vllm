...
class GPUModelRunner(
    ...
    def _preprocess(
        ...
        if self.supports_mm_inputs and is_first_rank and not is_encoder_decoder:
            ...
            # below).
            # Find token-id positions on CPU (is_token_ids.np is always kept
            # in sync in _prepare_inputs) and upload indices non-blocking, so
            # this step does not force a GPU sync from .nonzero().
