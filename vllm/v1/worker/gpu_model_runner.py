...
from vllm.v1.attention.backends.turboquant_attn import TurboQuantMetadataBuilder
    ...
    def _build_attention_metadata(
        ...
        def _build_attn_group_metadata(
            ...
            if use_spec_decode and isinstance(
                ...
                assert ubid is None, (
                    "UBatching is not supported with these spec-decode "
                    "attention builders yet"
                )
