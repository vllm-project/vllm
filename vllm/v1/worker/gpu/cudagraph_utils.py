...
def _is_compatible(
    ...
    return (
        ...
        and (
            desc.max_req_tokens is None
            or (max_req_tokens > 0 and desc.max_req_tokens >= max_req_tokens)
        )
...
class CudaGraphManager:
    ...
    def _init_candidates(self) -> None:
        ...
        def decode_descs(
            ...
            if self.varlen_spec_decode and num_tokens <= max_decode_tokens:
                yield BatchExecutionDescriptor(
                    cg_mode=decode_mode,
...
def prepare_inputs_to_capture(
    ...
    input_batch.max_req_tokens = max_req_tokens
