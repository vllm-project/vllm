...
def get_parallel_drafting_token_id(hf_config) -> int:
    ...
    Checks (in order): `dflash_config.mask_token_id`, `mask_token_id`,
    `pard_token`, `ptd_token_id`. Raises ValueError if none are present.
    """
    ...
    raise ValueError(
        ...
        " `mask_token_id`, `pard_token`, or `ptd_token_id` for parallel drafting."
    )
