...
# a single transfers spec (src_spec, dst_spec)
...
# submission queue of transfers (job_id, (src_spec, dst_spec)))
...
class OffloadingWorker:
    ...
    def initiate_shutdown(self):
        ...
        dummy_transfer = (-1, (DummyLoadStoreSpec(), DummyLoadStoreSpec()))
...
class OffloadingQueueManager:
    ...
    def transfer_async(self, spec: TransferSpec) -> int:
        """
        ...
        Returns:
            An integer representing a unique job ID for this transfer.
        """
        src, dst = spec
        worker = self.workers.get((src.medium(), dst.medium()))
