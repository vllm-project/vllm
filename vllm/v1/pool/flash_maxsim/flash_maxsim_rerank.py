...
The kernel reads doc embeddings directly from a packed [total_tokens, d]
tensor using per-doc (offset, length) pairs — no padding, no per-doc
tensors, no materialised [B, Lq, Ld] similarity tensor.
