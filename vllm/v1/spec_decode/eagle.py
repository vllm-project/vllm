...
class EagleProposer:
    ...
    def propose(
        ...
        draft_hidden_states = hidden_states[last_token_indices].view(
            batch_size, 1, -1)
        ...
        for level in range(tree_depth - 1):
            ...
            if (self.first_branching_level is not None
                ...
                query_len = 1
                tree_input_ids = draft_token_ids
                tree_positions = draft_positions
                tree_hidden_states = draft_hidden_states
