...
class DFlashProposer(SpecDecodeBaseProposer):
    ...
    def set_inputs_first_pass(
        ...
        self._ensure_slot_mapping_buffers()
        draft_kv_gids = self._draft_kv_gids()
        for kv_cache_gid in draft_kv_gids:
        ...
        primary_kv_gid = draft_kv_gids[0]
        query_slot_mapping = self._slot_mapping_buffers_by_gid[primary_kv_gid][1][
            :num_query_total
        ]
        ...
        new_cad = CommonAttentionMetadata(
            ...
            block_table_tensor=self._get_dflash_block_table(primary_kv_gid, cad),
