...
class EagleProposer:
    ...
    def generate_draft_token_ids(
       ...
       """
        ...
        target model to run a prefill in the Eagle to make the KV cache of Eagle
        same as that of the target model for previous tokens. Once the prefill
        ...
        Hidden States -[EH11,EH12,EH13,EH14,EH21,EH22,EH23,EH31]
        Sampled Tokens - [[T16],[T25],[T33']]

        Eagle Speculation Pass
        Sequences - [S1, S2, S3]
        Tokens - [T16, T25, T33']
        Positions - []
        Previous Hidden States - [EH14,EH23,EH31]
        Hidden States -[EH15,EH24,EH32]
        ...
        for req_idx in range(len(eagle_seq_lens)):
            ...
            if is_prefill[req_idx]:
                ...
                # is a completed prefill then use the last sampled token.
                ...
                # Handle non-prefill: Copy sampled token IDs
                eagle_input_ids[eagle_start_loc :\
        ...
        # Compute logits indices for sequences that are NOT partial prefills
        logits_indices = (
