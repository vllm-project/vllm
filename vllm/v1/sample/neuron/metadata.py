...
@dataclass
class NeuronSupportedSamplingMetadata:
    # This class exposes a more xla-friendly interface than SamplingMetadata
    # on Neuron, in particular all arguments should be traceable and no
    # optionals are allowed, to avoid graph recompilation on Nones.
    ...
    ) -> "NeuronSupportedSamplingMetadata":
        """
