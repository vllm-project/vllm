...
class Sampler(nn.Module):
    ...
    def __init__(
        ...
        self.chinese_mask: torch.Tensor | None = None
        self.custom_chinese_masks: dict[str, torch.Tensor] = {}
                            ...
                            if path:
                                ...
                                if path not in self.custom_chinese_masks:
                                    try:
                                        ...
                                        if default_mask is not None:
                                            self.custom_chinese_masks[path] = (
                                                default_mask
                                            )
                                req_mask = self.custom_chinese_masks.get(path)
                            else:
