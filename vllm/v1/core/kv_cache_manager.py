...
class KVCacheManager:
    ...
    def allocate_slots(
        ...
        # P/D: delay caching blocks if we have to recv from remote. Requests
        # may also opt out of populating the local prefix cache while retaining
        # the ability to read an existing cached prefix.
        if delay_cache_blocks or request.skip_writing_prefix_cache:
