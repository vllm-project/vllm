...
def resolve_kv_cache_block_sizes(
    ...
    # MRv2 PCP+DCP (dcp == pcp > 1): the KV cache is REPLICATED, so the
    # scheduler/hash block size is NOT inflated by dcp (pure-DCP keeps it).
    cache_dcp = 1 if (dcp > 1 and dcp == pcp) else dcp
