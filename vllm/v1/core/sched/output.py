...
class NewRequestData:
    ...
    def from_request(
        ...
        return cls(
            ...
            prompt_token_ids=request.params.prompt_token_ids,
            mm_inputs=request.params.mm_inputs,
            mm_hashes=request.params.mm_hashes,
            mm_positions=request.params.mm_positions,
            sampling_params=request.params.sampling_params,
            block_ids=block_ids,
            num_computed_tokens=request.num_computed_tokens,
            lora_request=request.params.lora_request,
        )
