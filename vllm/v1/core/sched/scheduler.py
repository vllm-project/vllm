...
class Scheduler(FlowPrefillMixin, SchedulerInterface):
    ...
    def schedule(self, throttle_prefills: bool = False) -> SchedulerOutput:
        ...
        # NOTE: resumption is not gated on defer_prefills — a suspended
        # prefill that just cleared its checkpoint is not new prefill
        # compute demand from this step's perspective, it's completing
        # work already budgeted for in an earlier step. Revisit if DP
        # prefill balancing needs stricter joint accounting.
