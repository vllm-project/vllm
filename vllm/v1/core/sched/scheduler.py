...
class Scheduler(SchedulerInterface):
    ...
    def schedule(self) -> SchedulerOutput:
        ...
        if not preempted_reqs:
            token_budget, req_index, encoder_compute_budget = \
            self._schedule_waiting_requests(token_budget,
                skipped_waiting_requests, req_index, scheduled_loras,
                scheduled_timestamp, scheduled_new_reqs,
                scheduled_resumed_reqs, req_to_new_blocks,
                num_scheduled_tokens, scheduled_encoder_inputs,
                encoder_compute_budget)
    ...
    def _schedule_waiting_requests(
        ...
        while self.waiting and token_budget > 0:
            ...
            # Request was not popped from self.waiting previously.
