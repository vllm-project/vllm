...
class Scheduler(SchedulerInterface):
    ...
    def update_from_output(
        ...
        worker_timing_samples = model_runner_output.worker_timing_samples
    ...
    def make_stats(
        ...
        perf_stats: PerfStats | None = None,
        worker_timing_samples: list[WorkerTimingStats] | None = None,
    ) -> SchedulerStats | None:
        ...
        return SchedulerStats(
            ...
            worker_timing_samples=worker_timing_samples or [],
        )
