...
class Scheduler(SchedulerInterface):
    def __init__(
        ...
        # resume there in place; hybrid groups (sliding windows, recurrent
        # states) start the request over from the prefix cache instead.
    ...
    def _update_requests_with_invalid_blocks(
        ...
        for request in requests:
            ...
            # tokens
            num_loaded_tokens = request.num_computed_tokens - num_scheduled_tokens.get(
                req_id, 0
            )
            ...
            # group holds it.
            num_valid_tokens = num_loaded_tokens
