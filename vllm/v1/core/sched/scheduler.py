...
class Scheduler(SchedulerInterface):
    ...
    def make_stats(
        ...
        return SchedulerStats(
            ...
            num_kv_cache_total_blocks=self.kv_cache_manager.num_total_blocks,
            num_prefix_cached_blocks=self.kv_cache_manager.num_cached_blocks,
            num_prefix_cached_tokens=self.kv_cache_manager.num_cached_tokens,
