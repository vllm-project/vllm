...
class BitmaskStructuredOutputBackend(StructuredOutputBackend):
    ...
    def __init__(self, vllm_config: VllmConfig, tokenizer: AnyTokenizer,
        ...
        self.strategy: BitmaskStrategy = strategy
    ...
    def grammar_bitmask(
        ...
        if self._grammar_bitmask is None:
            ...
            self._grammar_bitmask = \
                self.strategy.allocate_token_bitmask(
    ...
    def compile_grammar(self, request_type: StructuredOutputOptions,
                        grammar_spec: str) -> StructuredOutputGrammar:
        return self.strategy.compile_grammar(request_type, grammar_spec)
