...
class GroupCoordinator:
    ...
    def make_sibling_device_group(self, group_desc: str | None = None) -> ProcessGroup:
        ...
        """
        from vllm.backends.distributed.utils import get_distributed_timeout_or_none
    ...
    def graph_capture(self, graph_capture_context: GraphCaptureContext | None = None):
        ...
        from vllm.backends.distributed.device_communicators.xpu_communicator import (
            XpuCommunicator,
        )
