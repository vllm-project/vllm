...
WeightTransferEngineFactory.register_engine(
    "nccl",
    "vllm.backends.distributed.weight_transfer.nccl_engine",
    "NCCLWeightTransferEngine",
)

WeightTransferEngineFactory.register_engine(
    "ipc",
    "vllm.backends.distributed.weight_transfer.ipc_engine",
    "IPCWeightTransferEngine",
)

WeightTransferEngineFactory.register_engine(
    "sparse_nccl",
    "vllm.backends.distributed.weight_transfer.sparse_nccl_engine",
    "SparseNCCLWeightTransferEngine",
)

WeightTransferEngineFactory.register_engine(
    "sharded_rdt",
    "vllm.backends.distributed.weight_transfer.sharded_rdt_engine",
...
WeightTransferTrainerFactory.register_engine(
    "sharded_rdt",
    "vllm.backends.distributed.weight_transfer.sharded_rdt_trainer",
