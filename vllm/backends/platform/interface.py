...
class Platform:
    ...
    def is_cumem_allocator_available(self) -> bool:
        try:
            from vllm.backends.platform.device_allocator.cumem import cumem_available
        except ImportError:
            return False
    ...
    def get_pass_manager_cls(cls) -> str:
        ...
        """
        return "vllm.backends.compiler.passes.pass_manager.PostGradPassManager"
    ...
    def has_device_capability(
        ...
        [`DeviceCapability.to_int`][vllm.backends.platform.interface.DeviceCapability.to_int])
        """
    ...
    def get_static_graph_wrapper_cls(cls) -> str:
        ...
        """
        return "vllm.backends.compiler.base_static_graph.AbstractStaticGraphWrapper"
