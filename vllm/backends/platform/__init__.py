...
def tpu_platform_plugin() -> str | None:
    ...
    try:
        ...
        return "vllm.backends.platform.tpu.TpuPlatform"
...
def cuda_platform_plugin() -> str | None:
    ...
    return "vllm.backends.platform.cuda.CudaPlatform" if is_cuda else None
...
def rocm_platform_plugin() -> str | None:
    ...
    return "vllm.backends.platform.rocm.RocmPlatform" if is_rocm else None
...
def xpu_platform_plugin() -> str | None:
    ...
    try:
        ...
        if torch.distributed.is_xccl_available():
            dist_backend = "xccl"
            from vllm.backends.platform.xpu import XPUPlatform
    ...
    return "vllm.backends.platform.xpu.XPUPlatform" if is_xpu else None
...
def cpu_platform_plugin() -> str | None:
    ...
    if _is_amd_zen_cpu():
        try:
            ...
            return "vllm.backends.platform.zen_cpu.ZenCpuPlatform"
        except ImportError:
            logger.debug(
    ...
    return "vllm.backends.platform.cpu.CpuPlatform"
...
def resolve_current_platform_cls_qualname() -> str:
    ...
    if len(activated_oot_plugins) >= 2:
        ...
        platform_cls_qualname = "vllm.backends.platform.interface.UnspecifiedPlatform"
...
def __getattr__(name: str):
    if name == "current_platform":
        ...
        # 1. out-of-tree platform plugins need `from vllm.backends.platform import
