...
class AddRMSNormPattern(VllmPatternReplacement):
    ...
    def replacement(self):
        def _replacement(
            ...
            return vllm.backends.compute.ir.ops.fused_add_rms_norm(
...
class RMSNormReshapePattern(VllmPatternReplacement):
    ...
    def pattern(self):
        def _pattern(
            ...
            rms = vllm.backends.compute.ir.ops.rms_norm(input, weight, self.epsilon)
    ...
    def replacement(self):
        def _replacement(
            ...
            return vllm.backends.compute.ir.ops.rms_norm(input, weight, self.epsilon)
...
class FusedAddRMSNormReshapePattern(VllmPatternReplacement):
    ...
    def pattern(self):
        def _pattern(
            ...
            rms, residual_out = vllm.backends.compute.ir.ops.fused_add_rms_norm(
