...
class ConfiguredHelionKernel:
    ...
    def _load_platform_configs(self) -> None:
        from vllm.backends.compute.kernels.helion.config_manager import ConfigManager
        from vllm.backends.compute.kernels.helion.utils import get_canonical_gpu_name
