...
if silu_and_mul_nvfp4_quant_supported:
    FUSED_OPS[kNvfp4Dynamic] = torch.ops._C.silu_and_mul_nvfp4_quant.default

if current_platform.is_cuda_alike() and hasattr(torch.ops._C, "silu_and_mul_per_block_quant"):
