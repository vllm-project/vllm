...
# ROCm AITER support for allreduce + rmsnorm fusion
rocm_aiter_fused_allreduce_rmsnorm = None
if rocm_aiter_ops.is_enabled() and rocm_aiter_ops.is_rmsnorm_enabled():
    ...
    rocm_aiter_fused_allreduce_rmsnorm = (
...
# ---------------------------------------------------------------------------
# ROCm AITER: allreduce + RMSNorm patterns and pass
# ---------------------------------------------------------------------------


class RocmAiterAllReduceRMSNormPattern:
    """
    Fuses allreduce + rmsnorm (without residual) using AITER kernels.
...
class RocmAiterAllReduceFusedAddRMSNormPattern:
    """
    Fuses allreduce + fused_add_rmsnorm (with residual) using AITER kernels.
