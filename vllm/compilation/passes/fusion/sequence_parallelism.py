...
class SequenceParallelismPass(VllmPatternMatcherPass):
    ...
    def __init__(self, config: VllmConfig) -> None:
        ...
        # Fix shape-mismatched copy_ nodes generated by AOTAutograd
        # for in-place mutations on graph inputs (e.g., inputs_embeds)
        self.input_mutation_slicing = InputMutationSlicingPass(config)
        self.input_mutation_slicing.pass_name = (
            f"{self.pass_name}.{self.input_mutation_slicing.pass_name}"
        )
    ...
    def __call__(self, graph: fx.Graph) -> None:
        ...
        # Fix shape-mismatched input mutation nodes
        self.input_mutation_slicing(graph)
