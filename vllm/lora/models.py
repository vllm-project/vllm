...
class LoRAModel:
    ...
    def from_lora_tensors(
        ...
        for tensor_name, tensor in tensors.items():
            ...
            module_name = "score"
            if classifier_lora_name and tensor_name.endswith(classifier_lora_name):
        ...
        *,
        ...
        def check_unexpected_modules(modules: dict):
            for lora_module in modules.keys():  # noqa
                if classifier_lora_name and lora_module.endswith(classifier_lora_name):
                    continue
        ...
        if tensorizer_config_dict:
            ...
            for module in target_modules:
                if classifier_lora_name and module.endswith(classifier_lora_name):
                    continue
