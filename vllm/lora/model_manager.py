...
class LoRAModelManager:
    ...
    def __init__(
        ...
        self._is_moe = is_moe_model(self.model)
        self._is_3d_moe_model = self._is_moe and self.model.is_3d_moe_weight
        self._is_non_gated_moe = self._is_moe and self.model.is_non_gated_moe
        self._use_ep = bool(
