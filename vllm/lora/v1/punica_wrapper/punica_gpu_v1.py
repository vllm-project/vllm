...
if HAS_TRITON:
    from vllm.lora.v1.ops.triton_ops import v1_expand
    from vllm.lora.v1.ops.triton_ops import v1_shrink
...
@final
class PunicaWrapperGPUV1(PunicaWrapperBase):
    ...
    def _apply_shrink(
        ...
        # TODO (varun): Handle no_lora case - we can skip the op entirely.
        v1_shrink(
            x,
            w_t_all,
            y,
    ...
    def add_expand(self,
        ...
        # NOTE fused kernel
        self._apply_expand(y, x, lora_b_stacked, offset_start, add_inputs=True)
        y = y.view_as(y_org)
    ...
    def add_lora_logits(self,
        ...
        v1_expand(buffer, [lora_b_stacked],
                  y,
