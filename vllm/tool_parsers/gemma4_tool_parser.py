...
from vllm.tool_parsers.gemma4_utils import (
    _ESCAPE_TOKEN as STRING_DELIM,
    parse_gemma4_args as _parse_gemma4_args,
    parse_gemma4_array as _parse_gemma4_array,
    parse_gemma4_value as _parse_gemma4_value,
)
