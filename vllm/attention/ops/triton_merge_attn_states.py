...
def merge_attn_states_kernel(
    ...
    # FIXME(DefTruth): dynamically checking each value for infinity within 
    # the kernel might impact the execution efficiency of the generated Triton 
    # kernel (L20, etc.). To avoid affecting the generation of the Triton
    # kernel, I have try to handle this processing outside the kernel, but
    # still can't fix the performance issue. 
