...
def which_attn_to_use(
    ...
    # selected_backend = _Backend.OPENVINO
    # return selected_backend
    # device="cuda"
    print("==================Selec Backend================ device =", device)
    print("\n")
    ...
    if is_cpu() or device == "cpu":
        ...
        #     print("==================Cannot use %s backend on CPU.==================", selected_backend)
        #     logger.info("Cannot use %s backend on CPU.", selected_backend)
        print("==================backend use cpu ==================")
    ...
    # if is_openvino():
    if device == "openvino":
        print("==================backend use native openvino==================")
