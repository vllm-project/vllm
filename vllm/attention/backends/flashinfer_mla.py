...
class FlashInferMLAState(MLACommonState):
    ...
    def graph_capture_get_metadata_for_batch(
        ...
        attn_metadata = FlashInferMLAMetadata(
            **asdict(super().graph_capture_get_metadata_for_batch(
    ...
    def begin_forward(self):
        if self.num_decode_tokens > 0:
            ...
            self.decode_wrapper.plan(
                ...
                kv_indptr=self.paged_kv_indptr[self.num_prefills:],
                kv_indices=self.paged_kv_indices[self.num_prefills:],
                kv_len_arr=self.seq_lens_tensor[self.num_prefills:],
