...
class SageAttentionBackend(AttentionBackend):
    ...
    def get_impl_cls() -> Type["SageAttentionBackendImpl"]:
        return SageAttentionBackendImpl
...
@dataclass
class SageAttentionMetadata(AttentionMetadata, PagedAttentionMetadata):
    ...
    @property
    def prefill_metadata(self) -> Optional["SageAttentionMetadata"]:
        if self.num_prefill_tokens == 0:
            return None
        return self

    @property
    def decode_metadata(self) -> Optional["SageAttentionMetadata"]:
...
class SageAttentionBackendImpl(AttentionImpl[SageAttentionMetadata]):
    ...
    def forward(
        ...
        attn_metadata: SageAttentionMetadata,  # type: ignore
        k_scale: float = 1.0,
        v_scale: float = 1.0,
