...
def _compute_chunked_local_num_tokens(num_tokens_across_dp_cpu: List[int], max_num_tokens: int) -> List[List[int]]:
...
def set_chunked_tokens_across_dp_cpu(max_chunk_size_per_rank: int):
    ...
    chunked_local_num_tokens = _compute_chunked_local_num_tokens(num_tokens_across_dp_cpu, max_chunk_size_per_rank)

    global _dp_local_size_metadata
    metadata = DPLocalSizeMetadata(chunked_tokens_across_dp_cpu=chunked_local_num_tokens)
...
class DPMetadata:
    ...
    def make(
        ...
        return DPMetadata(max_tokens_across_dp_cpu, cu_tokens_across_dp_cpu)#, chunked_num_tokens_across_dp)
