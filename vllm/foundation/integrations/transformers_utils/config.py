...
class LazyConfigDict(dict):
    def __getitem__(self, key):
        ...
        import vllm.foundation.integrations.transformers_utils.configs as configs
...
def get_pooling_config(
    ...
    if pooling:
        from vllm.foundation.config.pooler import SEQ_POOLING_TYPES, TOK_POOLING_TYPES
