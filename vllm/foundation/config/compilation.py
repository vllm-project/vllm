...
class CompilationConfig:
    ...
    - Top-level Compilation control:
        - [`mode`][vllm.foundation.config.CompilationConfig.mode]
        - [`debug_dump_path`][vllm.foundation.config.CompilationConfig.debug_dump_path]
        - [`cache_dir`][vllm.foundation.config.CompilationConfig.cache_dir]
    ...
    - CudaGraph capture:
        ...
        [vllm.foundation.config.CompilationConfig.cudagraph_capture_sizes]
        - [`max_cudagraph_capture_size`]
        [vllm.foundation.config.CompilationConfig.max_cudagraph_capture_size]
        - [`cudagraph_num_of_warmups`]
        [vllm.foundation.config.CompilationConfig.cudagraph_num_of_warmups]
        - [`cudagraph_copy_inputs`]
        [vllm.foundation.config.CompilationConfig.cudagraph_copy_inputs]
    - Inductor compilation:
        - [`compile_sizes`][vllm.foundation.config.CompilationConfig.compile_sizes]
        - [`compile_ranges_endpoints`]
            [vllm.foundation.config.CompilationConfig.compile_ranges_endpoints]
        - [`inductor_compile_config`]
        [vllm.foundation.config.CompilationConfig.inductor_compile_config]
        - [`inductor_passes`][vllm.foundation.config.CompilationConfig.inductor_passes]
