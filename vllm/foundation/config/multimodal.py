...
from vllm.foundation.config.utils import config, get_from_deprecated_env_if_set
...
[`MultiModalDummyOptionsBuiltins`][vllm.foundation.config.multimodal.MultiModalDummyOptionsBuiltins].
"""
