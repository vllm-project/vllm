...
def deactivate_adapter(
    adapter_id: int, active_adapters: Dict[int, None], deactivate_func: Callable
) -> bool:
...
def add_adapter(
    adapter: Any, registered_adapters: Dict[int, Any], capacity: int, add_func: Callable
) -> bool:
...
def set_adapter_mapping(
    mapping: Any, last_mapping: Any, set_mapping_func: Callable
) -> Any:
...
def remove_adapter(
    adapter_id: int, registered_adapters: Dict[int, Any], deactivate_func: Callable
) -> bool:
    deactivate_func(adapter_id)
