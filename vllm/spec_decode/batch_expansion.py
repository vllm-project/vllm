...
class BatchExpansionTop1Scorer(SpeculativeScorer):
    ...
    def _contract_non_speculative(self, scores: SpeculativeScores,
                                  seq_group_metadata_list: List[SequenceGroupMetadata],
    ...
    def _contract_batch(self,
        ...
        return self._contract_non_speculative(spec_scores,
                                              contracted_seq_group_metadata_list,
                                              non_spec_indices, non_spec_outputs,
                                              has_prompt_log)
    ...
    def _split_scoring_output(
        ...
        split_sizes = (sampler_output.sampled_token_ids.numel() - num_scoring_tokens,
                       num_scoring_tokens)
        (non_spec_probs,
         spec_probs) = sampler_output.sampled_token_probs.split(split_sizes)
        (non_spec_sampled_tokens, spec_sampled_tokens
         ) = sampler_output.sampled_token_ids.flatten().split(split_sizes)
        (non_spec_logprobs, spec_logprobs) = sampler_output.logprobs.split(split_sizes)
        ...
        return (spec_sampled_tokens, spec_probs, spec_logprobs, spec_hidden_states,
