...
class SpecDecodeWorker(LoraNotSupportedWorkerBase):
    ...
    * The scoring forward pass is done without an MQA kernel, which is
    ...
    def create_worker(
        ...
        print("==============specinfer create_worker  cpu_draft_worker ================= ",cpu_draft_worker)
        ...
        if ngram_prompt_lookup_max > 0:
            ...
            if cpu_draft_worker:
                ...
                print("============== create worker cpu_draft_worker ======================\n")
                for key in draft_worker_kwargs:
                    print("key = {}, value = {} ".format(key, draft_worker_kwargs[key]))
                cpu_draft_worker_kwargs["device_config"].device = torch.device("cpu")
...
# >>>>>>> ov_pr
    ...
    def determine_num_available_blocks(
        ...
        # if self.proposer_worker.device_config.device.type == "openvino":
        print("====================== sspec decode ======= device.type  = ", self.proposer_worker.device_config.device.type)
    ...
    def _run_speculative_decoding_step(
        ...
        print("~~~~~~~~~~~~~~~~~~~~~score_proposals~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        proposal_scores = self.scorer.score_proposals(
            execute_model_req,
            proposals,
        )
        print("~~~~~~~~~~~~~~~~~~~~~_verify_tokens~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
