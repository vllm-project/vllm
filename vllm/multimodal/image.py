...
class ImageMediaIO(MediaIO[Image.Image]):
    ...
    def load_bytes(self, data: bytes, *, request_overrides: Optional[dict[str, Any]] = None) -> Image.Image:
        image = Image.open(BytesIO(data))
        image.load()
        return self._convert_image_mode(image)

    def load_base64(self, media_type: str, data: str, *, request_overrides: Optional[dict[str, Any]] = None) -> Image.Image:
        return self.load_bytes(pybase64.b64decode(data, validate=True))

    def load_file(self, filepath: Path, *, request_overrides: Optional[dict[str, Any]] = None) -> Image.Image:
...
class ImageEmbeddingMediaIO(MediaIO[torch.Tensor]):
    ...
    def load_bytes(self, data: bytes, *, request_overrides: Optional[dict[str, Any]] = None) -> torch.Tensor:
        buffer = BytesIO(data)
        return torch.load(buffer, weights_only=True)

    def load_base64(self, media_type: str, data: str, *, request_overrides: Optional[dict[str, Any]] = None) -> torch.Tensor:
        return self.load_bytes(pybase64.b64decode(data, validate=True))

    def load_file(self, filepath: Path, *, request_overrides: Optional[dict[str, Any]] = None) -> torch.Tensor:
