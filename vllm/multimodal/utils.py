    ...
    *,
    ...
    if prompt is None:
        ...
        if placeholder_token_count < len(repeat_count):
            logger.warning(
                "The number of placeholder tokens in the prompt is less than "
                "the number of placeholder inputs. Extra placeholder tokens "
        ...
        for i, repeat_count_item in enumerate(repeat_count):
            ...
            # The placeholder tokens are removed to be consistent with
            # HuggingFace
