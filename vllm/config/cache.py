...
KVOffloadingBackend = Literal["native", "lmcache", "lmcache_mp"]
...
class CacheConfig:
    ...
    'native' (vLLM native CPU offloading), 'lmcache' (LMCache V1), and
    'lmcache_mp' (LMCache's in-process MP runtime).
