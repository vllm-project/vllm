...
class EPLBConfig:
    ...
    def auto_set_num_redundant_experts(
        ...
        Args:
            ...
            ep_size: Expert parallel world size (TP_SIZE × DP_SIZE × PCP_SIZE)
        ...
        if num_logical_experts <= 0:
            ...
            # Keep -1 to allow fallback auto-calculation in EplbState.add_model()
            # after model construction when actual expert count is available.
            return
    ...
    def _validate_parallel_config(self) -> Self:
        ...
        if not self.enable_expert_parallel:
            ...
            if self.eplb_config.num_redundant_experts > 0:
                raise ValueError(
                    "num_redundant_experts can only be set when "
