...
class SpeculativeConfig:
    ...
    def create_draft_parallel_config(
        ...
        Expert parallelism is only inherited by MoE drafters: a dense drafter
        (e.g. DFlash or EAGLE heads) has no experts to shard and would fail
        the MoE check in ``ModelConfig.verify_with_parallel_config``.
        """
