        ...
        if speculative_max_model_len is not None:
            ...
            if speculative_max_model_len < target_max_model_len:
                logger.warning(
                    ...
                    "max_model_len (%d). The drafter runs on every "
                    "sequence regardless, so sequences longer than "
                    "%d tokens will be drafted beyond the drafter's "
                    "max_model_len and may produce low-quality drafts.",
