...
class ModelConfig:
    ...
    def _verify_quantization(self) -> None:
        ...
        if self.quantization == "gptq_marlin":
            raise ValueError(
                "Explicitly specifying gptq_marlin is deprecated."
                "--quantization gptq now automatically selects "
                "the kernel method with the best performance for "
                "the current device and model."
            )
