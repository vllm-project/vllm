...
def register_vllm_dev_mode_api_routers(app: FastAPI):
    ...
    from .dev_mode.cache.api_router import attach_router as attach_cache_router

    attach_cache_router(app)

    from .dev_mode.rlhf.api_router import attach_router as attach_rlhf_router

    attach_rlhf_router(app)

    from .dev_mode.rpc.api_router import attach_router as attach_rpc_router

    attach_rpc_router(app)

    from .dev_mode.server_info.api_router import (
        attach_router as attach_server_info_router,
    )

    attach_server_info_router(app)

    from .dev_mode.sleep.api_router import attach_router as attach_sleep_router
