...
# migrated from https://huggingface.co/deepseek-ai/DeepSeek-V3.2/blob/main/encoding/encoding_dsv32.py
import copy
import json
import re
...
def render_message(
    ...
    tools = msg.get("tools")  # for developer message
    response_format = msg.get("response_format")
    tool_calls = msg.get("tool_calls")  # for tool messages
