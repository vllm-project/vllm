...
from vllm.entrypoints.mega_launcher import serve_http_and_consume
from vllm.entrypoints.logger import RequestLogger
from vllm.entrypoints.openai.cli_args import make_arg_parser
# yapf conflicts with isort for this block
# yapf: disable
from vllm.entrypoints.janitorai.protocol import (ChatCompletionRequest,
                                              ChatCompletionResponse,
                                              ErrorResponse,
             )
# yapf: enable
from vllm.entrypoints.janitorai.rpc.client import AsyncEngineRPCClient
from vllm.entrypoints.janitorai.rpc.server import run_rpc_server
from vllm.entrypoints.janitorai.serving_chat import OpenAIServingChat
...
logger = init_logger('vllm.entrypoints.janitorai.api_server')
...
async def run_server(args, **uvicorn_kwargs) -> None:
    ...
    async with build_async_engine_client(args) as async_engine_client:
        ...
        shutdown_task = await serve_http_and_consume(
            app,
