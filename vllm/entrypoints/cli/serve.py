...
def run_multi_api_server(args: argparse.Namespace):
    ...
    # The handshake socket can be IPC if this front-end is colocated
    # with all engines.
    ...
    # This runs only with the rank 0 engine, or when not colocated with any
    # engines (in which case the value of dp_rank here will also be 0).
    coordinator = None
