...
class OpenAIServingChat(OpenAIServing):
    ...
    async def chat_completion_stream_generator(
        ...
        model_name: str, conversation: list[ConversationMessage],
        tokenizer: AnyTokenizer, request_metadata: RequestResponseMetadata
        ...
        if stream_options:
            include_usage = should_include_usage(
                stream_options.include_usage, self.enable_force_include_usage)
            include_continuous_usage = include_usage and \
                                       stream_options.continuous_usage_stats
        else:
            include_usage = should_include_usage(
                False, self.enable_force_include_usage)
