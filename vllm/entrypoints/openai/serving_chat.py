    ...
    async def chat_completion_stream_generator(
        ...
        try:
            async for res in result_generator:
                ...
                if self.reasoning_parser and reasoning_parser.is_reasoning_end(
                    res.prompt_token_ids or [], True
                ):
                    ...
                    # handle streaming deltas for tools with named tool_choice
                        ...
                        if self.reasoning_parser and not reasoning_end_arr[i]:
                            ...
                            if (
                                reasoning_parser.is_reasoning_end(
                                    as_list(output.token_ids), False
                                )
                                or reasoning_end_arr[i]
                            ):
                                reasoning_end_arr[i] = True
                        ...
                        if self.reasoning_parser:
                            _, content = reasoning_parser.extract_reasoning_content(
                                current_text, res.prompt_token_ids or [], request
                            )
                        else:
        ...
        for output in final_res.outputs:
            ...
            if self.reasoning_parser:
                ...
                reasoning_content, content = reasoning_parser.extract_reasoning_content(
                    output.text, final_res.prompt_token_ids or [], request=request
                )
                if not request.include_reasoning:
                    reasoning_content = None
            else:
