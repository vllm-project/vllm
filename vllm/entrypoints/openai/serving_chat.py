...
ChatCompletionResponseChoiceT = TypeVar("ChatCompletionResponseChoiceT",
...
class OpenAIServingChat(OpenAIServing):
    ...
    def maybe_filter_parallel_tool_calls(
            self, choice: ChatCompletionResponseChoiceT,
            request: ChatCompletionRequest) -> ChatCompletionResponseChoiceT:
        ...
        elif isinstance(choice, ChatCompletionResponseStreamChoice
                        ) and choice.delta.tool_calls:
            choice.delta.tool_calls = [
                tool_call for tool_call in choice.delta.tool_calls
