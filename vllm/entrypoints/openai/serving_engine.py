...
class OpenAIServing:
    ...
    async def beam_search(
        ...
        dummy_token_id = tokenizer.max_token_id + 1  # type: ignore
        ...
        max_result_logprobs_num = logprobs_num + 1
        ...
        for _ in range(max_tokens):
            ...
            for i, result in enumerate(output):
                ...
                if logprobs_len < max_result_logprobs_num:
                    padding_len = max_result_logprobs_num - logprobs_len
                    all_beams_token_id.extend([dummy_token_id] * padding_len)
                    all_beams_logprob.extend([float("-inf")] * padding_len)
            ...
            if not ignore_eos:
                ...
                for idx in eos_idx:
                    beam_index = idx // max_result_logprobs_num
                    current_beam = all_beams[beam_index]
                    result = output[beam_index]
