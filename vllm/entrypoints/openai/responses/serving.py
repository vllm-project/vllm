    ...
    def _split_completion_output(
        ...
        if self.reasoning_parser:
            if hasattr(self.reasoning_parser, "start_message"):
                delimiters = self.reasoning_parser(tokenizer).start_message  # type: ignore[attr-defined]
            if hasattr(self.reasoning_parser, "end_message"):
                end_delimiters = self.reasoning_parser(tokenizer).end_message  # type: ignore[attr-defined]
