...
from vllm.entrypoints.openai.protocol import (
    ...
    PromptTokenUsageInfo, RequestResponseMetadata, ToolCall, UsageInfo, ResponseRequest, ResponseResponse)
...
class OpenAIServingResponse(OpenAIServing):
    ...
    ) -> Union[AsyncGenerator[str, None], ResponseResponse, ErrorResponse]:
        """
        Response API similar to OpenAI's API.

        See https://platform.openai.com/docs/api-reference/responses/create
        for the API specification. This API mimics the OpenAI Response API.
        """
