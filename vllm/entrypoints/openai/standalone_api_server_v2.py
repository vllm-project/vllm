...
if __name__ == "__main__":
    ...
    # Use Gunicorn with the 'gthread' worker class to share the model across threads
    command = f"gunicorn -w 1 -k gthread --threads 2 --timeout 120 -b {args.host}:{args.port} vllm.entrypoints.openai.standalone_api_server:app"
    os.system(command)
