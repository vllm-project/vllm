...
def find_common_prefix(s1: str, s2: str) -> str:
    ...
    generated by vl_partial_json_parser, to help in ensuring that the right tokens
...
# vl_partial_json_parser doesn't support extra data and
# JSONDecoder.raw_decode doesn't support partial JSON
def partial_json_loads(input_str: str, flags: Allow) -> tuple[Any, int]:
    try:
        return (vl_partial_json_parser.loads(input_str, flags), len(input_str))
