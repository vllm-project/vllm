...
class Llama4JsonToolParser(ToolParser):
    """
    Tool call parser for Llama 4 models intended for use with the
    examples/tool_chat_template_llama4_json.jinja template.

    Used when --enable-auto-tool-choice --tool-call-parser llama4_json 
    are all set
    """
