...
class SpeechToTextBaseServing(GenerateBaseServing):
    ...
    async def _create_speech_to_text(
        ...
        # Whisper generation is not constrained by audio input length, while models
        # with audio-aligned decoder positions may provide an additional limit.
        model_max_tokens = self.model_cls.get_speech_to_text_max_tokens(
            engine_inputs[0]
        )
