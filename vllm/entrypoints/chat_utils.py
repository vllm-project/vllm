...
class CustomChatCompletionMessageParam(TypedDict, total=False):
    ...
    """The reasoning content for the message."""
    ...
    *,
    ...
    for result_msg in result:
        if role == 'assistant':
            ...
            # Check for reasoning_content in the message when
            # include_thinking is True
            if include_thinking and "reasoning_content" in message:
