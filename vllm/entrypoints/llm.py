...
class LLM:
    ...
    Args:
        ...
        dtype: The data type for the model weights and activations. Currently,
            ...
            the `torch_dtype` or `dtype` attribute specified in the model config
            file. However, if the `torch_dtype` or `dtype` in the config is
            `float32`, we will use `float16` instead.
