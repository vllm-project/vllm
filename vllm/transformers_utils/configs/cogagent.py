...
class CLIPVisionConfig:
    ...
    def __getitem__(self, idx: str):
        if not isinstance(idx, str):
            raise ValueError(f"{self.__class__} does not support index type {type(idx)}")
...
class EVACLIPVisionConfig(PretrainedConfig, CLIPVisionConfig):
    ...
    def __init__(
        ...
        **kwargs: Unpack[CLIPVisionConfig]
    ):        
...
class CogAgentConfig(PretrainedConfig):
    ...
    model_type = "cogagent"
    sub_configs = {"vision_config": EVACLIPVisionConfig, 
    ...
    def __init__(
        ...
        cross_vision_config: EVALargeVisionConfig | dict[str, Any]= None,
        vision_config: EVACLIPVisionConfig | dict[str, Any] = None,
        **kwargs
    ):
        ...
        if cross_vision_config is None:
            ...
            cross_hidden_size = cross_vision_config.pop('hidden_size', cross_hidden_size)
