...
_CLASS_TO_MODULE: dict[str, str] = {
    ...
    "StepRoboticsVLConfig": "vllm.transformers_utils.configs.step3_vl",
    "StepRoboticsVisionEncoderConfig": "vllm.transformers_utils.configs.step3_vl",
    "StepRoboticsTextConfig": "vllm.transformers_utils.configs.step3_vl",
...
__all__ = [
    ...
    "Step3TextConfig",
    "StepRoboticsVLConfig",
    "StepRoboticsVisionEncoderConfig",
    "StepRoboticsTextConfig",
    "Step3p5Config",
    "Qwen3ASRConfig",
    "Qwen3NextConfig",
    "Qwen3_5Config",
