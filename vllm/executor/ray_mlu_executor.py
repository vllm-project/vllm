...
class RayMLUExecutor(DistributedMLUExecutor):
    ...
    def _init_executor(self) -> None:
        ...
        # Create the parallel MLU workers.
    ...
    def _init_workers_ray(self, placement_group: "PlacementGroup",
        ...
        if (self.parallel_config.tensor_parallel_size == 1
            ...
            # For single mlu case, we use a ray worker with constrained memory.
            num_gpus = self.cache_config.gpu_memory_utilization
        else:
            # Otherwise, the ray workers are allocated with a full MLU.
            num_gpus = 1
        ...
        if not self.use_ray_spmd_worker and self.driver_dummy_worker is None:
            raise ValueError(
                "Ray does not allocate any MLUs on the driver node. Consider "
