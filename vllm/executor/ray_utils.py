...
def _wait_until_pg_ready(current_placement_group: "PlacementGroup"):
    ...
    try:
        ...
        total_gpu_required = sum(
            spec.get('GPU', 0) for spec in placement_group_specs)
        ...
        if total_gpu_required > 1:
            ...
            raise ValueError(
                ...
                "has enough resources.") from None
    ...
    if (current_platform.is_cuda() and parallel_config.world_size > 1):
        ...
        if parallel_config.world_size > available_gpus:
            logger.warning(
                ...
                parallel_config.world_size, available_gpus, available_gpus,
