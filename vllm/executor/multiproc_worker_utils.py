...
class ResultFuture(threading.Event, Generic[T]):
    ...
    def get(self) -> T:
        ...
        return self.result.value  # type: ignore
...
class LocalWorkerVllm():
    ...
    def __init__(self, result_handler: ResultHandler,
        ...
        self.process: BaseProcess = mp.Process(  # type: ignore
...
def _add_prefix(file: TextIO, worker_name: str, pid: int) -> None:
    ...
    def write_with_prefix(s: str):
        if not s:
            return
        assert hasattr(file, "start_new_line")
    ...
    file.start_new_line = True  # type: ignore
