...
"""Fused ops for glm5next (eager / breakable-cudagraph path).

These recover fusions that vLLM's torch.compile passes would normally do but
that don't fire when running eager under the breakable CUDA graph. Ported from
deepseek_v32/nvidia/fused_ops.py; the op itself is architecture-agnostic.
"""
