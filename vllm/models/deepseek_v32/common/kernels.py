...
def fused_norm_rope(
    ...
    if indexer_k_cache is not None:
        ...
        idx_cache_stride = 1
        if mla_kv_cache is None and not write_kv_output:
    ...
    if mla_kv_cache is not None:
        ...
        # Dummy values. The kernel skips the direct MLA cache write because
        # mla_entry_stride is zero.
