...
class DeepseekV41LLMForCausalLM(
    ...
    def process_weights_after_loading(self) -> None:
        logger.info("DeepSeek V4.1: finalizing MegaMoE weights")
        self.model.finalize_mega_moe_weights()
        logger.info("DeepSeek V4.1: finalizing mHC broadcast weights")
        self.model.finalize_mhc_broadcast_weights()
        logger.info("DeepSeek V4.1: finished model post-load processing")
