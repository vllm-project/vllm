...
def qwen4_exp_xpu_ple_ngram_embedding_fake(
    ngram_ids: torch.Tensor,
    output: torch.Tensor,
    layer_name: str,
) -> None:
...
direct_register_custom_op(
    op_name="qwen4_exp_xpu_ple_ngram_embedding",
    op_func=qwen4_exp_xpu_ple_ngram_embedding,
    mutates_args=["output"],
    fake_impl=qwen4_exp_xpu_ple_ngram_embedding_fake,
)
