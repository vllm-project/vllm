...
from vllm.models.minimax_m3.amd.ops.index_topk import (
    CP_TOPK_NUM_WARPS as DECODE_TOPK_NUM_WARPS,
)
from vllm.models.minimax_m3.amd.ops.index_topk import (
    _cp_alloc_emit as _alloc_emit,
)
from vllm.models.minimax_m3.amd.ops.index_topk import (
    _cp_emit_sparse_block_table_row as _emit_sparse_block_table_row,
)
from vllm.models.minimax_m3.amd.ops.index_topk import (
    _pack_score_key,
    _require_packable,
...
def merge_candidate_keys(
    ...
    """Select global top-k from gathered [world,tokens,topk] or [tokens,world*topk]."""
