...
"""iHC (independent Hyper-Connections) layers for HY V4 (AMD).
...
The AMD implementation uses the eager tensor path. Platform-specific fusion can
be added independently after correctness is established.
"""
