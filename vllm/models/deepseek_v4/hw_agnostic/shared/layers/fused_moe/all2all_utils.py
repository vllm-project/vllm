...
class _NotVendoredPrepareAndFinalize:
    ...
    @classmethod
    def maybe_roundup_layer_hidden_size(cls, hidden_size, *args, **kwargs):
        return hidden_size


class DeepEPHTPrepareAndFinalize(_NotVendoredPrepareAndFinalize):
    _kernel_name = "DeepEP-HT"


class DeepEPLLPrepareAndFinalize(_NotVendoredPrepareAndFinalize):
    _kernel_name = "DeepEP-LL"


class DeepEPV2PrepareAndFinalize(_NotVendoredPrepareAndFinalize):
    _kernel_name = "DeepEP-v2"


class MoriPrepareAndFinalize(_NotVendoredPrepareAndFinalize):
    _kernel_name = "Mori"


class NixlEPPrepareAndFinalize(_NotVendoredPrepareAndFinalize):
    _kernel_name = "NIXL-EP"


class FlashInferNVLinkOneSidedPrepareAndFinalize(_NotVendoredPrepareAndFinalize):
    _kernel_name = "FlashInfer-NVLink-OneSided"


class FlashInferNVLinkTwoSidedPrepareAndFinalize(_NotVendoredPrepareAndFinalize):
    _kernel_name = "FlashInfer-NVLink-TwoSided"


# DeepEP / NIXL block-shape constants — placeholders since the routes
# that consume them are stubbed above.
DEEPEP_QUANT_BLOCK_SHAPE: tuple[int, int] = (1, 128)
NIXL_EP_QUANT_BLOCK_SHAPE: tuple[int, int] = (1, 128)
