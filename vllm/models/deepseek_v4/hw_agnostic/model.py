...
class DeepseekV4MoE(nn.Module):
    def __init__(
        ...
        self.prefix = prefix
        # hw_agnostic path forces the standard vLLM FusedMoE backend; the
        # MegaMoE / DeepGEMM paths are NV-specific and live in nvidia/model.py.
...
class DeepseekV4Model(nn.Module):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        # TODO: In an HW agnostic implementation we always use the standard FusedMoE.
        self.use_mega_moe = False
