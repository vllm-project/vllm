...
def triton_mla_sparse_interface(
    ...
    """
    FP16 sparse MLA attention on CUDA (SM75). q/kv are loaded with their own
    dtype and stored as fp16.
    ...
    # BLOCK_H capped at 8 to fit the SM75 shared-memory limit (65536 bytes).
    BLOCK_H = 8
    BLOCK_DPE = block_dpe
