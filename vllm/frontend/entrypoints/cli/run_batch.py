...
class RunBatchSubcommand(CLISubcommand):
    ...
    def cmd(args: argparse.Namespace) -> None:
        from vllm.frontend.entrypoints.launchers.run_batch import main as run_batch_main
    ...
    def subparser_init(
        ...
        from vllm.frontend.entrypoints.launchers.run_batch import make_arg_parser
