...
Usage:
    python -m vllm.frontend.entrypoints.grpc_server --model <model_path>

Example:
    python -m vllm.frontend.entrypoints.grpc_server \
...
from vllm.frontend.entrypoints.serve.utils.api_utils import log_version_and_model
...
def main():
    """Main entry point for python -m vllm.frontend.entrypoints.grpc_server."""
