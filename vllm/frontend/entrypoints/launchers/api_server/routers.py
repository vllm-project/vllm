...
def register_api_routers(
    ...
    if "generate" in supported_tasks or "render" in supported_tasks:
        from vllm.frontend.entrypoints.scale_out.factories import register_scale_out_api_routers
    ...
    if any(task in POOLING_TASKS for task in supported_tasks):
        from vllm.frontend.entrypoints.pooling.factories import register_pooling_api_routers
