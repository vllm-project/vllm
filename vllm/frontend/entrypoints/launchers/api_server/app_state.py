...
async def init_app_state(
    ...
    if "generate" in supported_tasks:
        from vllm.frontend.entrypoints.generate.api_router import init_generate_state

        await init_generate_state(
            engine_client, state, args, request_logger, supported_tasks
        )

        from vllm.frontend.entrypoints.scale_out.factories import init_scale_out_state
    ...
    if any(task in POOLING_TASKS for task in supported_tasks):
        from vllm.frontend.entrypoints.pooling.factories import init_pooling_state
