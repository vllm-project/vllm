...
* :class:`Citation` / :class:`CitationSource`: the vLLM-internal citation
  ...
  :mod:`vllm.frontend.entrypoints.cohere.serving`. This is *not* the on-wire Cohere
...
* :class:`CohereChatMessage` / :class:`CohereDeltaMessage`: :class:`ChatMessage`
  ...
  (:class:`vllm.frontend.entrypoints.cohere.serving.CohereServingChatV2`) and by the
...
from vllm.frontend.entrypoints.openai.chat_completion.protocol import ChatMessage
...
class CitationSource(OpenAIBaseModel):
    ...
    :meth:`vllm.frontend.entrypoints.cohere.serving.CohereServingChatV2._apply_cohere_template_kwargs`.
