...
- For Cohere Command-family models, set ``--tokenizer-mode cohere`` and the
  ...
  (see :mod:`vllm.frontend.entrypoints.cohere.cohere_chat_message`).
...
def _emit(event: BaseModel) -> str:
    ...
    The typed event classes in ``vllm.frontend.entrypoints.cohere.protocol``
...
class CohereServingChatV2(OpenAIServingChat):
    ...
    subclasses (see :mod:`vllm.frontend.entrypoints.cohere.cohere_chat_message`) so
    ...
    def to_chat_completion_request(
        ...
        :meth:`vllm.frontend.entrypoints.scale_out.render.serving.ServingRender.render_chat_request`
    ...
    def _handle_citation_deltas(
        ...
        :mod:`vllm.frontend.entrypoints.cohere.cohere_chat_message`) with
