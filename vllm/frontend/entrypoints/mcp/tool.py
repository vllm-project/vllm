...
if TYPE_CHECKING:
    ...
    from vllm.frontend.entrypoints.openai.responses.context import ConversationContext
...
class HarmonyBrowserTool(Tool):
    ...
    async def get_result(self, context: "ConversationContext") -> Any:
        from vllm.frontend.entrypoints.openai.responses.context import HarmonyContext
...
class HarmonyPythonTool(Tool):
    ...
    async def get_result_parsable_context(self, context: "ConversationContext") -> Any:
        ...
        """
        from vllm.frontend.entrypoints.openai.responses.context import ParsableContext
