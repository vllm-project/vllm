...
def register_generate_api_routers(app: FastAPI):
    ...
    from vllm.frontend.entrypoints.openai.responses.api_router import (
    ...
    from vllm.frontend.entrypoints.anthropic.api_router import (
        attach_router as register_anthropic_api_router,
    )

    register_anthropic_api_router(app)

    from vllm.frontend.entrypoints.cohere.api_router import (
...
async def init_generate_state(
    ...
    # `vllm.frontend.entrypoints.cohere.api_router.attach_router`). Skip the import
    ...
    from vllm.frontend.entrypoints.mcp.tool_server import (
        DemoToolServer,
        MCPToolServer,
        ToolServer,
    )
