...
if TYPE_CHECKING:
    from vllm.foundation.config import ModelConfig, ObservabilityConfig, VllmConfig
...
class ProcessingInfoFactory(Protocol[_I_co]):
    """
    Constructs a
    [`BaseMultiModalProcessor`][vllm.frontend.processing.multimodal.processing.BaseMultiModalProcessor]
...
class DummyInputsBuilderFactory(Protocol[_I]):  # type: ignore[misc]
    """
    Constructs a
    [`BaseDummyInputsBuilder`][vllm.frontend.processing.multimodal.processing.BaseDummyInputsBuilder]
    instance from the context.
    """
