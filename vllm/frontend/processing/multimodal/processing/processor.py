...
class PromptIndex:
    ...
    [`BaseMultiModalProcessor._apply_prompt_updates`][vllm.frontend.processing.multimodal.processing.BaseMultiModalProcessor].
    """
...
[`modality`][vllm.frontend.processing.multimodal.processing.PromptUpdate.modality],
...
class PromptInsertion(PromptUpdate):
    ...
    [`target`][vllm.frontend.processing.multimodal.processing.PromptUpdate.target].
...
[`MultiModalKwargsItems`][vllm.frontend.processing.multimodal.inputs.MultiModalKwargsItems].
"""
...
class BaseMultiModalProcessor(ABC, Generic[_I]):
    ...
    def _get_prompt_updates(
        ...
        [`PlaceholderRange`][vllm.frontend.processing.multimodal.inputs.PlaceholderRange]
    ...
    def _get_hf_processor_text(self, mm_counts: Mapping[str, int]) -> str | None:
        ...
        [`DummyInputsBuilder`][vllm.frontend.processing.multimodal.processing.BaseDummyInputsBuilder].
        """
        return None
