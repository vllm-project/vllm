...
def nested_tensors_equal(
    ...
    [`NestedTensors`][vllm.frontend.processing.multimodal.inputs.NestedTensors] objects.
...
[`MultiModalKwargsItems.get_data`][vllm.frontend.processing.multimodal.inputs.MultiModalKwargsItems.get_data].
"""
...
class MultiModalFieldElem:
    ...
    [`MultiModalKwargsItem`][vllm.frontend.processing.multimodal.inputs.MultiModalKwargsItem].
    """
...
class BaseMultiModalField(ABC):
    ...
    [`group_and_batch_mm_items`][vllm.frontend.processing.multimodal.utils.group_and_batch_mm_items]
    ...
    def build_elems(
        ...
        """
        Construct
        [`MultiModalFieldElem`][vllm.frontend.processing.multimodal.inputs.MultiModalFieldElem]
        instances to represent the provided data.

        This is the inverse of
        [`reduce_data`][vllm.frontend.processing.multimodal.inputs.BaseMultiModalField.reduce_data].
        """
    ...
    def reduce_data(
        ...
        *,
        ...
        This is the inverse of
        [`build_elems`][vllm.frontend.processing.multimodal.inputs.BaseMultiModalField.build_elems].
        """
...
class MultiModalFlatField(BaseMultiModalField):
    """
    Info:
        [`MultiModalFieldConfig.flat`][vllm.frontend.processing.multimodal.inputs.MultiModalFieldConfig.flat]
        [`MultiModalFieldConfig.flat_from_sizes`][vllm.frontend.processing.multimodal.inputs.MultiModalFieldConfig.flat_from_sizes]
    """
...
class MultiModalSharedField(BaseMultiModalField):
    """
    Info:
        [`MultiModalFieldConfig.shared`][vllm.frontend.processing.multimodal.inputs.MultiModalFieldConfig.shared]
    """
...
class MultiModalKwargsItems(UserDict[str, Sequence[_I]]):
    ...
    [`BaseMultiModalField`][vllm.frontend.processing.multimodal.inputs.BaseMultiModalField]
