...
class _InputOptions(TypedDict):
    ...
    [`SingletonInput`][vllm.frontend.processing.inputs.engine.SingletonInput] types.
    """
...
def tokens_input(
    ...
    *,
    ...
    """
    Construct [`TokensInput`][vllm.frontend.processing.inputs.engine.TokensInput]
...
def embeds_input(
    ...
    *,
    ...
    """
    Construct [`EmbedsInput`][vllm.frontend.processing.inputs.engine.EmbedsInput]
    from optional values.
    """
...
"""
A rendered [`DecoderOnlyPrompt`][vllm.frontend.processing.inputs.llm.DecoderOnlyPrompt]
...
"""
A rendered [`EncoderPrompt`][vllm.frontend.processing.inputs.llm.EncoderPrompt]
which can be passed to `LLMEngine.add_request` or `AsyncLLM.add_request`.
"""
...
"""
A rendered [`DecoderPrompt`][vllm.frontend.processing.inputs.llm.DecoderPrompt]
which can be passed to `LLMEngine.add_request` or `AsyncLLM.add_request`.
"""
...
"""
A rendered [`SingletonPrompt`][vllm.frontend.processing.inputs.llm.SingletonPrompt]
which can be passed to `LLMEngine.add_request` or `AsyncLLM.add_request`.
"""
...
"""
A rendered [`PromptType`][vllm.frontend.processing.inputs.llm.PromptType]
which can be passed to `LLMEngine.add_request` or `AsyncLLM.add_request`.
"""
