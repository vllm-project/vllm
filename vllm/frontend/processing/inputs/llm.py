...
[`MultiModalDataBuiltins`][vllm.frontend.processing.inputs.llm.MultiModalDataBuiltins].
"""
...
class _PromptOptions(TypedDict):
    ...
    [`SingletonPrompt`][vllm.frontend.processing.inputs.llm.SingletonPrompt] types.
    """
...
[`ExplicitEncoderDecoderPrompt`][vllm.frontend.processing.inputs.llm.ExplicitEncoderDecoderPrompt].
"""
