...
non-streaming), see ``vllm.frontend.processing.reasoning.gemma4_reasoning_parser``.
For tool call parsing, see ``vllm.frontend.processing.tool_parsers.gemma4_utils``.
