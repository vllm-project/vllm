...
class CudaPlatformBase(Platform):
    ...
    def get_valid_backends(
        cls, head_size, dtype, kv_cache_dtype, block_size, use_mla, has_sink,
        use_sparse, device_capability_int
        ...
        for backend in _Backend:
            ...
            try:
                ...
                invalid_reasons_i = backend_class.validate_configuration(
                    ...
                    has_sink, use_sparse, device_capability_int)
            except ImportError:
    ...
    def get_attn_backend_cls(cls, selected_backend: "_Backend", head_size: int,
        ...
        valid_backends_priorities, invalid_reasons = cls.get_valid_backends(
            head_size, dtype, kv_cache_dtype, block_size, use_mla, has_sink,
            use_sparse, device_capability_int)
