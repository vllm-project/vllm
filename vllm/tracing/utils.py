...
class SpanAttributes:
    ...
    GEN_AI_LATENCY_PREPROCESSING = "gen_ai.latency.preprocessing.ms"
    GEN_AI_LATENCY_ENGINE_CALL = "gen_ai.latency.engine_call.ms"
    GEN_AI_LATENCY_POSTPROCESSING = "gen_ai.latency.postprocessing.ms"
