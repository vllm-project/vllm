...
class RendererRegistry:
    ...
    def init_renderer(
        ...
        return cls_.from_config(renderer_config, tokenizer_kwargs)


def renderer_from_config(renderer_config: "RendererConfig"):
    tokenizer_name = renderer_config.tokenizer
