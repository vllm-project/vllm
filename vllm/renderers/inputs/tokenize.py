...
"""
A [`DecoderOnlyDictPrompt`][vllm.renderers.inputs.preprocessDecoderOnlyDictPrompt]
...
"""
A [`EncoderDictPrompt`][vllm.renderers.inputs.preprocessEncoderDictPrompt]
that has been tokenized.
"""
...
"""
A [`DecoderDictPrompt`][vllm.renderers.inputs.preprocessDecoderDictPrompt]
that has been tokenized.
"""
...
class EncoderDecoderTokPrompt(TypedDict):
    """
    A
    [`EncoderDecoderDictPrompt`][vllm.renderers.inputs.preprocessEncoderDecoderDictPrompt]
    that has been tokenized.
    """
...
"""
A [`SingletonDictPrompt`][vllm.renderers.inputs.preprocessSingletonDictPrompt]
that has been tokenized.
"""
...
"""
A [`DictPrompt`][vllm.renderers.inputs.preprocessDictPrompt]
that has been tokenized.
"""
