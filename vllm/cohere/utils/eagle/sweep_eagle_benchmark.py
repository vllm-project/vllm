            ...
            for BENCH_TP in ALL_BENCH_TP:
                ...
                for K in ALL_K:
                    for SAMPLING_PROFILE in ALL_SAMPLING_PROFILE:
                        ...
                        cmd = f"""time CUDA_VISIBLE_DEVICES={CUDA_VISIBLE_DEVICES_STRING} VLLM_USE_HYBRID_MEM=0 VLLM_USE_V1=1 python3 /host/vllm-cohere/examples/offline_inference/eagle.py \
                            --skip_chat_template \
                            --dataset="/host/vllm-cohere/data/{BENCH_DATASET}/question.jsonl" \
                            --num_spec_tokens {K} \
