...
class ZeroOverheadSequence(Sequence):
    ...
    def __init__(self,
        ...
        super().__init__(seq_id, inputs, block_size, eos_token_id,
                         lora_request, prompt_adapter_request)
        self.effective_output_len: int = 0

    def fix_last_token_id(self, token_id: int) -> None:
        effect_offset = self.effective_output_len - len(
    ...
    def get_output_token_ids_to_return(
        ...
        if num_new_tokens == 1:
            ...
            return self.data._cached_all_token_ids[self.effective_output_len -
                                                   1]
