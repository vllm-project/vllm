...
def _get_fp8_einsum_m_values(
    ...
    # Small-M fp8_einsum specializations can compile against the original
    # token count. Warm every exact small shape so requests such as M=18
    # cannot load a new module at runtime.
