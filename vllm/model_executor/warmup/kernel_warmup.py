...
def flashinfer_autotune(runner: "GPUModelRunner") -> None:
    ...
    # TODO: enable by default once FlashInfer upstream fixes the persistent file
    # cache to resolve collisions like `use_8x4_sf_layout=True/False`, which can
    # cause invalid tactics to be chosen.
    if not envs.VLLM_ENABLE_FLASHINFER_AUTOTUNE_CACHE:
