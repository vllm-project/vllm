    ...
    "hopper": {
        ...
        (12288, 2048): _MatmulShapeConfig(
            ...
            m_buckets=(
                ...
                (8, _MatmulMConfig(16, 256, 4, 4)),
                (16, _MatmulMConfig(16, 256, 4, 4)),
                (32, _MatmulMConfig(32, 64, 8, 5)),
                (64, _MatmulMConfig(32, 256, 4, 4)),
                (256, _MatmulMConfig(128, 256, 8, 3)),
                (512, _MatmulMConfig(128, 256, 8, 3)),
                (1024, _MatmulMConfig(128, 256, 8, 3)),
                (2048, _MatmulMConfig(128, 256, 8, 3)),
            ),
        ),
        (2048, 6144): _MatmulShapeConfig(
            block_k=128,
