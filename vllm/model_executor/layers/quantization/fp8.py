        ...
        **extra_weight_attrs,
        ...
        if self.quant_config.is_checkpoint_fp8_serialized:
            ...
            def patched_weight_loader(param, loaded_weight, *args, **kwargs):
                ...
                if layer._loaded_numel == layer._target_loaded_numel:
                    self.process_weights_after_loading(layer)

                    # Delete the bookkeeping
                    del layer._loaded_numel
                    del layer._target_loaded_numel
        ...
        **extra_weight_attrs,
        ...
        if not self.quant_config.is_checkpoint_fp8_serialized:
            ...
            def patched_weight_loader(param, loaded_weight, *args, **kwargs):
                ...
                # add a counter to track how many elements we have updated
                if not hasattr(layer, "_target_loaded_numel"):
                    # for MoE, add up the number of elements from all the MoE
                    # weights
                    layer._target_loaded_numel = (
