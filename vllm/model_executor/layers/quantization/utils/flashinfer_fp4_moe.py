...
def apply_flashinfer_trtllm_fp4_moe(
    ...
    This function abstracts the logic for using FlashInfer's TRT-LLM FP4 MoE
    implementation, which includes:
    - FP4 quantization of input
    - Llama4-style routing detection
    - Calling the fused MoE kernel with block-scale quantization
