...
class GPTQMarlinLinearMethod(LinearMethodBase):
    ...
    def __init__(self, quant_config: GPTQMarlinConfig) -> None:
        self.quant_config = GPTQMarlinConfig(weight_bits=quant_config.weight_bits, group_size=quant_config.group_size,
                                             desc_act=quant_config.desc_act, is_sym=quant_config.is_sym,
