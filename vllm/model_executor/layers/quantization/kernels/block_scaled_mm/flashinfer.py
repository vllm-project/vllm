...
class FlashInferBlockScaledMMKernel(Fp8BlockScaledMMKernel):
    ...
    def ordered_fallback_kernels(cls) -> list[type["Fp8BlockScaledMMKernel"]]:
        return [
            DeepGemmBlockScaledMMKernel,
            CutlassBlockScaledMMKernel,
            TritonBlockScaledMMKernel,
        ]
...
class FlashInferDeepGEMMDynamicBlockScaledKernel(
    DynamicMMLinearKernel[
        Fp8BlockMMScaledConfig,
        FP8Params,
        FlashInferBlockScaledMMKernel,
        DeepGemmBlockScaledMMKernel,
    ]
):
    """
