...
class TorchAOWrappingCompressedTensorsW8A8Fp8MoEMethod(
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        ...
        if isinstance(
            ...
            layer.w13_weight = torch.nn.Parameter(layer.w13_weight.qdata)
            layer.w2_weight_scale = torch.nn.Parameter(layer.w2_weight.scale)
            layer.w2_weight = torch.nn.Parameter(layer.w2_weight.qdata)
