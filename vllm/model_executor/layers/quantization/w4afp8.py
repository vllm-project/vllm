...
class W4AFP8MoEMethod(FusedMoEMethodBase):
    ...
    def process_weights_after_loading(self, layer: RoutedExperts) -> None:
        ...
        from vllm.utils.humming import HummingInputSchema, InputQuantizationMode, dtypes

        a1_scale, a2_scale = self._prepare_input_scales(layer)
        layer.w13_input_scale = torch.nn.Parameter(a1_scale, requires_grad=False)
        layer.w2_input_scale = torch.nn.Parameter(a2_scale, requires_grad=False)
        self.humming_configs = convert_to_humming_moe_kernel_format(
            ...
            input_schema=HummingInputSchema(
                ...
                input_quant_mode=InputQuantizationMode.StaticTensor,
            ),
