...
# Stride-aware FP8 quantization with head_dim padding: reads directly from
# non-contiguous QKV views using 3D strides and pads head_dim to a multiple
# of 16 for cuDNN compatibility.
