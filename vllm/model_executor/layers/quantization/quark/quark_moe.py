...
class QuarkMoEMethod(FusedMoEMethodBase):
    ...
    def get_moe_method(
        ...
        elif quant_config._is_static_tensor_w8a8(weight_config, input_config):
            return QuarkW8A8Int8MoEMethod(weight_config, input_config, module.moe_config)
        elif quant_config._is_dynamic_per_token_w8a8(weight_config, input_config):
            return QuarkW8A8Int8MoEMethod(weight_config, input_config, module.moe_config)
        else:
...
class QuarkW8A8Int8MoEMethod(QuarkMoEMethod):
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        ...
        for attr in ("w13_input_zero_point", "w2_input_zero_point",
