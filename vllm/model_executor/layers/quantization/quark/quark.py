...
class QuarkConfig(QuantizationConfig):
    ...
    def _is_dynamic_per_token_w8a8(
        ...
        """Detect W8A8 INT8 with per-channel weights and dynamic per-token input."""
        if weight_quant is None or input_quant is None:
            return False

        is_int8_dtype = (
            weight_quant.get("dtype") == "int8"
            and input_quant.get("dtype") == "int8"
        )

        is_per_channel_weight = weight_quant.get("qscheme") in [
        ...
        return (is_int8_dtype and is_per_channel_weight
                and is_per_token_input and is_dynamic_input
