...
class QuarkConfig(QuantizationConfig):
    ...
    def _is_fp8_w4a8(
        ...
        is_static_weight = not weight_quant[0].get("is_dynamic") and not weight_quant[1].get("is_dynamic")
        ...
        print(f"is_w4a8_dtype: {is_w4a8_dtype}, is_static_weight: {is_static_weight}, is_per_tensor_fp8_and_per_channel_int4_weight: {is_per_tensor_fp8_and_per_channel_int4_weight}")
        if not (is_w4a8_dtype and is_static_weight and is_per_tensor_fp8_and_per_channel_int4_weight):
            return False
        ...
        print("Passed dynamic quantization check")
    ...
    def _is_fp8_w8a8(
        ...
        print("checking fp8 w8a8: ", weight_quant, input_quant, flush=True)
        # Confirm weights and input quantized.
        if weight_quant is None or input_quant is None:
            return False
