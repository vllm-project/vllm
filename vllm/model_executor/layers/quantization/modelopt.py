...
class ModelOptMixedPrecisionConfig(ModelOptQuantConfigBase):
    ...
    def get_quant_method(
        ...
        # ParallelLMHead is a VocabParallelEmbedding subclass that performs a
        # full vocab matmul. When lm_head is quantized, dispatch the same
        # method as for ordinary linear layers so FP4/FP8 parameters are
        # materialized.
