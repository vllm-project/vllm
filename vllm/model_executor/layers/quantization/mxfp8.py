...
from vllm.utils.flashinfer import flashinfer_mxfp8_quantize
...
class Mxfp8OnlineMoEMethod(Fp8OnlineMoEMethod):
    ...
    def _quantize_mxfp8_moe_weight(
        ...
        for i in range(num_batches):
            mx_fp8_quant, mx_fp8_scale = flashinfer_mxfp8_quantize(
                weight[i], is_sf_swizzled_layout=False
            )
            w_quant.append(mx_fp8_quant)
            w_scales.append(mx_fp8_scale.view(torch.uint8))
