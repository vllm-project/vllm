...
class AWQMarlinConfig(QuantizationConfig):
    ...
    def __init__(
        self, weight_bits: int, group_size: int, has_zp: bool, lm_head_quantized: bool
    ) -> None:
        ...
        verify_marlin_supported(
            self.quant_type, group_size=self.group_size, has_zp=self.has_zp
        )
    ...
    def is_awq_marlin_compatible(cls, quant_config: Dict[str, Any]):
        ...
        return check_marlin_supported(
            quant_type=cls.TYPE_MAP[num_bits], group_size=group_size, has_zp=has_zp
        )
