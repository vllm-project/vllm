...
from vllm.model_executor.layers.fused_moe.oracle.mxfp8 import (  # cohere: #38815
...
from vllm.model_executor.layers.quantization.utils.mxfp8_utils import (  # cohere #38815
    MXFP8_BLOCK_SIZE,
    MXFP8_SCALE_DTYPE,
    MXFP8_VALUE_DTYPE,
)
...
__all__ = [
    ...
    "CompressedTensorsW8A8Mxfp8MoEMethod",  # cohere: #38815
...
class CompressedTensorsW8A8Mxfp8MoEMethod(CompressedTensorsMoEMethod):
    ...
    Port of upstream vllm-project/vllm#38815 adapted to the cohere fork's
    single-file compressed_tensors_moe.py layout (upstream splits this into a
    sibling module under compressed_tensors_moe/).

    Remove this class after this fork merges upstream past df1e30e74 and its
    prerequisite #39187 (CT MoE "Oracle Structure" package split); at that
    point upstream's own version of this class applies cleanly.

    Upstream-PR: vllm-project/vllm#38815
    Upstream-Commit: df1e30e74be91bd48fd015c417e7699310a64119
    Drop-After-Upstream-Merged: vllm-project/vllm#39187
    """
