...
class MRotaryEmbedding(RotaryEmbedding):
            ...
            if use_numba:
                ...
                if is_omni:
                    ...
                    input_positions, mrope_position_delta = cls._omni_get_input_positions_numba(
                        ...
                        tokens_per_second=int(thinker_config.vision_config.tokens_per_second),
    ...
    def _omni_get_input_positions_numba(
        ...
        num_images = len(image_grid_thw)
        num_videos = len(video_grid_thw)
        num_audios = len(audio_feature_lengths)
        ...
        while i < num_input_tokens:
            ...
            if token_id == image_token_id:
                ...
                t_ntoken_per_chunk = int(seconds_per_chunk * second_per_grid_ts[cur_video_idx])
