...
def resolve_tuned_matmul_configs() -> None:
    ...
    # Must run outside torch.compile tracing: get_device_name uses
    # pynvml/ctypes, which Dynamo cannot trace.
    device_index = torch.accelerator.current_device_index()
    device_name = current_platform.get_device_name(device_id=device_index)
