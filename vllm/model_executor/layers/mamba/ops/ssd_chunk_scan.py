...
def _chunk_scan_fwd_kernel(
    ...
    stride_init_states_batch: tl.int32,
    stride_init_states_head: tl.int32,
    stride_init_states_hdim: tl.int32,
    stride_init_states_dstate: tl.int32,
    stride_D_head: tl.int32,
    # Meta-parameters
