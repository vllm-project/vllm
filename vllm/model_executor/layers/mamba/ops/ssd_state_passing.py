...
def _state_passing_fwd_kernel(
    ...
    chunk_size: tl.int32,
    # Strides
    stride_states_batch: tl.int32,
    stride_states_chunk: tl.int32,
    stride_states_head: tl.int32,
    stride_states_dim: tl.int32,
    stride_out_batch: tl.int32,
    stride_out_chunk: tl.int32,
    stride_out_head: tl.int32,
    stride_out_dim: tl.int32,
    stride_final_states_batch: tl.int32,
    stride_final_states_head: tl.int32,
    stride_final_states_dim: tl.int32,
    stride_dA_cs_batch: tl.int32,  # lower dim (chunk) is dynamic
    stride_dA_cs_head: tl.int32,  # lower dim (chunk) is dynamic
    stride_dA_cs_chunk: tl.int32,
    stride_initstates_batch: tl.int32,
    stride_initstates_head: tl.int32,
    stride_initstates_dim: tl.int32,
    stride_seq_idx_batch: tl.int32,
    stride_seq_idx_seqlen: tl.int32,
    # Meta-parameters
