...
def awq_marlin_moe_quant_config(
    ...
    a1_gscale / a2_gscale are optional global scales applied to the
    per-token activation quantization scales when using INT8 activations
    with group quantization (computed by marlin_act_int8_process_scales).
    """
    from vllm.model_executor.layers.quantization.utils.quant_utils import GroupShape
