...
def rocm_aiter_grouped_topk(
    ...
    assert routed_scaling_factor is None, "Share Expert Fusion is not implemented yet"
    assert num_share_fusion_replicas == 0, "Share Expert Fusion is not implemented yet"
