...
class FusedMoE(PluggableLayer):
    ...
    def __init__(
        ...
        # Store parameters needed for deferred _init_runner() call
        # (expert offloading initializes runner after weights are loaded)
        ...
        self._routed_scaling_factor = (
            routed_scaling_factor if apply_routed_scale_to_output else 1.0
        )
