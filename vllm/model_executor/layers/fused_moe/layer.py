...
class FusedMoE(torch.nn.Module):
    ...
    def __init__(
        ...
        self.dp_size = dp_size if dp_size is not None else get_dp_group(
        ).world_size
        ...
        use_ep = vllm_config.parallel_config.enable_expert_parallel and self.tp_size > 1
    ...
    def weight_loader(
        ...
        loaded_weight = (loaded_weight.t().contiguous() if
                         (self.quant_method.__class__.__name__
                          == "CompressedTensorsWNA16MoEMethod") else
                         loaded_weight)
    ...
    def make_expert_params_mapping(
        ...
        return [
            ...
            (
                ("experts.w13_" if weight_name in [
                    ckpt_gate_proj_name, ckpt_up_proj_name
                ] else "experts.w2_"),
