...
class UnquantizedFusedMoEMethod(FusedMoEMethodBase, CustomOp):
    ...
    def create_weights(
        ...
        **extra_weight_attrs,
        ...
        # The loader only fills the unpadded extent, so intermediate pad lanes
        # must start at zero to stay inert (silu(0) * 0 = 0, matching the zero
        # columns in w2). hidden_size padding is left as-is; it predates this.
