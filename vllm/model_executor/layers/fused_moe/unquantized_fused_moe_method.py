...
class UnquantizedFusedMoEMethod(FusedMoEMethodBase, CustomOp):
    ...
    def maybe_roundup_sizes(
        ...
        if self.unquantized_backend == UnquantizedMoeBackend.AITER:
            # Some model + TP splits give an unaligned per-partition
            # intermediate size (e.g. 1792 / TP=8 = 224), which AITER rejects
            # with "device_gemm ... does not support this GEMM problem".
