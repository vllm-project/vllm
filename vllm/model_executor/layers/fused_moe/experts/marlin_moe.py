...
def _fused_marlin_moe(
    ...
    # both element-wise and gated activations. apply_moe_activation fuses the
    # clamp/gate params: SILU + clamp_limit and SWIGLUOAI_UNINTERLEAVE both map
    # to the silu_and_mul_with_clamp kernel.
    activation_func(
        activation,
        intermediate_cache2,
        intermediate_cache1,
