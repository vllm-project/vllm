...
class BatchedTritonKernel(VllmTritonJitKernel["BatchedTritonKernel.CompileKey"]):
    ...
    def warmup_inputs(self, compile_key: CompileKey) -> dict[str, Any]:
        ...
        return dict(
            ...
            B=b_ptr,
            C=c_ptr,
            expert_num_tokens=int32_ptr,
            compute_type=compile_key.compute_type,
            max_num_tokens=compile_key.max_num_tokens,
            K=compile_key.k,
            N=compile_key.n,
            A_scale=scale_ptr if compile_key.use_fp8_w8a8 else None,
            B_scale=b_scale_ptr
            ...
            stride_ce=compile_key.max_num_tokens * compile_key.n,
            stride_cm=compile_key.n,
            stride_cn=1,
            stride_ase=compile_key.max_num_tokens * scale_cols,
            stride_asm=scale_cols,
            stride_ask=1,
            stride_bse=compile_key.n * scale_cols,
            stride_bsk=1,
            ...
            per_act_token_quant=compile_key.per_act_token_quant,
