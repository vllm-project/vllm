    ...
    def _compute_routing(
        ...
        *,
        ...
        if rocm_aiter_ops.is_fused_moe_enabled():
            ...
            # XPU Triton persistent_reduction kernels generated by torch.compile
            # have incorrect thread-to-data mappings for certain token counts
            # (e.g. with TP=4), causing out-of-bounds expert indices. Use the
            # eager (non-compiled) implementation instead.
            grouped_topk_impl = _grouped_topk_inner
        else:
