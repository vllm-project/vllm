...
"""FlashInfer MoE utility helpers.

Canonical location for MoE-specific FlashInfer helpers. Previously in
quantization.utils.flashinfer_utils; moved here for clearer module organization.
"""
