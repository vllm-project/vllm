...
"""FlashInfer utilities that are tightly coupled with MoE layer implementation.

These functions manipulate layer attributes and are specific to vLLM's MoE layer
structure, so they live here in the model_executor rather than in vllm.utils.
"""
