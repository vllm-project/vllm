        ...
        if include_fused:
            ...
            if gate_up is not None:
                fused_mapping = [
                    ...
                    (w13, f"experts.{gate_up}.{lora_base_layer_prefix}", 0, "w1"),
                    (w13, f"experts.{gate_up}.{lora_base_layer_prefix}", 1, "w3"),
                    (
                        w2,
                        f"experts.{ckpt_down_proj_name}.{lora_base_layer_prefix}",
                        0,
                        "w2",
                    ),
                ]
