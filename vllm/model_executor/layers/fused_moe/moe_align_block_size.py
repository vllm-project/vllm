...
def batched_moe_align_block_size(
    ...
    max_num_tokens_padded = B * max(max_tokens_per_batch, block_size)
    max_num_tokens_padded = round_up(max_num_tokens_padded, block_size)
    ...
    ops.batched_moe_align_block_size(max_tokens_per_batch, block_size,
                                     expert_num_tokens, sorted_ids, expert_ids,
                                     num_tokens_post_pad)
