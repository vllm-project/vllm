    ...
    def _omni3_get_input_positions_tensor(
        ...
        if input_ids is not None and (image_grid_thw is not None
            ...
            for i, seq_input_ids in enumerate(total_input_ids):
                ...
                audio_nums = torch.sum(seq_input_ids == audio_start_token_id)
                image_nums = (vision_tokens == image_token_id).sum()
                ...
                position_ids[...,
                             i, :seq_input_ids.shape[0]] = llm_positions.to(
                                 position_ids.device)
    ...
    def _omni_get_input_positions_tensor(
        ...
        if "qwen3_omni" in model_type:
            llm_positions, mrope_position_delta = cls._omni3_get_input_positions_tensor(
                ...
                video_grid_thw, use_audio_in_video, audio_feature_lengths,
