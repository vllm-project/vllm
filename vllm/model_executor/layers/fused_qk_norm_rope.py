...
def _fused_qk_rmsnorm_rope_gate_kernel(
    ...
    w = tl.load(w_ptr + head_offs, mask=head_mask, other=0.0).to(tl.float32) + 1.0
    ...
    w_rot1 = tl.load(w_ptr + rot_offs, mask=rot_mask, other=0.0).to(tl.float32) + 1.0
    w_rot2 = (
...
def fused_qk_rmsnorm_rope_gate(
    ...
    Args:
        ...
        q_weight: (head_dim,) raw GemmaRMSNorm weight
