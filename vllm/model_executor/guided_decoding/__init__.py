...
def maybe_backend_fallback(
    ...
    if guided_params.backend_name == "lm-format-enforcer":
        ...
        elif guided_params.json is not None and has_lmf_unsupported_json_features(
                guided_params.json):
            fallback_or_error(
                guided_params,
    ...
    if guided_params.backend_name == "xgrammar":
        ...
        elif guided_params.json is not None and has_xgrammar_unsupported_json_features(
                guided_params.json):
            fallback_or_error(
                guided_params,
                "xgrammar does not support advanced JSON schema features like "
                "enums, patterns or numeric ranges.",
                "outlines",
            )
