...
class MarlinLinearKernel(MPLinearKernel):
    ...
    def apply_weights(
        ...
        # Use uint4b8 at kernel invocation for signed int4 packed weights.
        effective_wtype = (
            scalar_types.uint4b8 if c.weight_type == scalar_types.int4 else c.weight_type
        )
