...
# The portable Triton pack lives in dcp_indexer_topk; re-exported here under
# its historical name for existing import sites.
from vllm.model_executor.kernels.attention.dsa.dcp_indexer_topk import (
    pack_dcp_topk_candidates as pack_dcp_topk_candidates_cutedsl,  # noqa: F401
)
