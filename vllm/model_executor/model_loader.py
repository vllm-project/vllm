...
# add lora config list: (lora_model_path, adapter_name)
def get_model(model_config: ModelConfig, lora_configs: list[tuple[str, str]] = None) -> nn.Module:
    ...
    if lora_configs is not None:
        for lora_config in lora_configs:
            ...
            add_lora_adapter(model=model, lora_path=lora_path, adapter_name=adapter_name)
