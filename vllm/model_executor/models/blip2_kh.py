...
from transformers import (BatchFeature, Blip2Config, Blip2QFormerConfig,
                          Blip2VisionConfig, CLIPVisionConfig,
...
class Blip2MultiModalProcessor(BaseMultiModalProcessor):
    ...
    def _get_prompt_replacements(
        ...
        print(f"kh {hf_config=}")
        image_token_id = hf_config.image_token_index

        #max_image_tokens = get_blip2_image_feature_size(hf_config) #32
        max_image_tokens = get_max_blip2_image_tokens(self.ctx)  #256
    ...
    def _get_dummy_mm_inputs(
        ...
        #Convert from AddedToken class to str
        image_token = str(hf_processor.image_token)
        print(f"kh {image_token=}{type(hf_processor)}")
