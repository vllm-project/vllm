...
VLLM_ATTN_ATTR = "attn"
"""Attribute in which to store the vLLM `Attention` instance that serves a Transformers
            ...
            if (
                ...
                if index in self.attention_fusers:
                    ...
                    raise ValueError(
                        ...
                        f"module ({other} and {prefix}), which one vLLM attention "
                        "layer cannot serve."
                    )
    ...
    def create_attention_instances(self) -> dict[int, Attention]:
        ...
        if getattr(text_config, "kv_lora_rank", None) is not None:
            if attn_cls is MLAAttention:
                text_config._attn_implementation = VLLM_MLA_ATTN_IMPL
            else:
