# coding=utf-8
# Adapted from
# https://github.com/huggingface/transformers/blob/v4.28.0/src/transformers/models/BlueLM/modeling_BlueLM.py
...
from vllm.transformers_utils.configs import BlueLMConfig
...
class BlueLMForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        self.model = BlueLMModel(config, quant_config)
        vocab_size = ((config.vocab_size + 63) // 64) * 64
