# coding=utf-8
# Adapted from https://huggingface.co/THUDM/chatglm2-6b/blob/main/modeling_chatglm.py
...
class ChatGLMAttention(nn.Module):
    ...
    def __init__(
        ...
        self.projection_size = kv_channels * num_heads
        # Per attention head and per partition values.
        self.hidden_size_per_attention_head = self.projection_size // num_heads
        ...
        if multi_query_attention:
            ...
            self.qkv_hidden_size = (
                    self.projection_size + 2 * self.hidden_size_per_attention_head * multi_query_group_num
            )
...
class ChatGLMForCausalLM(nn.Module):
    ...
    # TODO: I have no confidence on the correctness of below code snippet.
    # follow baichuan's code.
