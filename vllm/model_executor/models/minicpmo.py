...
if TYPE_CHECKING:
    from vllm.foundation.integrations.transformers_utils.processors.minicpmo import (
        MiniCPMOProcessor,
    )
...
class MiniCPMOProcessingInfo(MiniCPMVProcessingInfo):
    ...
    def get_hf_processor(self, **kwargs: object) -> "MiniCPMOProcessor":
        ...
        from vllm.foundation.integrations.transformers_utils.processors.minicpmo import (  # noqa: E501
            MiniCPMOProcessor,
        )
