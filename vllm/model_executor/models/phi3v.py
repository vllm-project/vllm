...
from transformers import CLIPVisionModel, LlamaConfig, PretrainedConfig
...
class Phi3VForCausalLM(VisionLanguageModelBase):
    def __init__(self, 
        ...
        self.vision_embed_tokens = Phi3ImageEmbedding(config, self.model.embed_tokens)
    ...
    def load_weights(self, weights: Iterable[Tuple[str, torch.Tensor]]):
        ...
        for name, loaded_weight in weights:
            ...
            if "model.vision_embed_tokens" in name:
                name = name.replace("model.vision_embed_tokens", "vision_embed_tokens")
