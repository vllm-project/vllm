...
# Adapted from
# https://github.com/vllm-project/vllm/blob/main/vllm/model_executor/models/granite.py
...
"""Inference-only IBM Granite model with sliding window attention and sinks."""
...
from .granite import GraniteMLP
...
class GraniteSWAForCausalLM(nn.Module, SupportsLoRA, SupportsPP, SupportsQuant):
    hf_to_vllm_mapper = GraniteSWAModel.hf_to_vllm_mapper
