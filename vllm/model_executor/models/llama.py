    ...
    def forward(
        ...
        for i in range(self.start_layer, self.end_layer):
            ...
            hidden_states, residual = layer(
                positions, hidden_states, kv_caches[i - self.start_layer], attn_metadata, residual
            )
...
class LlamaForCausalLM(nn.Module, SupportsLoRA):
    ...
    supported_lora_modules = ["qkv_proj", "o_proj", "gate_up_proj", "down_proj", "embed_tokens", "lm_head"]
    ...
    def __init__(
        ...
        self.model = LlamaModel(config, cache_config, quant_config, lora_config=lora_config, prefix="model")
        if get_pp_group().is_last_rank:
