...
def create_qwen2_5_omni_thinker_field_config(spatial_merge_size: int) -> Callable[
    ...
    def _parse_audio_data(
        ...
        if isinstance(data, dict):
            return DictEmbeddingItems(
                ...
                fields_factory=create_qwen2_5_omni_thinker_field_config(self._spatial_merge_size),
            )
...
class Qwen2_5OmniThinkerMultiModalProcessor(
    ...
    def _get_mm_fields_config(
        ...
        return create_qwen2_5_omni_thinker_field_config(
