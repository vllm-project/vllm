...
_TEXT_GENERATION_MODELS = {
    ...
    # Qwen3.5-MoE shares the Qwen3-Next hybrid GDN architecture
    "Qwen3_5MoeForConditionalGeneration": ("qwen3_next", "Qwen3NextForCausalLM"),
    "Qwen3_5MoeForCausalLM": ("qwen3_next", "Qwen3NextForCausalLM"),
