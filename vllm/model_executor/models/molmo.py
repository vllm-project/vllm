    ...
    def __call__(
        ...
        **kwargs,
        ...
        if image_input_idx is not None:
            ...
            feat_is_patch_flat[image_valid_flat] = input_is_patch[
                image_input_idx_flat[image_valid_flat]]
...
class MolmoMultiModalProcessor(BaseMultiModalProcessor[MolmoProcessingInfo]):
    ...
    def _get_prompt_updates(
        ...
        extra_joint = [img_start_id
                       ] + extra_row * image_token_length_h + [img_end_id]
