...
class MPTMLP(nn.Module):
    def __init__(self, config: MPTConfig):
        ...
        self.up_proj = ColumnParallelLinear(
            hidden_size, intermediate_size, bias=not config.no_bias, gather_output=False, perform_initialization=False
        )
...
class MPTModel(nn.Module):
    def __init__(self, config: MPTConfig):
        ...
        self.wte = VocabParallelEmbedding(config.vocab_size, config.d_model, perform_initialization=False)
