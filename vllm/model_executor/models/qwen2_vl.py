...
def _get_vision_info(
    ...
    llm_num_vision_tokens = (
        vision_tokens // image_processor.merge_size // image_processor.merge_size
    )
...
def _expand_pad_tokens(
    ...
    """
    indices = [idx for idx, token in enumerate(prompt_token_ids) if token == token_id]
    ...
    for cnt, data in enumerate(inputs):
        ...
        if cnt == 0:
            ...
            non_data_tokens = prompt_token_ids[indices[cnt - 1] + 1 : indices[cnt]]
    ...
    def _parse_and_validate_image_input(
        ...
        if pixel_values is not None:
            ...
            return Qwen2VLImagePixelInputs(
                type="pixel_values", data=pixel_values, image_grid_thw=image_grid_thw
            )
        ...
        if image_embeds is not None:
            ...
            return Qwen2VLImageEmbeddingInputs(type="image_embeds", data=image_embeds)
