...
class Siglip2EncoderLayer(nn.Module):
    ...
    def forward(
        ...
        """
        Args:
            hidden_states: Input tensor of shape (seq_len, embed_dim).
            cu_seqlens: Cumulative sequence lengths tensor.
            rotary_pos_emb_cos: Cosine component of rotary position embeddings.
            rotary_pos_emb_sin: Sine component of rotary position embeddings.
        """
...
class Siglip2Encoder(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.config = config
        with set_model_tag("siglip2_encoder", is_encoder=True):
