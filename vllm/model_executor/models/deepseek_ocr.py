...
def _ban_repeated_ngrams(
    ...
    `ngram_size`. Matches `NoRepeatNGramLogitsProcessor` semantics.
...
class NGramPerReqLogitsProcessorV2(V2LogitsProcessor):
    ...
    Same per-request semantics as `NGramPerReqLogitsProcessor` (the V1-runner
    wrapper of `NoRepeatNGramLogitsProcessor`), against the batched V2 logits
