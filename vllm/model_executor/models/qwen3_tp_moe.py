...
class Qwen3TPMoeSparseMoeBlock(nn.Module):
    def __init__(
        self,
...
class Qwen3TPMoeAttention(nn.Module):
    def __init__(
        self,
        hidden_size: int,
        num_heads: int,
...
class Qwen3TPMoeDecoderLayer(nn.Module):
    def __init__(self, vllm_config: VllmConfig, prefix: str = "") -> None:
        ...
        self.self_attn = Qwen3TPMoeAttention(
        ...
        if (layer_idx not in mlp_only_layers) and (
            ...
            self.mlp = Qwen3TPMoeSparseMoeBlock(
                vllm_config=vllm_config, prefix=f"{prefix}.mlp"
            )
        else:
            self.mlp = Qwen3TPMoeMLP(
                hidden_size=config.hidden_size,
...
class Qwen3TPMoeModel(nn.Module):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: Qwen3TPMoeDecoderLayer(vllm_config=vllm_config, prefix=prefix),
...
class Qwen3TPMoeForCausalLM(
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        for layer in self.model.layers:
            ...
            assert isinstance(layer, Qwen3TPMoeDecoderLayer)
            if isinstance(layer.mlp, Qwen3TPMoeSparseMoeBlock):
                example_layer = layer.mlp
                self.moe_layers.append(layer.mlp.experts)

        if example_layer is None:
            raise RuntimeError("No Qwen3TPMoe layer found in the model.layers.")
