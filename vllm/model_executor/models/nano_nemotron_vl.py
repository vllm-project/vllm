...
class NanoNemotronVLDummyInputsBuilder(
    ...
    def get_dummy_mm_data(
        ...
        if extractor := self.info.audio_extractor:
            ...
            print(tokens_per_audio)
            audio_len = extractor.audio_length(tokens_per_audio)
            dummy_audio = {
...
class NemotronH_Nano_VL_V2(
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.mlp1 = self.mlp1.to(llm_dtype)
    ...
    def _parse_and_validate_multimodal_inputs(self, **kwargs: object) -> dict:
        ...
        for input_key in kwargs:
            ...
            if (
                ...
                modalities["audios"] = NanoNemotronVLAudioFeatureInputs(**kwargs)
