...
def get_quant_config(
    ...
    if hf_quant_config is None:
        ...
        if model_config.quantization in ["quark_online_fp4", "quark_online_fp8_ptpc"]:
            hf_quant_config = quant_cls.get_default_quant_config_by_quantization_scheme(model_config.quantization)
