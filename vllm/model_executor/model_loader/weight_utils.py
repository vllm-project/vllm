...
from vllm.utils.system_utils import get_fs_type, is_network_filesystem
...
def safetensors_weights_iterator(
    ...
    *,
    ...
    # Only the first file is checked — all checkpoint shards reside in the
    # same directory and therefore on the same filesystem.
    fs_type = get_fs_type(sorted_files[0]) if sorted_files else ""
    is_net_fs = is_network_filesystem(sorted_files[0]) if sorted_files else False
