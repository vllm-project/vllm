...
class BaseModelLoader(ABC):
    ...
    def load_model(
        ...
        with set_default_torch_dtype(model_config.dtype):
            ...
            use_layerwise_loading = _get_use_layerwise_loading(
...
def _get_use_layerwise_loading(
    model_loader: BaseModelLoader, vllm_config: VllmConfig, model_config: ModelConfig
) -> bool:
    # Online quantization is needed when we have FP8 quantization
    # but the checkpoint is not already serialized in FP8 format
    ...
    return is_online_quant and not is_dummy_loader
