...
# subsequent run (repeated run in RL training loop):
...
#  process_weights_after_loading (if present):
#    this will be skipped since it's already ran in
#    load_weights


def save_metadata_and_attributes_for_weight_reloading(model: nn.Module):
