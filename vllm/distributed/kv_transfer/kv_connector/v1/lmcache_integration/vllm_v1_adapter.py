...
class LMCacheConnectorV1Impl:
    ...
    def start_load_kv(self, forward_context: "ForwardContext", **kwargs) -> None:
        ...
        # If CUDA graphs are enabled, drain all layer retrievers now since
        # wait_for_layer_load() won't be called during graph replay.
        if (self.layerwise_retrievers
                and forward_context.cudagraph_runtime_mode.has_full_cudagraphs()):
