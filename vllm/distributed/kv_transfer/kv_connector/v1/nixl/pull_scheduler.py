...
class NixlPullConnectorScheduler(NixlBaseConnectorScheduler):
    ...
    def request_finished(
        ...
        if delay_free_blocks:
            ...
            expiry_time = time.perf_counter() + request_kv_blocks_ttl
            self._reqs_need_send[request.request_id] = expiry_time
            if is_d_node:
                # D blocks TTL exported for the turn-2 readback.
                blocks_ttl = request_kv_blocks_ttl
                blocks_expiry_time = expiry_time
