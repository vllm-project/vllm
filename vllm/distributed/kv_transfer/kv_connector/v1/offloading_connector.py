...
class OffloadingConnectorScheduler:
    ...
    def get_num_new_matched_tokens(
        ...
        """
        # Prefer prefix-based lookup if the request provides shared prefix hints.
        # This allows connectors to implement shared-prefix/extent directories
        # without relying on BlockHash-based entries.
    ...
    def update_state_after_alloc(
        ...
        if shared_prefix_id is not None and shared_prefix_len is not None:
            # Prefix-based load: src spec comes from the manager's prefix directory.
        ...
        if block_hashes:
            ...
            # Prefix-based loads do not use BlockHash entries.
