...
_WORLD: Optional[Union[GroupCoordinator, "StatelessGroupCoordinator"]] = None
...
_DP: Optional[Union[GroupCoordinator, "StatelessGroupCoordinator"]] = None
...
_EP: Optional[Union[GroupCoordinator, "StatelessGroupCoordinator"]] = None
...
_STANDBY_DP: Optional["StatelessGroupCoordinator"] = None
_STANDBY_EP: Optional["StatelessGroupCoordinator"] = None
_STANDBY_WORLD: Optional["StatelessGroupCoordinator"] = None
_STANDBY_WORLD_NODE_COUNT: Optional[int] = None


def get_standby_dp_group() -> Optional["StatelessGroupCoordinator"]:
    return _STANDBY_DP


def get_standby_ep_group() -> Optional["StatelessGroupCoordinator"]:
    return _STANDBY_EP


def get_standby_world_group() -> Optional["StatelessGroupCoordinator"]:
