...
def graph_capture():
    ...
    with torch.cuda.stream(stream), maybe_ca_context:
        ...
        #
        # The current status on ROCm is:
        #     allreduce \ Mode   |  Eager  |  Graph  |
        # --------------------------------------------
        # custom allreduce       | disabled| disabled|
        # PyNccl                 | disabled| disabled|
        # torch.distributed      | enabled | enabled |
        #
        # In summary:
        # On ROCm, we use PyTorch NCCL at all times.
        # On CUDA, when using CUDA graph, we use
