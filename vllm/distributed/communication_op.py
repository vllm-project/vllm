...
def broadcast_sp_tensor_dict(data_dict: Optional[Dict[Any, Union[torch.Tensor,
                                                                 Any]]] = None,
                             src: int = 0):
    if not torch.distributed.is_initialized():
        return data_dict
...
def send_sp_tensor(tensor: torch.Tensor = None,
                   sp_group: int = 0,
                   dst: int = 0):
...
def recv_sp_tensor(tensor: torch.Tensor = None,
                   sp_group: int = 0,
                   src: int = 0):
