import logging
from typing import Any, Callable, Dict, Hashable, List, Optional, Set, Type, Tuple
...
def convert_mapping(
    ...
    Returns:
        A tuple of tensors:
            ...
            sampler_indices: Tensor of shape [batch_size] mapping requests to
                PromptAdapter indices for sampler. For generation, this will be the
    ...
    for i in range(len(index_mapping_indices)):
        ...
        prompt_adapter_idx = (prompt_adapter_index_to_id.index(index_mapping_indices[i])
    ...
    sampler_indices_padded[sampler_indices_padded == -1] = max_prompt_adapters - 1
...
class PromptAdapterModelManager(AdapterModelManager):
    ...
    def _set_prompt_adapter_mapping(self, mapping: PromptAdapterMapping) -> None:
        (base_indices, sampler_indices, sampler_indices_padded,
...
def create_prompt_adapter_manager(
    ...
    prompt_adapter_manager = prompt_adapter_manager_cls(
        ...
        max_num_batched_tokens=max_num_batched_tokens, prompt_adapter_config=prompt_adapter_config, **kwargs)
