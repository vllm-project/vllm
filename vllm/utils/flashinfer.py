...
# ===
# MoE FlashInfer utilities
#
# These pure helpers (no torch.nn.Module dependency) were previously in
# vllm.model_executor.layers.quantization.utils.flashinfer_utils and are
# consolidated here so there is a single canonical location for all
# FlashInfer-related utilities.
# ===
...
def activation_to_flashinfer_int(activation: "MoEActivation") -> int:
    ...
    # silu and gelu are mapped to their gated versions SwiGLU and GeGLU
    # respectively
...
__all__ = [
    ...
    # MoE FlashInfer utilities (consolidated from flashinfer_utils)
