...
def get_sparse_mqa_logits_metadata(
    ...
    Args:
        cu_seqlen_ks: Per-row K range start in the packed KV workspace, shape
            [num_q_tokens], dtype int32.
        cu_seqlen_ke: Per-row K range end in the packed KV workspace, shape
            [num_q_tokens], dtype int32.
