...
STR_DIFFERENTIAL_FLASH_ATTN_VAL: str = "DIFFERENTIAL_FLASH_ATTN"
STR_PLACEHOLDER_ATTN_VAL: str = "PLACEHOLDER_ATTN"
STR_FLASHMLA_VAL: str = "FLASHMLA"
STR_ROCM_AITER_MLA_VAL: str = "ROCM_AITER_MLA"
STR_TRITON_MLA_VAL: str = "TRITON_MLA"
