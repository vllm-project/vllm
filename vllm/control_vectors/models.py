...
class ControlVectorModelManager(AdapterModelManager):
    ...
    def __init__(self, model: nn.Module, control_vector_config: ControlVectorConfig):
        ...
        self.control_vector_index_to_id: List[Optional[int]] = [None] * self.adapter_slots
        ...
        for module_name, module in self.model.named_modules():
            for key in _all_cv_classes:
                ...
                if isinstance(module, _all_cv_classes[key]):
                    continue
                new_module = self.replace_submodule(self.model, module_name, _all_cv_classes[key](module))
...
def create_cv_manager(
    ...
    control_vector_manager_cls: Type[ControlVectorModelManager] = ControlVectorModelManager,
