        ...
        for ptr, data in self.pointer_to_data.items():
            if tags is None or data.tag in tags:
                ...
                try:
                    ...
                    # crash the process.
                    continue
                # Only mark awake once the VA is successfully remapped; on the
                # failure path above we `continue`, so it stays flagged asleep
                # and is reported via WakeUpPartialFailure.
