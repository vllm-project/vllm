...
class EncodeOnlyWorkflow(Workflow):
    ...
    InputProcessor: str = ("vllm.wde.encode_only.processor."
                           "input_processor:EncodeOnlyModelInputProcessor")
    RequestProcessor: str = ("vllm.wde.encode_only.processor."
    ...
    ModelInputBuilder: str = (
        "vllm.wde.encode_only.processor."
    ...
    AttnBackend: str = ("vllm.wde.encode_only.layers."
