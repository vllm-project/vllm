...
_maybe_add_tolerance(
    DEFAULT_TOLERANCES, "float8_e4m3fn", {"atol": 1e-1, "rtol": 1e-1}
)

# 2-bit mantissa; machine epsilon ~1.25e-1.
# Wider than e4m3fn due to the smaller mantissa.
_maybe_add_tolerance(
    DEFAULT_TOLERANCES, "float8_e5m2", {"atol": 2e-1, "rtol": 2e-1}
)
...
_maybe_add_tolerance(
    DEFAULT_TOLERANCES, "float4_e2m1fn_x2", {"atol": 3e-1, "rtol": 3e-1}
)
