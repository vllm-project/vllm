...
class EngineArgs:
    ...
    decode_priority_cadence: int = SchedulerConfig.decode_priority_cadence
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        scheduler_group.add_argument(
            ...
            **scheduler_kwargs["decode_priority_cadence"],
        )
        scheduler_group.add_argument(
    ...
    def create_engine_config(
        ...
        scheduler_config = SchedulerConfig(
            ...
            decode_priority_cadence=self.decode_priority_cadence,
