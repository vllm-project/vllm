...
class EngineArgs:
    ...
    def create_engine_configs(
        ...
        max_model_len = getattr(model_config.hf_config, 'max_position_embeddings', float('inf'))
        scheduler_config = SchedulerConfig(self.max_num_batched_tokens, self.max_num_seqs, max_model_len)
