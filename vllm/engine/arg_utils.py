...
@dataclass
class SpSEngineArgs:
    """Arguments for vLLM engine. With speculative decoding"""
    draft_model: str
    target_model: str
    window_size: int = 8
    tokenizer: Optional[str] = None
    ...
    def create_engine_configs(
        ...
        draft_model_config = ModelConfig(
            ...
            self.trust_remote_code, self.download_dir, self.use_np_weights,
        ...
        scheduler_config = SchedulerConfig(
            ...
            draft_model_config.get_max_model_len())
        return draft_model_config, target_model_config, cache_config, parallel_config, scheduler_config
