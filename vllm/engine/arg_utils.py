...
class EngineArgs:
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        # Multi-step scheduling arguments removed
    ...
    def create_engine_config(
        ...
        if self.num_scheduler_steps != 1:
            raise ValueError("Multi-step scheduling has been removed; "
                             "num_scheduler_steps must be 1.")

        # Set num_lookahead_slots appropriately when speculative decoding is
        # enabled.
        num_lookahead_slots = (self.num_lookahead_slots if speculative_config is None
