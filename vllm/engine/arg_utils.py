...
class EngineArgs:
    ...
    enable_return_sampling_mask: bool = ModelConfig.enable_return_sampling_mask
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        model_group.add_argument(
            ...
            **model_kwargs["enable_return_sampling_mask"],
        )
    ...
    def create_model_config(self) -> ModelConfig:
        ...
        return ModelConfig(
            ...
            enable_return_sampling_mask=self.enable_return_sampling_mask,
