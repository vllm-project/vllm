...
from vllm.inputs.prefill_only.data import Inputs, Params
...
class LLMEngine:
    ...
    def _maybe_init_async_scheduling(self):
        ...
        if self.use_async_scheduling:
            self.executor_in: Queue = Queue()
            self.executor_out: Queue = Queue()
    ...
    def from_engine_args(cls, engine_args: Union[Dict,
        ...
        from vllm.model_executor.prefill_only.loader.utils import (
            get_model_workflow)
