...
class LLMEngine:
    ...
    def _get_stats(self,
        ...
        # Swap the usage and cache hit stats of between gpu and cpu when running on cpu environment because cpu worker intentionally counts cpu blocks as gpu blocks.
