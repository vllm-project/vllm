...
class EngineClient(ABC):
    ...
    async def beam_search(
        ...
        for _ in range(max_tokens):
            ...
            all_beams_token_id = []
            #Store the cumulative probability of all tokens generated by beam search
            all_beams_logprob = []
            ...
            if not ignore_eos:
                ...
                #After processing, set the log probability of the eos condition to negative infinity.
