...
HfOverrides = Union[
    Dict[str, Any], Callable[[PretrainedConfig], PretrainedConfig]
]
...
class SpeculativeConfig:
    ...
    def maybe_create_spec_config(
        ...
        if speculative_model == "[ngram]":
            ...
            speculative_draft_tensor_parallel_size = SpeculativeConfig._verify_and_get_draft_model_tensor_parallel_size(
            ...
            if (
                ...
                and speculative_draft_tensor_parallel_size != 1
            ):
...
class PromptAdapterConfig:
    ...
    def verify_with_model_config(self, model_config: ModelConfig):
        if self.prompt_adapter_dtype in (None, "auto"):
            ...
            self.prompt_adapter_dtype = getattr(
                torch, self.prompt_adapter_dtype
            )
...
def _get_and_verify_max_len(
    ...
    if disable_sliding_window and sliding_window_len is not None:
        ...
        derived_max_model_len = min(
            derived_max_model_len, sliding_window_len_min
        )
...
def get_min_sliding_window(
    sliding_window: Union[int, List[Optional[int]]],
) -> int:
...
class VllmConfig:
    ...
    parallel_config: ParallelConfig = field(default=None, init=True)  # type: ignore
    scheduler_config: SchedulerConfig = field(default=None, init=True)  # type: ignore
