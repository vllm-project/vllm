...
class ModelConfig:
    ...
    Args:
        ...
        disable_mm_cache_preprocessor: If true, then disables caching of the
    ...
    def __init__(self,
        ...
        self.disable_mm_cache_preprocessor = disable_mm_cache_preprocessor
...
class VllmConfig:
    ...
    def __str__(self):
        return (
            ...
            f"disable_mm_cache_preprocessor={self.model_config.disable_mm_cache_preprocessor!r}, "  # noqa
