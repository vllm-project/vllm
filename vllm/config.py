...
class ModelConfig:
    ...
    def __init__(
        ...
        max_seqlen_to_capture: Optional[int] = None,
        max_logprobs: int = 5,
        ...
        self.max_seqlen_to_capture = max_seqlen_to_capture or max_context_len_to_capture
    ...
    def _verify_cuda_graph(self) -> None:
        if self.max_seqlen_to_capture is None:
            self.max_seqlen_to_capture = self.max_model_len
        self.max_seqlen_to_capture = min(self.max_seqlen_to_capture,
                                              self.max_model_len)
...
class SpeculativeConfig:
    ...
    def maybe_create_spec_config(
        ...
        draft_model_config = ModelConfig(
            ...
            max_seqlen_to_capture=target_model_config.
            max_seqlen_to_capture,
