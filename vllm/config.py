...
def _get_and_verify_max_len(
    ...
    # The correct one should be "longrope", kept "su" here to be backward compatible
    if rope_scaling is not None and rope_scaling["type"] != "su" and rope_scaling["type"] != "longrope":
