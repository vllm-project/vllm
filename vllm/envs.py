...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # HTTP port of the P-side vLLM OpenAI server, used by D to send lease
    # refresh requests to keep KV blocks alive while requests are queued.
    "VLLM_NIXL_HTTP_PORT": lambda: int(os.getenv("VLLM_NIXL_HTTP_PORT", "8000")),
