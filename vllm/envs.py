...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Fuse the DeepSeek-V4.1 sequence-parallel ``wo_b`` projection with its
    # TP reduce-scatter using the SM100 BF16/MXFP8 GEMM-RS kernel. All TP
    # ranks must belong to one NVLink domain. Off until model evals land.
    "VLLM_DSV41_GEMM_RS": lambda: bool(int(os.getenv("VLLM_DSV41_GEMM_RS", "0"))),
