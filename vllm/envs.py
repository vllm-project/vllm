...
if TYPE_CHECKING:
    ...
    VLLM_Q3VL_FUSE_ATTN_PROLOGUE: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Fuse Qwen3-VL QK norm, MRoPE, KV quantization, and cache update.
    "VLLM_Q3VL_FUSE_ATTN_PROLOGUE": lambda: (
        os.getenv("VLLM_Q3VL_FUSE_ATTN_PROLOGUE", "False").lower() in ("true", "1")
    ),
