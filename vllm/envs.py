...
if TYPE_CHECKING:
    ...
    VLLM_ENABLE_HPC_ROPE_NORM: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # ENABLE HPC kernels (hpc rope_norm and so on)
    "VLLM_ENABLE_HPC_ROPE_NORM": lambda: bool(
        int(os.getenv("VLLM_ENABLE_HPC_ROPE_NORM", "0"))
    ),
