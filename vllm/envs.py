...
if TYPE_CHECKING:
    ...
    VLLM_DSV41_PROJECT_BEFORE_AG: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Project sequence shards before gathering DSV4.1 attention inputs.
    "VLLM_DSV41_PROJECT_BEFORE_AG": lambda: bool(
        int(os.getenv("VLLM_DSV41_PROJECT_BEFORE_AG", "0"))
    ),
