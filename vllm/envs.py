...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Enables viztracer (CPU-only) and torch profiler (CPU+GPU) if set.
    # Both non-worker processes's CPU traces as well as workers'
    # torch profile traces (CPU+GPU) will be saved under this directory.
