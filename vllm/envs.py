...
if TYPE_CHECKING:
    ...
    VLLM_DEEPEP_V2_ALLOW_HYBRID_MODE: bool | None = None
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # DeepEP v2: unset selects hybrid mode across NVLink domains, NVLink-only
    # within one domain. Set 0 or 1 to override topology-based selection.
    "VLLM_DEEPEP_V2_ALLOW_HYBRID_MODE": lambda: maybe_convert_bool(
        os.getenv("VLLM_DEEPEP_V2_ALLOW_HYBRID_MODE")
    ),
