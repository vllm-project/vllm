...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # batch is split into sub-batches that each fit. The output buffer is also
    # reused across calls so the caching allocator does not fragment from
    # per-layer alloc/free of multi-GB tensors. 0 disables both the budget
    # check and the chunking (legacy behaviour). Default: 4096 MB.
