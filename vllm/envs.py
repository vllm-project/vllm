...
if TYPE_CHECKING:
    ...
    VLLM_MINIMAX_SPARSE_PREFILL_TILE_Q: int = 0
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Experimental query-tile size for MiniMax-M3 sparse prefill attention.
    # Zero or one keeps the scalar kernel; larger values opt into query tiling.
    "VLLM_MINIMAX_SPARSE_PREFILL_TILE_Q": lambda: int(
        os.getenv("VLLM_MINIMAX_SPARSE_PREFILL_TILE_Q", "0")
    ),
