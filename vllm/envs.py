...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_USE_MEGA_AOT_ARTIFACT": lambda: (
        os.environ.get("VLLM_USE_MEGA_AOT_ARTIFACT", "0") == "1"
    ),
    ...
    # Example: VLLM_TOOL_TOKENS_TO_SUPPRESS=1271,1268,1270
    "VLLM_TOOL_TOKENS_TO_SUPPRESS": lambda: [
        int(x.strip())
        for x in os.getenv("VLLM_TOOL_TOKENS_TO_SUPPRESS", "").split(",")
        if x.strip()
    ],
    # Whether to apply logit bias to suppress tool tokens when tool_choice is "none"
