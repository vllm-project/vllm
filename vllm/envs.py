...
if TYPE_CHECKING:
    ...
    VLLM_ROCM_USE_MERGED_MOE_FRONT: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Use a merged MoE-front projection for explicitly tuned model shapes.
    # Routed experts remain on the native backend.
    "VLLM_ROCM_USE_MERGED_MOE_FRONT": lambda: bool(
        int(os.getenv("VLLM_ROCM_USE_MERGED_MOE_FRONT", "0"))
    ),
