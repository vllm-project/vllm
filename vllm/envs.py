...
if TYPE_CHECKING:
    ...
    VLLM_ROCM_USE_AITER_MLA_ROPE: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Whether to use aiter asm rope kernel for MLA (DeepSeek) rotary embedding.
    # By default is disabled.
    "VLLM_ROCM_USE_AITER_MLA_ROPE": lambda: (
        os.getenv("VLLM_ROCM_USE_AITER_MLA_ROPE", "False").lower() in ("true", "1")
    ),
