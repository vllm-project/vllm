...
if TYPE_CHECKING:
    ...
    VLLM_USE_ALPHA_MOE: bool = False
    VLLM_ALPHA_MOE_CONFIG: str | None = None
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # If set to 1, use Alpha MoE fused FP8 megakernel for MoE ops.
    # Alpha MoE provides high-performance CUDA kernels optimized for TP servings.
    # Requires Alpha-MoE package to be installed.
    "VLLM_USE_ALPHA_MOE": lambda: bool(int(os.getenv("VLLM_USE_ALPHA_MOE", "0"))),
    # Path to Alpha MoE configuration file (JSON format).
    # Generated by running: python jit_moe.py --E <experts> --N <N> --K <K>
    "VLLM_ALPHA_MOE_CONFIG": lambda: os.getenv("VLLM_ALPHA_MOE_CONFIG", None),
