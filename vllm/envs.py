...
if TYPE_CHECKING:
    ...
    VLLM_DEEPEP_V2_MAX_SYNCLESS_TOKENS: int = 0
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # DeepEP v2: use worst-case expanded allocation below this per-rank token
    # count to avoid the dispatch CPU sync. Disabled by default.
    "VLLM_DEEPEP_V2_MAX_SYNCLESS_TOKENS": lambda: int(
        os.getenv("VLLM_DEEPEP_V2_MAX_SYNCLESS_TOKENS", "0")
    ),
