...
if TYPE_CHECKING:
    ...
    VLLM_XPU_INC_W4A16_BACKEND: Literal["auto", "ark", "w4a16", "w4a8"] = "auto"
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Kernel backend for INC weight-only int4 linear layers on XPU.
    ...
    "VLLM_XPU_INC_W4A16_BACKEND": env_with_choices(
        "VLLM_XPU_INC_W4A16_BACKEND", "auto", ["auto", "ark", "w4a16", "w4a8"]
    ),
