...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # If unset, default to the precompiled wheel path for editable installs.
    # Set VLLM_USE_PRECOMPILED=0 to force a local compiled build.
    "VLLM_USE_PRECOMPILED": lambda: os.environ.get("VLLM_USE_PRECOMPILED", "1")
    .strip()
    .lower()
    in ("1", "true")
    ...
    # Use RayDistributedExecutor V2 backend.
    ...
    # Directory for caching media downloads. Empty string disables caching.
    ...
    # Time-to-live in hours for cached media files.
    ...
    # Maximum total number of sequences generated per request (beam width times
    # sequences per request). Limits resource consumption. Default: 16384.
    ...
    # If set to "0", disable LayerName opaque type for layer_name params.
    ...
    # SSM convolution state layout used throughout vLLM.
    ...
    # If set, skip model name validation in API requests.
