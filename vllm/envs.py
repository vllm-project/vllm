...
if TYPE_CHECKING:
    ...
    VLLM_MLA_FUSED_ROPE_QUANT: bool = True
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # If set to 0, disables fused RoPE+FP8 quantization in MLA decode.
    # Default is enabled (1) for FP8 KV cache.
    "VLLM_MLA_FUSED_ROPE_QUANT": lambda: bool(
        int(os.getenv("VLLM_MLA_FUSED_ROPE_QUANT", "1"))
    ),
