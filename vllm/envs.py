...
if TYPE_CHECKING:
    ...
    VLLM_ENFORCE_TRITON_ATTN: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # If set to True or 1, vLLM will use the Triton flash attention kernel
    # for MLA prefill instead of the default backend.
    "VLLM_ENFORCE_TRITON_ATTN": lambda: (
        os.getenv("VLLM_ENFORCE_TRITON_ATTN", "False").lower() in ("true", "1")
    ),
