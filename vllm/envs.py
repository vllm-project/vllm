...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # of the per-tool `strict` field: "off" (default) only constrains an
    # "auto" request when a tool sets strict, "function" constrains the
    # tool-call envelope for every request with tools, "parameter" also pins
    # argument schemas. Mirrors SGLANG_TOOL_STRICT_LEVEL.
    "VLLM_TOOL_STRICT_LEVEL": lambda: os.getenv("VLLM_TOOL_STRICT_LEVEL", "off"),
