...
from vllm.sequence import (Sequence, SequenceData, SequenceGroup,
                           ...
                           SequenceStatus)
from vllm.utils import BlockSwapParam, Device, PyObjectCache
...
class SchedulerOutputs:
    ...
    blocks_to_swap_in: List[Tuple[BlockSwapParam, BlockSwapParam]]
...
class Scheduler:
    ...
    def _schedule_running(
        ...
        blocks_to_swap_out: List[Tuple[
            BlockSwapParam, BlockSwapParam]] = ret.blocks_to_swap_out
