...
class BlockTable:
    ...
    def allocate(self, token_ids: List[int], device: Device = Device.GPU) -> None:
        ...
        assert token_ids
        self._blocks = self._allocate_blocks_for_token_ids(prev_block=None, token_ids=token_ids, device=device)
    ...
    def append_token_ids(self, token_ids: List[int]) -> None:
        ...
        token_blocks = [token_ids[:first_chunk_size]] + chunk_list(token_ids[first_chunk_size:], self._block_size)
