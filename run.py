...
model = LLM(MODEL_NAME, enforce_eager=True, tensor_parallel_size=TENSOR_PARALLEL_SIZE)
print("\n\n")
print(model.generate("The best thing about the internet is", sampling_params=params)[0].outputs[0].text)
print("\n\n")
