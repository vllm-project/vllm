...
| Pending | gpqa and a 32k-context task with `nvfp4_ds_mla` (gsm8k barely exercises the fp4 compressed path); the bs1 launch-overhead follow-up above; recipes stay untracked like the rest of `recipe/`. |
