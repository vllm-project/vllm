# Example usage:
# Without token parallelism: torchrun --nproc-per-node=4 HTTP/test_http.py --tensor-parallel-size 4 --pipeline-parallel-size 1 --data-parallel-size 1
# With token parallelism: torchrun --nproc-per-node=8 HTTP/test_http.py --tensor-parallel-size 4 --pipeline-parallel-size 1 --data-parallel-size 1 --enable-token-parallel --token-parallel-size 2
