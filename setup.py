...
if (nvcc_cuda_version < Version("11.1") and
    any(cc.startswith("8.6") for cc in compute_capabilities)):
        raise RuntimeError(
...
if nvcc_cuda_version < Version("11.8"):
    if any(cc.startswith("8.9") for cc in compute_capabilities):
        ...
        warnings.warn(
            ...
            "Targeting compute capability 8.0 instead.", stacklevel=2)
