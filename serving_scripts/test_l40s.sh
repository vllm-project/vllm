#!/usr/bin/env bash
# 2-node pipeline parallel: 1x L40S per node (PP=2). Slurm picks L40S nodes.
# Optional: #SBATCH --nodelist=htc-g[061,063]  to pin specific hosts
#SBATCH --job-name=vllm-host-qwen3-30b-l40s
#SBATCH --nodes=2
...
SCRIPT_VERSION="arc-ray-qwen3-30b-a3b-instruct-l40s-pp2"
...
echo "=== vLLM multi-node host job (2x L40S, PP=2) ==="
