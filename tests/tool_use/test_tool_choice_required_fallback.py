...
class TestToolChoiceRequiredNonStreaming:
    ...
    def test_xml_content_raises_without_tool_parser(self):
        """Without a configured tool_parser, XML content should raise."""
        request = _make_request()
    ...
    def test_xml_content_raises_without_enable_auto_tools(self):
    ...
    def test_multiple_json_tool_calls(self):
        ...
        function_calls, returned_content = OpenAIServing._parse_tool_calls_from_content(
            request=request,
            tokenizer=None,
            enable_auto_tools=False,
            tool_parser_cls=None,
