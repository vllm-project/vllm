...
def test_convert_param_value_single_types(parser):
    ...
    assert parser._convert_param_value("123.0", "number") == 123  # Should be int when whole number
    ...
    assert parser._convert_param_value('{"key": "value"}', "unknown") == {"key": "value"}
...
def test_convert_param_value_multi_typed_values(parser):
    ...
    assert parser._convert_param_value("123", ["string", "integer"]) == "123"  # String first
    assert parser._convert_param_value("123", ["integer", "string"]) == 123    # Integer first
    
    # Test with all types failing - returns original value
    assert parser._convert_param_value("not_a_number", ["integer", "float", "boolean"]) == "not_a_number"
...
def test_convert_param_value_stricter_type_checking(parser):
    ...
    assert parser._convert_param_value("TRUE", "boolean") == "TRUE"  # Note: uppercase not in allowed list
    ...
    assert parser._convert_param_value("123abc", ["integer", "float", "string"]) == "123abc"
...
def test_convert_param_value_edge_cases(parser):
    ...
    assert parser._convert_param_value("", "integer") == ""  # Invalid int returns original
    ...
    assert parser._convert_param_value("TRUE", "boolean") == "TRUE"  # Not in allowed list
    assert parser._convert_param_value("FALSE", "boolean") == "FALSE"
