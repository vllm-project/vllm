...
# Bytes per token for the nvfp4_fp8_ds_mla cache layout (see flashmla_sparse.py).
...
def _nvfp4_sf_element_order(wire_sf_bytes: torch.Tensor) -> torch.Tensor:
    ...
    The 32 NoPE scale-factor bytes of an nvfp4_fp8_ds_mla entry are stored
...
def test_concat_and_cache_nvfp4_ds_mla(
    ...
    kv_cache_dtype = "nvfp4_fp8_ds_mla"
