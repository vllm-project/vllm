...
def main(
    ...
    key_cache_f16, value_cache_f16 = key_caches[0], value_caches[0]

    key_cache_fp8 = torch.empty_like(key_cache_f16, dtype=torch.int8)
    value_cache_fp8 = torch.empty_like(value_cache_f16, dtype=torch.int8)

    ops.convert_fp8(key_cache_fp8, key_cache_f16)
    ops.convert_fp8(value_cache_fp8, value_cache_f16)
