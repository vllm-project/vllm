...
Specifically exercises process_weights_after_loading + apply_weights for
square weight matrices (N == K), which previously suffered silent data
corruption due to a shape-based transpose heuristic that was a no-op when
the weight shape tuple (N, K) == (K, N).
