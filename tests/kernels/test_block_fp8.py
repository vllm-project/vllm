...
def deep_gemm_w8a8_block_fp8_moe(M, K, a, w1, w2, w1_s, w2_s, score, topk,
    ...
    topk_weight, topk_ids,token_expert_indices = fused_topk(a, score.float(), topk, False)
...
def test_w8a8_block_fp8_deep_gemm_fused_moe(M, N, K, E, topk, seed):
    ...
    with set_current_vllm_config(vllm_config):
        ...
        topk_weights, topk_ids, token_expert_indices = fused_topk(a, score.float(), topk, False)
