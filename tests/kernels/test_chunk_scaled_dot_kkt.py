...
BT = FLA_CHUNK_SIZE
# Floored by the reduced-precision dot paths (RDNA bf16 WMMA) at ~8e-4; the
# mainline path measures 2.5e-4 on H200 and 1.0e-4 on XPU. bf16 is no worse
# than fp32, both reaching the dot promoted, hence one value for both.
TOL = 1e-3
