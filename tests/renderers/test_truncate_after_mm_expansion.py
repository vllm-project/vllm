...
def test_mixed_prompt_embeds_truncation_defers_to_hf_renderer():
    """In mixed mode (MM + prompt_embeds), HfRenderer defers truncation
    until prompt_embeds spans are attached. A limit clearing all spans must
    truncate normally, while a limit cutting the prompt_embeds span must reject.
    """
