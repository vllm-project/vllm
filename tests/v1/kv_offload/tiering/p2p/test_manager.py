...
class TestBindHostPortDefaults:
    ...
    def _construct(monkeypatch, dp_index=0, **kwargs) -> P2PSecondaryTierManager:
        ...
        # Test-only side channel: the recorded constructor args are stashed on
        # the instance so callers can read them back off the returned manager.
    ...
    def test_nixl_name_decoupled_from_identity(self, monkeypatch):
        ...
        calls: dict = mgr._test_calls  # type: ignore[attr-defined]
