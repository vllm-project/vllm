...
def _setup_adaptive_k(scheduler, alphas, prev_k=5):
    ...
    scheduler._adaptive_k_c_draft = 0.1144
    scheduler._adaptive_k_bs_penalty = 0.002
    scheduler._adaptive_k_min_tokens = 0
    scheduler._adaptive_k_cooldown_steps = 2
    scheduler._adaptive_k_alpha_prior = 0.85
...
def test_ema_not_initialized_uses_prior():
    ...
    _setup_adaptive_k(s, [])
    s._per_position_ema = None
    s._adaptive_k_alpha_prior = 0.85
