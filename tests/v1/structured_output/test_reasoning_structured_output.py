...
class TestReasoningStructuredOutput:
    ...
    def test_grammar_init_uses_request_scoped_backend(
        ...
        try:
            ...
            assert guidance_request.sampling_params is not None
            ...
            xgrammar_backend.compile_grammar.assert_called_once_with(
                ...
                '{"type":"object"}',
                stop_token_ids=xgrammar_request.sampling_params.all_stop_token_ids,
            )
            guidance_backend.compile_grammar.assert_called_once_with(
                StructuredOutputOptions.JSON,
                '{"type":"object"}',
                stop_token_ids=guidance_request.sampling_params.all_stop_token_ids,
            )
        finally:
