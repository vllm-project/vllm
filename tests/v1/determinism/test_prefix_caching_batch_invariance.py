...
seeded random shared prefix so several prefix-cache blocks are exercised, and
verifies that a cold run and a hot-cache rerun of the same batch produce
bitwise-identical logprobs across a sweep of batch sizes.
"""
...
def test_logprobs_prefix_caching_batch_invariance(
    ...
    try:
        ...
        tokenized_prompts, shared_prefix_tokens = _build_prompt_variants(
            llm,
            max_batch_size,
        )
