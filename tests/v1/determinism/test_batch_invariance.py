...
@skip_unsupported
def test_logprobs_bitwise_batch_invariance_bs1_vs_bsN_no_forced_backend():
    if not IS_HETERO_HEAD_SIZE:
        pytest.skip(
            "This test checks behaviour on mixed attention backends; "
            "homogeneous head size models do not mix backends."
        )
