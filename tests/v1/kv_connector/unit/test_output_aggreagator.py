...
class DummyModelRunnerOutput(ModelRunnerOutput):
    ...
    def __repr__(self):
        return (f"DummyModelRunnerOutput("
                f"finished_sending={self.finished_sending}, "
                f"finished_recving={self.finished_recving}, "
                f"invalid_block_ids={self.invalid_block_ids})")
