...
def test_standardized_view_geometry_and_padded_registration():
    ...
    (view,) = reshape_kv_cache(raw, spec, num_blocks, 1, KVCacheLayout.LBNHC)
    ...
    (mla_view,) = reshape_kv_cache(mla_raw, mla, num_blocks, 1, KVCacheLayout.LBNHC)
