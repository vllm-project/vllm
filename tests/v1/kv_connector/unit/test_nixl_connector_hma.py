...
def test_read_blocks_for_req_expands_remote_ids(
    ...
    # pr1 keeps meta.remote.block_ids logical (reused on retry/failure paths)
    # and applies the per-PP-stage kernel expansion to a local copy used for
    # the reads. Spy on the expansion helper to capture the kernel block IDs.
