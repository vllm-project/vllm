...
tp_configs=(
  ...
  "GPU_MEMORY_UTILIZATION=0.8 MODEL_NAMES=deepseek-ai/DeepSeek-V2-Lite-Chat" # MLA case
  "GPU_MEMORY_UTILIZATION=0.8 PREFILLER_TP_SIZE=1 DECODER_TP_SIZE=2 MODEL_NAMES=deepseek-ai/DeepSeek-V2-Lite-Chat"
  "GPU_MEMORY_UTILIZATION=0.8 PREFILLER_TP_SIZE=2 DECODER_TP_SIZE=1 MODEL_NAMES=deepseek-ai/DeepSeek-V2-Lite-Chat"
)
dp_ep_configs=(
"DP_EP=1 GPU_MEMORY_UTILIZATION=0.8 PREFILLER_TP_SIZE=1 DECODER_TP_SIZE=2 MODEL_NAMES=deepseek-ai/DeepSeek-V2-Lite-Chat" # MLA+P-TP1, D-DPEP=2 (TP=1)
"DP_EP=1 GPU_MEMORY_UTILIZATION=0.8 PREFILLER_TP_SIZE=2 DECODER_TP_SIZE=2 MODEL_NAMES=deepseek-ai/DeepSeek-V2-Lite-Chat" # MLA+P-TP2, D-DPEP=2 (TP=1)
)
