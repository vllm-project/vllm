...
def _quantize_dequantize_nvfp4_ds_mla(
    ...
    """Round-trip kv_c/k_pe through the nvfp4_fp8_ds_mla cache layout.
...
@pytest.mark.parametrize(
    "kv_cache_dtype",
    ["auto", "fp8", "fp8_ds_mla", "nvfp4_fp8_ds_mla"],
)
...
def test_sparse_backend_decode_correctness(
    ...
    use_nvfp4_ds_mla_quantization = kv_cache_dtype == "nvfp4_fp8_ds_mla"
