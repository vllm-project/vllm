...
def test_uno_adapter_validation_precedes_engine_submission(use_uno, with_adapter):
    """Uno rejects request-specific LoRA before the request reaches the engine.

    This carries the Model Runner V1 rejection cases onto V2; only the
    Uno-plus-adapter combination is invalid, and it must fail at preprocessing.
    """
