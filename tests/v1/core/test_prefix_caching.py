...
_EAGLE_HYBRID_MODEL_TEST_CASES = [
    ...
    # 2 groups: 0 full (all other types)
    pytest.param(["sliding_window", "mamba"], 3, id="2g-sw+mamba"),
    pytest.param(["sliding_window", "sliding_window_large"], 2, id="2g-sw+sw_large"),
    # 3 groups: 1 full + 2 others (same type)
    pytest.param(["full", "sliding_window", "sliding_window"], 2, id="3g-full+2sw"),
    pytest.param(["full", "mamba", "mamba"], 3, id="3g-full+2mamba"),
    # 3 groups: 1 full + 2 others (different types)
    ...
    # 3 groups: 2 full + 1 other
    pytest.param(["full", "full", "sliding_window"], 2, id="3g-2full+sw"),
    pytest.param(["full", "full", "mamba"], 3, id="3g-2full+mamba"),
    # 4 groups: interleaved (full, other, full, other)
    pytest.param(
        ["full", "sliding_window", "full", "sliding_window_large"],
        1,
