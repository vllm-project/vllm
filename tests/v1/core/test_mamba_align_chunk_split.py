...
def _mamba_aligned_split(
    ...
    stub = SimpleNamespace(
        ...
        # Partial-tail stops (finer prefix_match_unit, #46384) are exercised
        # by tests/v1/core/prefix_cache/test_partial_prefix_cache_hits.py;
        # keep them off here so the oracle only models full-block snapshots.
