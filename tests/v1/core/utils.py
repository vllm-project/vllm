...
def create_scheduler(
    ...
    min_prefill_chunk_tokens: int = 0,
    max_prefill_chunk_delay_steps: int = 16,
    ...
    scheduler_config = SchedulerConfig(
        ...
        min_prefill_chunk_tokens=min_prefill_chunk_tokens,
        max_prefill_chunk_delay_steps=max_prefill_chunk_delay_steps,
