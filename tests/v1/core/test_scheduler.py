...
def test_check_stop_min_tokens():
    ...
    # Test case 1: min_tokens > 0 and num_output_tokens < min_tokens
    ...
    request.output_token_ids = [10, 11, EOS_TOKEN_ID]  # EOS token present
    ...
    request_no_min.output_token_ids = [10, EOS_TOKEN_ID]

    result = check_stop(request_no_min, max_model_len=100)
    assert result is True, "Should stop immediately on EOS when min_tokens=0"
    ...
    request_stop.output_token_ids = [10, 11, 42]
