...
@pytest.mark.parametrize(
    ...
    [
        ...
        (0.5, 0.9, {}, True, "ok"),
        # Fits, but another process is resident: the extensible default
        # (utilization 1.0) assumes exclusivity and refuses; the profiling
        # default keeps its historical headroom-sharing semantics and warns.
        (0.97, None, {4242: 1 << 30}, True, "raise"),
        (0.97, None, {4242: 1 << 30}, False, "warn"),
