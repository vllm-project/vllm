...
def test_create_single_target_seq_group_metadata(k: int):
    ...
    assert output.sampling_params.repetition_penalty == input_seq_group_metadata.sampling_params.repetition_penalty
    assert output.sampling_params.temperature == input_seq_group_metadata.sampling_params.temperature
    assert output.sampling_params.top_p == input_seq_group_metadata.sampling_params.top_p
    assert output.sampling_params.top_k == input_seq_group_metadata.sampling_params.top_k
