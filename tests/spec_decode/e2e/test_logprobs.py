...
def test_logprobs_bs1(baseline_llm_generator, test_llm_generator, batch_size: int,
                output_len: int):
    """TODO
    """
...
@pytest.mark.parametrize("seed", [1])
def test_logprobs_bs_gt_1(baseline_llm_generator, test_llm_generator, batch_size: int,
                output_len: int):
    """TODO
    """
    run_greedy_logprobs_correctness_test(baseline_llm_generator,
