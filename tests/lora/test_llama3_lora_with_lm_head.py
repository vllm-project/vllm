...
def test_llama_lora(llama3_lora_lm_head_files, tp_size, num_gpus_available):
    ...
    assert do_sample(llm, llama3_lora_lm_head_files, lora_id=0) == expected_no_lora_output
    ...
    print("lora 2")
    assert do_sample(llm, llama3_lora_lm_head_files, lora_id=2) == expected_lora_output

    print("removing lora")


def test_llama_tensor_parallel_equality(llama3_lora_lm_head_files, num_gpus_available):
    ...
    output_tp1 = do_sample(llm_tp1, llama3_lora_lm_head_files, lora_id=1)
    ...
    output_tp2 = do_sample(llm_tp2, llama3_lora_lm_head_files, lora_id=1)
    ...
    output_tp4 = do_sample(llm_tp4, llama3_lora_lm_head_files, lora_id=1)
...
def test_llama_lora_warmup(llama3_lora_lm_head_files):
