...
MODELS_QUANT = [
    ("LnL-AI/TinyLlama-1.1B-intermediate-step-1341k-3T-autoround-lm_head-symFalse", True),
...
def test_lm_head(
    ...
    lm_head_layer = (vllm_model.model.llm_engine.model_executor.
                     driver_worker.model_runner.model.lm_head)
