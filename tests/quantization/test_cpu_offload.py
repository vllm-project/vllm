...
def test_cpu_offload_fp8():
    ...
    compare_two_settings("meta-llama/Llama-3.2-1B-Instruct", ["--quantization", "fp8"],
...
def test_cpu_offload_awq(monkeypatch):
    ...
    monkeypatch.setenv('VLLM_TEST_FORCE_LOAD_FORMAT', 'auto')
    # Test AWQ Marlin
    compare_two_settings("Qwen/Qwen2-1.5B-Instruct-AWQ", [], ["--cpu-offload-gb", "1"],
                         max_wait_seconds=480)
    # Test AWQ
...
def test_cpu_offload_compressed_tensors(monkeypatch):
    ...
    compare_two_settings("nm-testing/llama7b-one-shot-2_4-w4a16-marlin24-t", [],
                         ...
                         max_wait_seconds=480)
    # Test w8a8
    compare_two_settings("nm-testing/tinyllama-oneshot-w8w8-test-static-shape-change",
                         [], ["--cpu-offload-gb", "1"],
                         max_wait_seconds=480)
