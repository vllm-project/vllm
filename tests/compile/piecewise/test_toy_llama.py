...
def test_toy_llama(use_inductor: bool, use_inductor_graph_partition: bool,
    ...
    if use_inductor_graph_partition:
        compile_config_no_split.inductor_compile_config[
    ...
    # Inductor partition always splits
    # FIXME(luka): resolve once Inductor partition respects splitting_ops
    if use_inductor_graph_partition:
        num_cgs = 2 * (1 + llama_config.num_layers)
    ...
    with compilation_counter.expect(
            ...
            num_cudagraph_captured=num_cgs,
            **kwargs,
    ):
