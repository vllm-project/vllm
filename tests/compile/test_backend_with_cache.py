...
# InductorCache is a nested class inside VllmSerializableFunction
InductorCache = VllmSerializableFunction.InductorCache
...
class TestVllmBackendWithCache:
    ...
    def test_init(self):
        ...
        inductor_cache = VllmSerializableFunction.InductorCache()
        ...
        assert backend.inductor_cache == inductor_cache
...
class TestVllmBackendWithCacheFlag:
    ...
    def test_flag_parsing(self):
        ...
        # Test default value
        if "VLLM_USE_BACKEND_WITH_INDUCTOR_CACHE" in os.environ:
            del os.environ["VLLM_USE_BACKEND_WITH_INDUCTOR_CACHE"]
        ...
        assert os.environ["VLLM_USE_BACKEND_WITH_INDUCTOR_CACHE"] == "1"
