...
if is_quant_method_supported("aqlm"):  # noqa: SIM223
    TEST_MODELS.append(("ISTA-DASLab/Llama-2-7b-AQLM-2Bit-1x16-hf", {
        "quantization": "aqlm"
    }))

if is_quant_method_supported("gguf"):  # noqa: SIM223
...
def check_full_graph_support(model,
    ...
    if (model == "meta-llama/Meta-Llama-3-8B" and
        optimization_level >= CompilationLevel.PIECEWISE):
        return
