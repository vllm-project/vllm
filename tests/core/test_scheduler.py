...
from vllm.sequence import SampleLogprob, SequenceGroup
...
def test_scheduler_schedule_preempt_abort():
    ...
    # processed.
    token_id = 0
    seq_a.append_token_id(token_id, {token_id: SampleLogprob(0.0)})
    seq_b.append_token_id(token_id, {token_id: SampleLogprob(0.0)})
