...
def test_models(
    ...
    spec_vllm_model = vllm_runner(model, dtype=dtype, draft_model=draft_model, propose_cnt=propose_cnt)
    spec_vllm_outputs = spec_vllm_model.generate_greedy(example_prompts, max_tokens)
    del spec_vllm_model
