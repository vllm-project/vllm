...
def test_decode_graph_state_indices_mask_padding():
    ...
    assert actual.num_prefills == 1, "the batch this guards must be a prefill batch"
...
def test_multi_token_batch_does_not_stage_cudagraph_state_indices():
    """A batch with a longer row never replays the decode graph."""
    builder, common, actual = _build_non_spec(
