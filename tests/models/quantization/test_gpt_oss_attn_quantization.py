...
HF_HUB_AMD_ORG_ACCESS = all([has_huggingface_access(model_name) for model_name in MODEL_NAMES])
...
def test_mixed_precision_model_accuracies(model_name: str, task_name: str, expected_accuracy: float):
