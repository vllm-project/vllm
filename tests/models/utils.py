...
from vllm.sequence import SampleLogprobs, Logprob
...
# OpenAI-API-style logprobs
OpenAIAPILogprobs = Tuple[List[str], str,
                          Optional[Union[List[Dict[str, float]],
                                         List[Dict[str, Logprob]]]]]


def check_logprobs_close(
    *,
    outputs_0_lst: Sequence[Union[TokensTextLogprobs, OpenAIAPILogprobs]],
    outputs_1_lst: Sequence[Union[TokensTextLogprobs, OpenAIAPILogprobs]],
    name_0: str,
    name_1: str,
