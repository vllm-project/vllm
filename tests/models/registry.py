...
_EMBEDDING_EXAMPLE_MODELS = {
    ...
    # The model on Huggingface is currently being updated, hence I temporarily mark it as not available online
    "PrithviGeoSpatialMAE": _HfExamplesInfo("ibm-nasa-geospatial/Prithvi-EO-2.0-300M-TL-Sen1Floods11",
                                            is_available_online=False),
}
