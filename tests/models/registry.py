    ...
    def check_transformers_version(
        ...
        *,
        ...
        if (
            ...
            reason = self.transformers_version_reason[check_version_reason]
            msg += f" Reason({check_version_reason}): {reason}"
        elif is_transformers_valid:
            return None
