...
def test_contexted_kv_attention(
    ...
    def context_attention_fwd(
        ...
        from vllm.attention.ops.nki_flash_attn import (FlashConfig,
        ...
        if return_debug_tensors:
            o, *debug_tensors = _run_kernel(
                flash_paged_attention[1, num_kv_heads], **kwargs)
            return o, *debug_tensors
        else:
            o = _run_kernel(flash_paged_attention[1, num_kv_heads], **kwargs)
            return o
