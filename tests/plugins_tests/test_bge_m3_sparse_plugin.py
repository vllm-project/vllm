...
def test_bge_m3_sparse_plugin_offline_multiple_inputs(vllm_runner):
    ...
    prompts = [
        {"input": "What is the capital of France?", "return_tokens": True},
        {"input": "What is the capital of Germany?", "return_tokens": True},
        {"input": "What is the capital of Spain?", "return_tokens": True},
    ]
