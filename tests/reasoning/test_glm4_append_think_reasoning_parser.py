...
parser_name = "glm45_append_think"
end_token = "</think>"

# GLM-4 model path (same tokenizer as used by GLM-4.7-FP8)
...
# =============================================================================
# Glm4AppendThinkReasoningParser behavior:
...
#
# This parser is used when GLM-4 models don't generate the <think> start token
# but do generate the </think> end token.
# =============================================================================
