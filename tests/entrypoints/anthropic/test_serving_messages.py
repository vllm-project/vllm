...
async def _async_serving_chat_init():
    ...
    serving_completion = AnthropicServingMessages(engine,
                                           model_config,
                                           models,
...
async def test_serving_chat_should_set_correct_max_tokens():
    ...
    serving_messages = AnthropicServingMessages(mock_engine,
                                     MockModelConfig(),
                                     models,
                                     response_role="assistant",
                                     chat_template=CHAT_TEMPLATE,
    ...
    with suppress(Exception):
        await serving_messages.create_messages(req)
    ...
    serving_chat = AnthropicServingMessages(mock_engine,
                                     mock_model_config,
                                     models,
                                     response_role="assistant",
                                     chat_template=CHAT_TEMPLATE,
    ...
    with suppress(Exception):
        await serving_chat.create_messages(req)
