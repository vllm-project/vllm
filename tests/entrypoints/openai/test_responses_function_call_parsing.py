...
def test_function_call_dict_parsing():
    """Test that function call dictionaries are parsed as ResponseFunctionToolCall objects."""
    ...
    assert parsed_function_call.call_id == 'call_a90e65e81cd84553855dde1733e77749'
...
def test_direct_function_call_object_preservation():
    ...
    assert isinstance(parsed_function_call, ResponseFunctionToolCall)
    assert parsed_function_call is function_call_obj  # Should be the same object
