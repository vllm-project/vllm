...
@pytest.mark.parametrize("streaming, model_output,"
                         " expected_tool_calls",
                         TEST_CASES_STREAM)
def test_tool_call_stream(streaming: bool,
                          model_output: list,
                          expected_tool_calls:
                          list[FunctionCall]):
    ...
    content, tool_calls = run_tool_extraction_hermes(
        tool_parser,
        model_output,
        streaming=streaming)
...
@pytest.mark.parametrize("streaming, "
                         ...
                         "expected_tool_calls",
                         TEST_CASES_NO_STREAM)
def test_tool_call_no_stream(streaming: bool,
                             model_output: str,
                             expected_tool_calls:
                             list[FunctionCall]):
    # The tokenizer for the local
    ...
    assert extracted.tools_called == \
           bool(extracted.tool_calls)
    assert extracted.tool_calls[0].type \
           == "function"
