...
async def test_prompt_logprobs_chat(client: openai.AsyncOpenAI, model_name: str,
...
async def test_required_tool_use(client: openai.AsyncOpenAI, is_v1_server: bool,
                                 model_name: str):
    if is_v1_server:
