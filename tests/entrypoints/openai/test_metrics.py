...
EXPECTED_METRICS_V1 = [
    ...
    "vllm:p0_processor_mm_cache_usage",
    "vllm:p0_processor_mm_cache_queries",
    "vllm:p0_processor_mm_cache_hits",
    "vllm:p0_mirror_mm_cache_usage",
    "vllm:p0_mirror_mm_cache_queries",
    "vllm:p0_mirror_mm_cache_hits",
    "vllm:p1_mirror_mm_cache_usage",
    "vllm:p1_mirror_mm_cache_queries",
    "vllm:p1_mirror_mm_cache_hits",
    "vllm:num_preemptions_total",
    "vllm:prompt_tokens_total",
    "vllm:generation_tokens_total",
    "vllm:iteration_tokens_total",
