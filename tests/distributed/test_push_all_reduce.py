...
def _feature_toggle_enabled_worker(rank, world_size, port):
    ...
    os.environ.pop("VLLM_DISABLE_AUTO_PERF_PLAN_2", None)
    ...
    assert _PLAN_STEP == 2
    assert _DISABLE_ENV_VAR == "VLLM_DISABLE_AUTO_PERF_PLAN_2"
    assert "AllReduce" in _PLAN_DESCRIPTION
...
def _feature_toggle_disabled_worker(rank, world_size, port):
    ...
    os.environ["VLLM_DISABLE_AUTO_PERF_PLAN_2"] = "1"
...
def _feature_toggle_not_disabled_worker(rank, world_size, port):
    ...
    os.environ["VLLM_DISABLE_AUTO_PERF_PLAN_2"] = "0"
