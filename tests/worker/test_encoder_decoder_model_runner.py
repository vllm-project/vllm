...
def test_prepare_prompt(batch_size, backend_name, enforce_eager, monkeypatch):
    ...
    # Encoder model input
    encoder_model_input = model_runner._prepare_encoder_model_input_tensors(
    ...
    assert torch.allclose(attn_metadata.block_tables, 
                          expected,
                          )
    # - Encoder/decoder cross-attention
    assert torch.allclose(attn_metadata.cross_block_tables, 
                          expected,
                          )
