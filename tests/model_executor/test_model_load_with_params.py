...
MODEL_NAME_ROBERTA = os.environ.get("MODEL_NAME", "sdadas/polish-roberta-base-v2")
...
def test_roberta_model_loading_with_params(vllm_runner):
    ...
    with vllm_runner(model_name=MODEL_NAME_ROBERTA,
        ...
        # asserts on the tokenizer loaded
        assert model_tokenizer.tokenizer_id == "sdadas/polish-roberta-base-v2"
        assert model_tokenizer.tokenizer_config["do_lower_case"]
        assert model_tokenizer.tokenizer.model_max_length == 768
