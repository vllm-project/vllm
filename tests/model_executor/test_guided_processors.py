...
def test_guided_logits_processors(llama_1B_tokenzer, sample_regex,
                                  sample_json_schema):
    ...
    token_ids = llama_1B_tokenzer.encode(
...
async def test_guided_logits_processor_black_box(backend: str, is_local: bool,
    ...
    regex_lp = get_local_guided_decoding_logits_processor(
            regex_request, llama_1B_tokenzer, config) if is_local else \
