...
async def test_guided_logits_processor_black_box(backend: str, is_local: bool,
                                                 sample_regex, sample_json_schema,
                                                 zephyr_7B_tokenzer):
    ...
    json_lp = await get_guided_decoding_logits_processor(json_request,
                                                         zephyr_7B_tokenzer, config)
...
async def test_guided_logits_processor_with_reasoning(backend: str, is_local: bool,
