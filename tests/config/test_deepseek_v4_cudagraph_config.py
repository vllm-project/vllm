...
def test_deepseek_v4_does_not_auto_enable_breakable_cudagraph(monkeypatch):
...
def test_deepseek_v4_does_not_auto_enable_breakable_cudagraph_on_sm121(monkeypatch):
    monkeypatch.setattr(
        current_platform,
        "is_device_capability",
