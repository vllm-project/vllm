...
def _make_model_arch_config(derived_max_model_len: int = 4096) -> ModelArchitectureConfig:
    return ModelArchitectureConfig(
        ...
        derived_max_model_len_and_key=(derived_max_model_len, "max_position_embeddings"),
    )
