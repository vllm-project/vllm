...
CI_MODEL_NAME = "CohereLabs/cohere-transcribe-03-2026"
HF_MODEL_NAME = "cohere-transcribe-03-2026"
...
def test_cohere_transcribe_wer_correctness():
    model_info = HF_EXAMPLE_MODELS.find_hf_info(CI_MODEL_NAME)
    server_model = _get_server_model(HF_MODEL_NAME, CI_MODEL_NAME)
    server_args = [
        f"--served-model-name={CI_MODEL_NAME}",
    ]
